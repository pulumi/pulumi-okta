...
tfgen::
	go install -ldflags "-X github.com/pulumi/pulumi-okta/pkg/version.Version=${VERSION}" ${PROJECT}/cmd/${TFGEN}
...
install::
	GOBIN=$(PULUMI_BIN) go install -ldflags "-X github.com/pulumi/pulumi-okta/pkg/version.Version=${VERSION}" ${PROJECT}/cmd/${PROVIDER}
