...
require (
	github.com/okta/terraform-provider-okta v0.0.0-20220826053930-a08a6f0e9138
...
require (
	...
	github.com/okta/okta-sdk-golang/v2 v2.13.1-0.20220629214615-7167dfb447ff // indirect
