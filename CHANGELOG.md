...
*As of this notice, using CHANGELOG.md is DEPRECATED. We will be using [GitHub Releases](https://github.com/pulumi/pulumi-okta/releases) for this repository*
...
## 3.5.1 (2021-12-10)
* Upgrade to v3.20.2 of the Okta Terraform Provider
