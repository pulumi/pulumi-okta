...
func GetApiToken(ctx *pulumi.Context) string {
	...
	if dv, ok := getEnvOrDefault("", nil, "OKTA_API_TOKEN").(string); ok {
		return dv
	}
	return v
}
...
func GetBaseUrl(ctx *pulumi.Context) string {
	...
	if dv, ok := getEnvOrDefault("", nil, "OKTA_BASE_URL").(string); ok {
		return dv
	}
	return v
}
...
func GetOrgName(ctx *pulumi.Context) string {
	...
	if dv, ok := getEnvOrDefault("", nil, "OKTA_ORG_NAME").(string); ok {
		return dv
	}
	return v
}
