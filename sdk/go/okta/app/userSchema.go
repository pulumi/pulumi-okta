...
func NewUserSchema(ctx *pulumi.Context,
	name string, args *UserSchemaArgs, opts ...pulumi.ResourceOpt) (*UserSchema, error) {
	...
	s, err := ctx.RegisterResource("okta:app/userSchema:UserSchema", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &UserSchema{s: s}, nil
}
...
func GetUserSchema(ctx *pulumi.Context,
	name string, id pulumi.ID, state *UserSchemaState, opts ...pulumi.ResourceOpt) (*UserSchema, error) {
	inputs := make(map[string]interface{})
	if state != nil {
	...
	s, err := ctx.ReadResource("okta:app/userSchema:UserSchema", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &UserSchema{s: s}, nil
