...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AutoLoginUserInput)(nil)).Elem(), AutoLoginUserArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AutoLoginUserArrayInput)(nil)).Elem(), AutoLoginUserArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*BasicAuthUserInput)(nil)).Elem(), BasicAuthUserArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BasicAuthUserArrayInput)(nil)).Elem(), BasicAuthUserArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*BookmarkUserInput)(nil)).Elem(), BookmarkUserArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BookmarkUserArrayInput)(nil)).Elem(), BookmarkUserArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*OAuthUserInput)(nil)).Elem(), OAuthUserArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SecurePasswordStoreUserArrayInput)(nil)).Elem(), SecurePasswordStoreUserArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*SwaUserInput)(nil)).Elem(), SwaUserArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SwaUserArrayInput)(nil)).Elem(), SwaUserArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ThreeFieldUserInput)(nil)).Elem(), ThreeFieldUserArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ThreeFieldUserArrayInput)(nil)).Elem(), ThreeFieldUserArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*UserSchemaArrayOneOfInput)(nil)).Elem(), UserSchemaArrayOneOfArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UserSchemaArrayOneOfArrayInput)(nil)).Elem(), UserSchemaArrayOneOfArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*UserSchemaOneOfInput)(nil)).Elem(), UserSchemaOneOfArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*UserSchemaOneOfArrayInput)(nil)).Elem(), UserSchemaOneOfArray{})
