...
class RateLimitingArgs:
    def __init__(__self__, *,
                 authorize: pulumi.Input[builtins.str],
                 login: pulumi.Input[builtins.str],
                 communications_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a RateLimiting resource.
        :param pulumi.Input[builtins.str] authorize: Called during authentication. Valid values: `ENFORCE` *(Enforce limit and log per client (recommended))*, `DISABLE` *(Do nothing (not recommended))*, `PREVIEW` *(Log per client)*.
        :param pulumi.Input[builtins.str] login: Called when accessing the Okta hosted login page. Valid values: `ENFORCE` *(Enforce limit and log per client (recommended))*, `DISABLE` *(Do nothing (not recommended))*, `PREVIEW` *(Log per client)*.
        :param pulumi.Input[builtins.bool] communications_enabled: Enable or disable rate limiting communications. By default, it is `true`.
        """
    ...
    @property
    @pulumi.getter
    def authorize(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @authorize.setter
    def authorize(self, value: pulumi.Input[builtins.str]):
    ...
    def communications_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def communications_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _RateLimitingState:
    def __init__(__self__, *,
                 authorize: Optional[pulumi.Input[builtins.str]] = None,
                 communications_enabled: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    @property
    @pulumi.getter
    def authorize(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Called during authentication. Valid values: `ENFORCE` *(Enforce limit and log per client (recommended))*, `DISABLE` *(Do nothing (not recommended))*, `PREVIEW` *(Log per client)*.
        """
        return pulumi.get(self, "authorize")
    ...
    @authorize.setter
    def authorize(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "authorize", value)
...
class RateLimiting(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            authorize: Optional[pulumi.Input[builtins.str]] = None,
            communications_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            login: Optional[pulumi.Input[builtins.str]] = None) -> 'RateLimiting':
        """
    ...
    @property
    @pulumi.getter
    def authorize(self) -> pulumi.Output[builtins.str]:
        """
        Called during authentication. Valid values: `ENFORCE` *(Enforce limit and log per client (recommended))*, `DISABLE` *(Do nothing (not recommended))*, `PREVIEW` *(Log per client)*.
        """
        return pulumi.get(self, "authorize")
    ...
    @property
    @pulumi.getter(name="communicationsEnabled")
    def communications_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enable or disable rate limiting communications. By default, it is `true`.
        """
        return pulumi.get(self, "communications_enabled")
