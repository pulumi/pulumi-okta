...
class ZoneArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] dynamic_proxy_type: Type of proxy being controlled by this dynamic network zone - can be one of `Any`, `TorAnonymizer` or `NotTorAnonymizer`. Use with type `DYNAMIC`
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] gateways: Array of values in CIDR/range form depending on the way it's been declared (i.e. CIDR will contain /suffix). Please check API docs for examples. Use with type `IP`
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] ip_service_categories_excludes: List of ip service excluded. Use with type `DYNAMIC_V2`
...
class _ZoneState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] set_usage_as_exempt_list: Set this parameter to true in your request when you update the `DefaultExemptIpZone` to allow IPs through the blocklist.
        :param pulumi.Input[_builtins.str] status: Network Status - can either be `ACTIVE` or `INACTIVE` only
        :param pulumi.Input[_builtins.bool] system: Indicates a system Network Zone
        :param pulumi.Input[_builtins.str] type: Type of the Network Zone - can be `IP`, `DYNAMIC` or `DYNAMIC_V2` only
        :param pulumi.Input[_builtins.str] usage: Usage of the Network Zone - can be either `POLICY` or `BLOCKLIST`. By default, it is `POLICY`
        """
        if asns is not None:
...
class Zone(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def asns(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        List of asns included. Format of each array value: a string representation of an ASN numeric value. Use with type `DYNAMIC` or `DYNAMIC_V2`
        """
        return pulumi.get(self, "asns")
    ...
    @_builtins.property
    @pulumi.getter(name="dynamicLocations")
    def dynamic_locations(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        Array of locations ISO-3166-1(2) included. Format code: countryCode OR countryCode-regionCode. Use with type `DYNAMIC` or `DYNAMIC_V2`
        """
        return pulumi.get(self, "dynamic_locations")
    ...
    @_builtins.property
    @pulumi.getter(name="dynamicLocationsExcludes")
    def dynamic_locations_excludes(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        Array of locations ISO-3166-1(2) excluded. Format code: countryCode OR countryCode-regionCode. Use with type `DYNAMIC_V2`
        """
        return pulumi.get(self, "dynamic_locations_excludes")
    ...
    @_builtins.property
    @pulumi.getter(name="dynamicProxyType")
    def dynamic_proxy_type(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Type of proxy being controlled by this dynamic network zone - can be one of `Any`, `TorAnonymizer` or `NotTorAnonymizer`. Use with type `DYNAMIC`
        """
        return pulumi.get(self, "dynamic_proxy_type")
    ...
    @_builtins.property
    @pulumi.getter(name="ipServiceCategoriesExcludes")
    def ip_service_categories_excludes(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        List of ip service excluded. Use with type `DYNAMIC_V2`
        """
        return pulumi.get(self, "ip_service_categories_excludes")
    ...
    @_builtins.property
    @pulumi.getter(name="ipServiceCategoriesIncludes")
    def ip_service_categories_includes(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        List of ip service included. Use with type `DYNAMIC_V2`
        """
        return pulumi.get(self, "ip_service_categories_includes")
