...
def get_auth_server_claim(auth_server_id: Optional[builtins.str] = None,
    ...
    :param builtins.str auth_server_id: Auth server ID
    :param builtins.str id: Name of the claim. Conflicts with `name`.
    :param builtins.str name: Name of the claim. Conflicts with `id`.
    """
    __args__ = dict()
...
def get_auth_server_claim_output(auth_server_id: Optional[pulumi.Input[builtins.str]] = None,
