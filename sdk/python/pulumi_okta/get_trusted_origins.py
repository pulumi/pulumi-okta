...
def get_trusted_origins(filter: Optional[builtins.str] = None,
    ...
    :param builtins.str filter: Filter criteria. Filter value will be URL-encoded by the provider
    """
    __args__ = dict()
...
def get_trusted_origins_output(filter: Optional[pulumi.Input[Optional[builtins.str]]] = None,
