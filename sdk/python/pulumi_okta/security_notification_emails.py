...
class SecurityNotificationEmailsArgs:
    def __init__(__self__, *,
                 report_suspicious_activity_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 send_email_for_factor_enrollment_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 send_email_for_factor_reset_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 send_email_for_new_device_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 send_email_for_password_changed_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a SecurityNotificationEmails resource.
        :param pulumi.Input[builtins.bool] report_suspicious_activity_enabled: Notifies end users about suspicious or unrecognized activity from their account. Default is `true`.
        :param pulumi.Input[builtins.bool] send_email_for_factor_enrollment_enabled: Notifies end users of any activity on their account related to MFA factor enrollment. Default is `true`.
        :param pulumi.Input[builtins.bool] send_email_for_factor_reset_enabled: Notifies end users that one or more factors have been reset for their account. Default is `true`.
        :param pulumi.Input[builtins.bool] send_email_for_new_device_enabled: Notifies end users about new sign-on activity. Default is `true`.
        :param pulumi.Input[builtins.bool] send_email_for_password_changed_enabled: Notifies end users that the password for their account has changed. Default is `true`.
        """
    ...
    def report_suspicious_activity_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def report_suspicious_activity_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "report_suspicious_activity_enabled", value)

    @property
    @pulumi.getter(name="sendEmailForFactorEnrollmentEnabled")
    def send_email_for_factor_enrollment_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def send_email_for_factor_enrollment_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "send_email_for_factor_enrollment_enabled", value)

    @property
    @pulumi.getter(name="sendEmailForFactorResetEnabled")
    def send_email_for_factor_reset_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def send_email_for_factor_reset_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "send_email_for_factor_reset_enabled", value)

    @property
    @pulumi.getter(name="sendEmailForNewDeviceEnabled")
    def send_email_for_new_device_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def send_email_for_new_device_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "send_email_for_new_device_enabled", value)

    @property
    @pulumi.getter(name="sendEmailForPasswordChangedEnabled")
    def send_email_for_password_changed_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def send_email_for_password_changed_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class SecurityNotificationEmails(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            send_email_for_factor_reset_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            send_email_for_new_device_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            send_email_for_password_changed_enabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'SecurityNotificationEmails':
        """
    ...
    @property
    @pulumi.getter(name="reportSuspiciousActivityEnabled")
    def report_suspicious_activity_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Notifies end users about suspicious or unrecognized activity from their account. Default is `true`.
        """
        return pulumi.get(self, "report_suspicious_activity_enabled")
    ...
    @property
    @pulumi.getter(name="sendEmailForFactorEnrollmentEnabled")
    def send_email_for_factor_enrollment_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Notifies end users of any activity on their account related to MFA factor enrollment. Default is `true`.
        """
        return pulumi.get(self, "send_email_for_factor_enrollment_enabled")
    ...
    @property
    @pulumi.getter(name="sendEmailForFactorResetEnabled")
    def send_email_for_factor_reset_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Notifies end users that one or more factors have been reset for their account. Default is `true`.
        """
        return pulumi.get(self, "send_email_for_factor_reset_enabled")
    ...
    @property
    @pulumi.getter(name="sendEmailForNewDeviceEnabled")
    def send_email_for_new_device_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Notifies end users about new sign-on activity. Default is `true`.
        """
        return pulumi.get(self, "send_email_for_new_device_enabled")
    ...
    @property
    @pulumi.getter(name="sendEmailForPasswordChangedEnabled")
    def send_email_for_password_changed_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Notifies end users that the password for their account has changed. Default is `true`.
        """
        return pulumi.get(self, "send_email_for_password_changed_enabled")
