...
def get_app_group_assignments(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: ID of the Okta App being queried for groups
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_app_group_assignments_output(id: Optional[pulumi.Input[builtins.str]] = None,
