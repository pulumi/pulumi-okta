...
def get_theme(brand_id: Optional[builtins.str] = None,
    ...
    :param builtins.str theme_id: Theme ID
    """
    __args__ = dict()
...
def get_theme_output(brand_id: Optional[pulumi.Input[builtins.str]] = None,
