...
class EventHookArgs:
    def __init__(__self__, *,
                 channel: pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]],
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] channel: Details of the endpoint the event hook will hit.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] events: The events that will be delivered to this hook. [See here for a list of supported
               events](https://developer.okta.com/docs/reference/api/event-types/?q=event-hook-eligible).
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] auth: Details of the endpoint the event hook will hit. - 'version' - (Required) The version of the channel. The
        ...
        :param pulumi.Input[builtins.str] name: The event hook display name.
    ...
    @property
    @pulumi.getter
    def channel(self) -> pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]:
        """
    ...
    @channel.setter
    def channel(self, value: pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]):
...
class EventHook(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            headers: Optional[pulumi.Input[Sequence[pulumi.Input[Union['EventHookHeaderArgs', 'EventHookHeaderArgsDict']]]]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'EventHook':
        """
    ...
    @property
    @pulumi.getter
    def channel(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        Details of the endpoint the event hook will hit.
        """
        return pulumi.get(self, "channel")
