...
class UserSchemaPropertyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] master: Master priority for the user schema property. It can be set to `PROFILE_MASTER`, `OVERRIDE` or `OKTA`.
        ...
        :param pulumi.Input[builtins.str] pattern: The validation pattern to use for the subschema. Must be in form of '.+', or '[<pattern>]+' if present.'
        ...
        :param pulumi.Input[builtins.str] scope: determines whether an app user attribute can be set at the Individual or Group Level. Default: `NONE`
...
@pulumi.type_token("okta:index/userSchemaProperty:UserSchemaProperty")
class UserSchemaProperty(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[builtins.str]] = None,
            unique: Optional[pulumi.Input[builtins.str]] = None,
            user_type: Optional[pulumi.Input[builtins.str]] = None) -> 'UserSchemaProperty':
        """
