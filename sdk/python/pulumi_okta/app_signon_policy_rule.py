...
class AppSignonPolicyRuleArgs:
    def __init__(__self__, *,
                 ...
                 device_is_managed: Optional[pulumi.Input[builtins.bool]] = None,
                 device_is_registered: Optional[pulumi.Input[builtins.bool]] = None,
                 factor_mode: Optional[pulumi.Input[builtins.str]] = None,
                 groups_excludeds: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 groups_includeds: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 inactivity_period: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 network_includes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 platform_includes: Optional[pulumi.Input[Sequence[pulumi.Input['AppSignonPolicyRulePlatformIncludeArgs']]]] = None,
                 priority: Optional[pulumi.Input[builtins.int]] = None,
                 re_authentication_frequency: Optional[pulumi.Input[builtins.str]] = None,
                 risk_score: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None,
                 user_types_excludeds: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 user_types_includeds: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 users_excludeds: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 users_includeds: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        ...
        :param pulumi.Input[builtins.bool] device_is_managed: If the device is managed. A device is managed if it's managed by a device management system. When managed is passed, registered must also be included and must be set to true.
        :param pulumi.Input[builtins.bool] device_is_registered: If the device is registered. A device is registered if the User enrolls with Okta Verify that is installed on the device.
        :param pulumi.Input[builtins.str] factor_mode: The number of factors required to satisfy this assurance level
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] groups_excludeds: List of group IDs to exclude
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] groups_includeds: List of group IDs to include
        :param pulumi.Input[builtins.str] inactivity_period: The inactivity duration after which the end user must re-authenticate. Use the ISO 8601 Period format for recurring time intervals.
        :param pulumi.Input[builtins.str] name: Policy Rule Name
        :param pulumi.Input[builtins.str] network_connection: Network selection mode: ANYWHERE, ZONE, ON*NETWORK, or OFF*NETWORK.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] network_excludes: The zones to exclude
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] network_includes: The zones to include
        :param pulumi.Input[builtins.int] priority: Priority of the rule.
        :param pulumi.Input[builtins.str] re_authentication_frequency: The duration after which the end user must re-authenticate, regardless of user activity. Use the ISO 8601 Period format for recurring time intervals. PT0S - Every sign-in attempt, PT43800H - Once per session
        :param pulumi.Input[builtins.str] risk_score: The risk score specifies a particular level of risk to match on: ANY, LOW, MEDIUM, HIGH
        :param pulumi.Input[builtins.str] status: Status of the rule
        :param pulumi.Input[builtins.str] type: The Verification Method type
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] user_types_excludeds: Set of User Type IDs to exclude
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] user_types_includeds: Set of User Type IDs to include
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] users_excludeds: Set of User IDs to exclude
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] users_includeds: Set of User IDs to include
        """
    ...
    def device_assurances_includeds(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def device_assurances_includeds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "device_assurances_includeds", value)

    @property
    @pulumi.getter(name="deviceIsManaged")
    def device_is_managed(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def device_is_managed(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "device_is_managed", value)

    @property
    @pulumi.getter(name="deviceIsRegistered")
    def device_is_registered(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def device_is_registered(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "device_is_registered", value)

    @property
    @pulumi.getter(name="factorMode")
    def factor_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @factor_mode.setter
    def factor_mode(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "factor_mode", value)

    @property
    @pulumi.getter(name="groupsExcludeds")
    def groups_excludeds(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def groups_excludeds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def inactivity_period(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def inactivity_period(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def network_connection(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def network_connection(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "network_connection", value)

    @property
    @pulumi.getter(name="networkExcludes")
    def network_excludes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def network_excludes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "network_excludes", value)

    @property
    @pulumi.getter(name="networkIncludes")
    def network_includes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def network_includes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def re_authentication_frequency(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def re_authentication_frequency(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "re_authentication_frequency", value)

    @property
    @pulumi.getter(name="riskScore")
    def risk_score(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @risk_score.setter
    def risk_score(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def user_types_excludeds(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def user_types_excludeds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "user_types_excludeds", value)

    @property
    @pulumi.getter(name="userTypesIncludeds")
    def user_types_includeds(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def user_types_includeds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "user_types_includeds", value)

    @property
    @pulumi.getter(name="usersExcludeds")
    def users_excludeds(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def users_excludeds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "users_excludeds", value)

    @property
    @pulumi.getter(name="usersIncludeds")
    def users_includeds(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def users_includeds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _AppSignonPolicyRuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] risk_score: The risk score specifies a particular level of risk to match on: ANY, LOW, MEDIUM, HIGH
        :param pulumi.Input[builtins.str] status: Status of the rule
        :param pulumi.Input[builtins.bool] system: Often the `Catch-all Rule` this rule is the system (default) rule for its associated policy
        :param pulumi.Input[builtins.str] type: The Verification Method type
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] user_types_excludeds: Set of User Type IDs to exclude
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] user_types_includeds: Set of User Type IDs to include
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] users_excludeds: Set of User IDs to exclude
...
class AppSignonPolicyRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            user_types_includeds: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            users_excludeds: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            users_includeds: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'AppSignonPolicyRule':
        """
    ...
    @property
    @pulumi.getter
    def access(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Allow or deny access based on the rule conditions: ALLOW or DENY
        """
        return pulumi.get(self, "access")
    ...
    @property
    @pulumi.getter
    def constraints(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        An array that contains nested Authenticator Constraint objects that are organized by the Authenticator class
        """
        return pulumi.get(self, "constraints")
    ...
    @property
    @pulumi.getter(name="customExpression")
    def custom_expression(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        This is an optional advanced setting. If the expression is formatted incorrectly or conflicts with conditions set above, the rule may not match any users.
        """
        return pulumi.get(self, "custom_expression")
    ...
    @property
    @pulumi.getter(name="deviceAssurancesIncludeds")
    def device_assurances_includeds(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of device assurance IDs to include
        """
        return pulumi.get(self, "device_assurances_includeds")
    ...
    @property
    @pulumi.getter(name="deviceIsManaged")
    def device_is_managed(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If the device is managed. A device is managed if it's managed by a device management system. When managed is passed, registered must also be included and must be set to true.
        """
        return pulumi.get(self, "device_is_managed")
    ...
    @property
    @pulumi.getter(name="deviceIsRegistered")
    def device_is_registered(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If the device is registered. A device is registered if the User enrolls with Okta Verify that is installed on the device.
        """
        return pulumi.get(self, "device_is_registered")
    ...
    @property
    @pulumi.getter(name="factorMode")
    def factor_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The number of factors required to satisfy this assurance level
        """
        return pulumi.get(self, "factor_mode")
    ...
    @property
    @pulumi.getter(name="groupsExcludeds")
    def groups_excludeds(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of group IDs to exclude
        """
        return pulumi.get(self, "groups_excludeds")
    ...
    @property
    @pulumi.getter(name="inactivityPeriod")
    def inactivity_period(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The inactivity duration after which the end user must re-authenticate. Use the ISO 8601 Period format for recurring time intervals.
        """
        return pulumi.get(self, "inactivity_period")
    ...
    @property
    @pulumi.getter(name="networkConnection")
    def network_connection(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Network selection mode: ANYWHERE, ZONE, ON*NETWORK, or OFF*NETWORK.
        """
        return pulumi.get(self, "network_connection")
    ...
    @property
    @pulumi.getter(name="networkExcludes")
    def network_excludes(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The zones to exclude
        """
        return pulumi.get(self, "network_excludes")
    ...
    @property
    @pulumi.getter(name="networkIncludes")
    def network_includes(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The zones to include
        """
        return pulumi.get(self, "network_includes")
    ...
    @property
    @pulumi.getter(name="reAuthenticationFrequency")
    def re_authentication_frequency(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The duration after which the end user must re-authenticate, regardless of user activity. Use the ISO 8601 Period format for recurring time intervals. PT0S - Every sign-in attempt, PT43800H - Once per session
        """
        return pulumi.get(self, "re_authentication_frequency")
    ...
    @property
    @pulumi.getter(name="riskScore")
    def risk_score(self) -> pulumi.Output[builtins.str]:
        """
        The risk score specifies a particular level of risk to match on: ANY, LOW, MEDIUM, HIGH
        """
        return pulumi.get(self, "risk_score")
    ...
    @property
    @pulumi.getter(name="userTypesExcludeds")
    def user_types_excludeds(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Set of User Type IDs to exclude
        """
        return pulumi.get(self, "user_types_excludeds")
    ...
    @property
    @pulumi.getter(name="userTypesIncludeds")
    def user_types_includeds(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Set of User Type IDs to include
        """
        return pulumi.get(self, "user_types_includeds")
    ...
    @property
    @pulumi.getter(name="usersExcludeds")
    def users_excludeds(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Set of User IDs to exclude
        """
        return pulumi.get(self, "users_excludeds")
    ...
    @property
    @pulumi.getter(name="usersIncludeds")
    def users_includeds(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Set of User IDs to include
        """
        return pulumi.get(self, "users_includeds")
