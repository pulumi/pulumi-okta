...
def get_log_stream(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: ID of the log stream to retrieve, conflicts with `name`.
    :param builtins.str name: Unique name for the Log Stream object, conflicts with `id`.
    """
    __args__ = dict()
    __args__['id'] = id
    __args__['name'] = name
...
def get_log_stream_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
