...
class OriginArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] origin: Unique origin URL for this trusted origin
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] scopes: Scopes of the Trusted Origin - can either be `CORS` and/or `REDIRECT`
        :param pulumi.Input[builtins.bool] active: Whether the Trusted Origin is active or not - can only be issued post-creation. By default, it is `true`.
        :param pulumi.Input[builtins.str] name: Unique name for this trusted origin
        """
...
class Origin(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            origin: Optional[pulumi.Input[builtins.str]] = None,
            scopes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'Origin':
        """
