...
class EmailDomainArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] brand_id: Brand id of the email domain.
        :param pulumi.Input[builtins.str] display_name: Display name of the email domain.
        :param pulumi.Input[builtins.str] domain: Mail domain to send from.
        :param pulumi.Input[builtins.str] user_name: User name of the email domain.
        """
...
class _EmailDomainState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] domain: Mail domain to send from.
        :param pulumi.Input[builtins.str] user_name: User name of the email domain.
        :param pulumi.Input[builtins.str] validation_status: Status of the email domain. Values: NOT*STARTED, IN*PROGRESS, VERIFIED, COMPLETED
        """
...
class EmailDomain(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            domain: Optional[pulumi.Input[builtins.str]] = None,
            user_name: Optional[pulumi.Input[builtins.str]] = None,
            validation_status: Optional[pulumi.Input[builtins.str]] = None) -> 'EmailDomain':
        """
