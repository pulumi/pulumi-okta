...
class GroupMembershipsArgs:
    def __init__(__self__, *,
                 ...
                 track_all_users: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a GroupMemberships resource.
        :param pulumi.Input[builtins.str] group_id: ID of a Okta group.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] users: The list of Okta user IDs which the group should have membership managed for.
        :param pulumi.Input[builtins.bool] track_all_users: The resource concerns itself with all users added/deleted to the group; even those managed outside of the resource.
        """
    ...
    def track_all_users(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def track_all_users(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class GroupMemberships(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            group_id: Optional[pulumi.Input[builtins.str]] = None,
            track_all_users: Optional[pulumi.Input[builtins.bool]] = None,
            users: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'GroupMemberships':
        """
    ...
    @property
    @pulumi.getter(name="trackAllUsers")
    def track_all_users(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        The resource concerns itself with all users added/deleted to the group; even those managed outside of the resource.
        """
        return pulumi.get(self, "track_all_users")
