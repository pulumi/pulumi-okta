...
class DomainCertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] certificate_chain: Certificate chain
        :param pulumi.Input[builtins.str] domain_id: Domain's ID
        :param pulumi.Input[builtins.str] private_key: Certificate private key
        :param pulumi.Input[builtins.str] type: Certificate type. Valid value is `PEM`
        """
...
class DomainCertificate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            domain_id: Optional[pulumi.Input[builtins.str]] = None,
            private_key: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'DomainCertificate':
        """
