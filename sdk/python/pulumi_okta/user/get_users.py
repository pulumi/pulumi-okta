...
class GetUsersResult:
    ...
    def include_groups(self) -> Optional[builtins.bool]:
        """
    ...
    def include_roles(self) -> Optional[builtins.bool]:
        """
...
def get_users(compound_search_operator: Optional[builtins.str] = None,
              delay_read_seconds: Optional[builtins.str] = None,
              group_id: Optional[builtins.str] = None,
              include_groups: Optional[builtins.bool] = None,
              include_roles: Optional[builtins.bool] = None,
    ...
    :param builtins.str delay_read_seconds: Force delay of the users read by N seconds. Useful when eventual consistency of users information needs to be allowed for.
    :param builtins.str group_id: Find users based on group membership using the id of the group.
    :param builtins.bool include_groups: Fetch group memberships for each user
    :param builtins.bool include_roles: Fetch user roles for each user
...
def get_users_output(compound_search_operator: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     ...
                     include_groups: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                     include_roles: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
