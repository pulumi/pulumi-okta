...
class UserPasswordHash(dict):
    ...
    def __init__(__self__, *,
                 ...
                 salt_order: Optional[builtins.str] = None,
                 work_factor: Optional[builtins.int] = None):
        """
        :param builtins.str algorithm: The algorithm used to generate the hash using the password
        :param builtins.str value: For SHA-512, SHA-256, SHA-1, MD5, This is the actual base64-encoded hash of the password (and salt, if used). This is the Base64 encoded value of the SHA-512/SHA-256/SHA-1/MD5 digest that was computed by either pre-fixing or post-fixing the salt to the password, depending on the saltOrder. If a salt was not used in the source system, then this should just be the the Base64 encoded value of the password's SHA-512/SHA-256/SHA-1/MD5 digest. For BCRYPT, This is the actual radix64-encoded hashed password.
        :param builtins.str salt: Only required for salted hashes
        :param builtins.str salt_order: Specifies whether salt was pre- or postfixed to the password before hashing
        :param builtins.int work_factor: Governs the strength of the hash and the time required to compute it. Only required for BCRYPT algorithm
        """
    ...
    def salt_order(self) -> Optional[builtins.str]:
        """
    ...
    def work_factor(self) -> Optional[builtins.int]:
        """
...
class GetUsersUserResult(dict):
    ...
    def admin_roles(self) -> Sequence[builtins.str]:
    ...
    def group_memberships(self) -> Sequence[builtins.str]:
