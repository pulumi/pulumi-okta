...
class GetUserResult:
    ...
    def compound_search_operator(self) -> Optional[builtins.str]:
        """
    ...
    def delay_read_seconds(self) -> Optional[builtins.str]:
        """
    ...
    def skip_roles(self) -> Optional[builtins.bool]:
        """
...
def get_user(compound_search_operator: Optional[builtins.str] = None,
             delay_read_seconds: Optional[builtins.str] = None,
             searches: Optional[Sequence[Union['GetUserSearchArgs', 'GetUserSearchArgsDict']]] = None,
             skip_groups: Optional[builtins.bool] = None,
             skip_roles: Optional[builtins.bool] = None,
    ...
    :param builtins.str compound_search_operator: Search operator used when joining multiple search clauses
    :param builtins.str delay_read_seconds: Force delay of the user read by N seconds. Useful when eventual consistency of user information needs to be allowed for.
    ...
    :param builtins.bool skip_groups: Do not populate user groups information (prevents additional API call)
    :param builtins.bool skip_roles: Do not populate user roles information (prevents additional API call)
    :param builtins.str user_id: Retrieve a single user based on their id
    """
    __args__ = dict()
...
def get_user_output(compound_search_operator: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                    delay_read_seconds: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                    ...
                    skip_roles: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
