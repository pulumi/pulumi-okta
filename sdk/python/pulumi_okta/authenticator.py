...
class AuthenticatorArgs:
    def __init__(__self__, *,
                 ...
                 legacy_ignore_name: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 provider_auth_port: Optional[pulumi.Input[builtins.int]] = None,
                 provider_host: Optional[pulumi.Input[builtins.str]] = None,
                 provider_hostname: Optional[pulumi.Input[builtins.str]] = None,
                 provider_integration_key: Optional[pulumi.Input[builtins.str]] = None,
                 provider_json: Optional[pulumi.Input[builtins.str]] = None,
                 provider_secret_key: Optional[pulumi.Input[builtins.str]] = None,
                 provider_shared_secret: Optional[pulumi.Input[builtins.str]] = None,
                 provider_user_name_template: Optional[pulumi.Input[builtins.str]] = None,
                 settings: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Authenticator resource.
        :param pulumi.Input[builtins.str] key: A human-readable string that identifies the authenticator. Some authenticators are available by feature flag on the organization. Possible values inclue: `duo`, `external_idp`, `google_otp`, `okta_email`, `okta_password`, `okta_verify`, `onprem_mfa`, `phone_number`, `rsa_token`, `security_question`, `webauthn`
        :param pulumi.Input[builtins.bool] legacy_ignore_name: Name does not trigger change detection (legacy behavior)
        :param pulumi.Input[builtins.str] name: Display name of the Authenticator
        :param pulumi.Input[builtins.int] provider_auth_port: The RADIUS server port (for example 1812). This is defined when the On-Prem RADIUS server is configured. Used only for authenticators with type `security_key`.  Conflicts with `provider_json` argument.
        :param pulumi.Input[builtins.str] provider_host: (DUO specific) - The Duo Security API hostname. Conflicts with `provider_json` argument.
        :param pulumi.Input[builtins.str] provider_hostname: Server host name or IP address. Default is `localhost`. Used only for authenticators with type `security_key`. Conflicts with `provider_json` argument.
        :param pulumi.Input[builtins.str] provider_integration_key: (DUO specific) - The Duo Security integration key.  Conflicts with `provider_json` argument.
        :param pulumi.Input[builtins.str] provider_json: Provider JSON allows for expressive providervalues. This argument conflicts with the other 'provider_xxx' arguments. The [CreateProvider](https://developer.okta.com/docs/reference/api/authenticators-admin/#request) illustrates detailed provider values for a Duo authenticator. [Provider values](https://developer.okta.com/docs/reference/api/authenticators-admin/#authenticators-administration-api-object)are listed in Okta API.
        :param pulumi.Input[builtins.str] provider_secret_key: (DUO specific) - The Duo Security secret key.  Conflicts with `provider_json` argument.
        :param pulumi.Input[builtins.str] provider_shared_secret: An authentication key that must be defined when the RADIUS server is configured, and must be the same on both the RADIUS client and server. Used only for authenticators with type `security_key`. Conflicts with `provider_json` argument.
        :param pulumi.Input[builtins.str] provider_user_name_template: Username template expected by the provider. Used only for authenticators with type `security_key`.  Conflicts with `provider_json` argument.
        :param pulumi.Input[builtins.str] settings: Settings for the authenticator. The settings JSON contains values based on Authenticator key. It is not used for authenticators with type `security_key`
        :param pulumi.Input[builtins.str] status: Authenticator status: `ACTIVE` or `INACTIVE`. Default: `ACTIVE`
        """
    ...
    def legacy_ignore_name(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def legacy_ignore_name(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def provider_auth_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def provider_auth_port(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "provider_auth_port", value)

    @property
    @pulumi.getter(name="providerHost")
    def provider_host(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def provider_host(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "provider_host", value)

    @property
    @pulumi.getter(name="providerHostname")
    def provider_hostname(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def provider_hostname(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "provider_hostname", value)

    @property
    @pulumi.getter(name="providerIntegrationKey")
    def provider_integration_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def provider_integration_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "provider_integration_key", value)

    @property
    @pulumi.getter(name="providerJson")
    def provider_json(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def provider_json(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "provider_json", value)

    @property
    @pulumi.getter(name="providerSecretKey")
    def provider_secret_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def provider_secret_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "provider_secret_key", value)

    @property
    @pulumi.getter(name="providerSharedSecret")
    def provider_shared_secret(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def provider_shared_secret(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "provider_shared_secret", value)

    @property
    @pulumi.getter(name="providerUserNameTemplate")
    def provider_user_name_template(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def provider_user_name_template(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _AuthenticatorState:
    def __init__(__self__, *,
                 ...
                 provider_host: Optional[pulumi.Input[builtins.str]] = None,
                 provider_hostname: Optional[pulumi.Input[builtins.str]] = None,
                 provider_instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 provider_integration_key: Optional[pulumi.Input[builtins.str]] = None,
                 provider_json: Optional[pulumi.Input[builtins.str]] = None,
                 provider_secret_key: Optional[pulumi.Input[builtins.str]] = None,
                 provider_shared_secret: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] provider_host: (DUO specific) - The Duo Security API hostname. Conflicts with `provider_json` argument.
        :param pulumi.Input[builtins.str] provider_hostname: Server host name or IP address. Default is `localhost`. Used only for authenticators with type `security_key`. Conflicts with `provider_json` argument.
        :param pulumi.Input[builtins.str] provider_instance_id: App Instance ID.
        :param pulumi.Input[builtins.str] provider_integration_key: (DUO specific) - The Duo Security integration key.  Conflicts with `provider_json` argument.
        :param pulumi.Input[builtins.str] provider_json: Provider JSON allows for expressive providervalues. This argument conflicts with the other 'provider_xxx' arguments. The [CreateProvider](https://developer.okta.com/docs/reference/api/authenticators-admin/#request) illustrates detailed provider values for a Duo authenticator. [Provider values](https://developer.okta.com/docs/reference/api/authenticators-admin/#authenticators-administration-api-object)are listed in Okta API.
        :param pulumi.Input[builtins.str] provider_secret_key: (DUO specific) - The Duo Security secret key.  Conflicts with `provider_json` argument.
        :param pulumi.Input[builtins.str] provider_shared_secret: An authentication key that must be defined when the RADIUS server is configured, and must be the same on both the RADIUS client and server. Used only for authenticators with type `security_key`. Conflicts with `provider_json` argument.
        :param pulumi.Input[builtins.str] provider_type: Provider type. Supported value for Duo: `DUO`. Supported value for Custom App: `PUSH`
        :param pulumi.Input[builtins.str] provider_user_name_template: Username template expected by the provider. Used only for authenticators with type `security_key`.  Conflicts with `provider_json` argument.
        :param pulumi.Input[builtins.str] settings: Settings for the authenticator. The settings JSON contains values based on Authenticator key. It is not used for authenticators with type `security_key`
        :param pulumi.Input[builtins.str] status: Authenticator status: `ACTIVE` or `INACTIVE`. Default: `ACTIVE`
        :param pulumi.Input[builtins.str] type: he type of Authenticator. Values include: `password`, `security_question`, `phone`, `email`, `app`, `federated`, and `security_key`.
        """
        if key is not None:
            pulumi.set(__self__, "key", key)
        if legacy_ignore_name is not None:
    ...
    def provider_instance_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        App Instance ID.
        """
    ...
    def provider_instance_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Authenticator(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            settings: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'Authenticator':
        """
    ...
    @property
    @pulumi.getter(name="legacyIgnoreName")
    def legacy_ignore_name(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Name does not trigger change detection (legacy behavior)
        """
        return pulumi.get(self, "legacy_ignore_name")
    ...
    @property
    @pulumi.getter(name="providerAuthPort")
    def provider_auth_port(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The RADIUS server port (for example 1812). This is defined when the On-Prem RADIUS server is configured. Used only for authenticators with type `security_key`.  Conflicts with `provider_json` argument.
        """
        return pulumi.get(self, "provider_auth_port")
    ...
    @property
    @pulumi.getter(name="providerHost")
    def provider_host(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        (DUO specific) - The Duo Security API hostname. Conflicts with `provider_json` argument.
        """
        return pulumi.get(self, "provider_host")
    ...
    @property
    @pulumi.getter(name="providerHostname")
    def provider_hostname(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Server host name or IP address. Default is `localhost`. Used only for authenticators with type `security_key`. Conflicts with `provider_json` argument.
        """
        return pulumi.get(self, "provider_hostname")
    ...
    @property
    @pulumi.getter(name="providerInstanceId")
    def provider_instance_id(self) -> pulumi.Output[builtins.str]:
        """
        App Instance ID.
        """
        return pulumi.get(self, "provider_instance_id")
    ...
    @property
    @pulumi.getter(name="providerIntegrationKey")
    def provider_integration_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        (DUO specific) - The Duo Security integration key.  Conflicts with `provider_json` argument.
        """
        return pulumi.get(self, "provider_integration_key")
    ...
    @property
    @pulumi.getter(name="providerJson")
    def provider_json(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Provider JSON allows for expressive providervalues. This argument conflicts with the other 'provider_xxx' arguments. The [CreateProvider](https://developer.okta.com/docs/reference/api/authenticators-admin/#request) illustrates detailed provider values for a Duo authenticator. [Provider values](https://developer.okta.com/docs/reference/api/authenticators-admin/#authenticators-administration-api-object)are listed in Okta API.
        """
        return pulumi.get(self, "provider_json")
    ...
    @property
    @pulumi.getter(name="providerSecretKey")
    def provider_secret_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        (DUO specific) - The Duo Security secret key.  Conflicts with `provider_json` argument.
        """
        return pulumi.get(self, "provider_secret_key")
    ...
    @property
    @pulumi.getter(name="providerSharedSecret")
    def provider_shared_secret(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        An authentication key that must be defined when the RADIUS server is configured, and must be the same on both the RADIUS client and server. Used only for authenticators with type `security_key`. Conflicts with `provider_json` argument.
        """
        return pulumi.get(self, "provider_shared_secret")
    ...
    @property
    @pulumi.getter(name="providerUserNameTemplate")
    def provider_user_name_template(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Username template expected by the provider. Used only for authenticators with type `security_key`.  Conflicts with `provider_json` argument.
        """
        return pulumi.get(self, "provider_user_name_template")
