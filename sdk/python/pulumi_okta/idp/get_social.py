...
class GetSocialResult:
    ...
    def account_link_action(self) -> _builtins.str:
        """
    ...
    def account_link_group_includes(self) -> Sequence[_builtins.str]:
        """
    ...
    def authorization_binding(self) -> _builtins.str:
        """
    ...
    def deprovisioned_action(self) -> _builtins.str:
        """
    ...
    def groups_action(self) -> _builtins.str:
        """
    ...
    def groups_assignments(self) -> Sequence[_builtins.str]:
        """
    ...
    def groups_filters(self) -> Sequence[_builtins.str]:
        """
    ...
    def profile_master(self) -> _builtins.bool:
        """
    ...
    def provisioning_action(self) -> _builtins.str:
        """
    ...
    def subject_match_attribute(self) -> _builtins.str:
        """
    ...
    def subject_match_type(self) -> _builtins.str:
        """
    ...
    def suspended_action(self) -> _builtins.str:
        """
    ...
    def token_binding(self) -> _builtins.str:
        """
    ...
    def username_template(self) -> _builtins.str:
        """
...
def get_social(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: The id of the social idp to retrieve, conflicts with `name`.
    :param _builtins.str name: The name of the social idp to retrieve, conflicts with `id`.
    """
    __args__ = dict()
    __args__['id'] = id
    __args__['name'] = name
...
def get_social_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
