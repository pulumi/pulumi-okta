...
class GetSocialResult:
    ...
    def account_link_group_includes(self) -> Sequence[builtins.str]:
        """
    ...
    def groups_assignments(self) -> Sequence[builtins.str]:
        """
    ...
    def groups_filters(self) -> Sequence[builtins.str]:
        """
    ...
    def profile_master(self) -> builtins.bool:
        """
...
def get_social(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The id of the social idp to retrieve, conflicts with `name`.
    :param builtins.str name: The name of the social idp to retrieve, conflicts with `id`.
    """
    __args__ = dict()
    __args__['id'] = id
    __args__['name'] = name
...
def get_social_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
