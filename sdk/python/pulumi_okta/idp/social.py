...
class SocialArgs:
    def __init__(__self__, *,
                 ...
                 apple_kid: Optional[pulumi.Input[builtins.str]] = None,
                 apple_private_key: Optional[pulumi.Input[builtins.str]] = None,
                 apple_team_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] type: Identity Provider Types: https://developer.okta.com/docs/reference/api/idps/#identity-provider-type
        ...
        :param pulumi.Input[builtins.str] apple_kid: The Key ID that you obtained from Apple when you created the private key for the client
        :param pulumi.Input[builtins.str] apple_private_key: The Key ID that you obtained from Apple when you created the private key for the client. PrivateKey is required when resource is first created. For all consecutive updates, it can be empty/omitted and keeps the existing value if it is empty/omitted. PrivateKey isn't returned when importing this resource.
        :param pulumi.Input[builtins.str] apple_team_id: The Team ID associated with your Apple developer account
        ...
        :param pulumi.Input[builtins.str] issuer_mode: Indicates whether Okta uses the original Okta org domain URL, or a custom domain URL. It can be `ORG_URL` or `CUSTOM_URL`. Default: `ORG_URL`
        ...
        :param pulumi.Input[builtins.str] protocol_type: The type of protocol to use. It can be `OIDC` or `OAUTH2`. Default: `OAUTH2`
    ...
    def apple_kid(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @apple_kid.setter
    def apple_kid(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "apple_kid", value)

    @property
    @pulumi.getter(name="applePrivateKey")
    def apple_private_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def apple_private_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "apple_private_key", value)

    @property
    @pulumi.getter(name="appleTeamId")
    def apple_team_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def apple_team_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _SocialState:
    def __init__(__self__, *,
                 ...
                 trust_audience: Optional[pulumi.Input[builtins.str]] = None,
                 trust_issuer: Optional[pulumi.Input[builtins.str]] = None,
                 trust_kid: Optional[pulumi.Input[builtins.str]] = None,
                 trust_revocation: Optional[pulumi.Input[builtins.str]] = None,
                 trust_revocation_cache_lifetime: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] trust_audience: Trust audience for the Okta IdP instance.
        :param pulumi.Input[builtins.str] trust_issuer: Trust issuer for the Okta IdP instance.
        :param pulumi.Input[builtins.str] trust_kid: Trust kid for the Okta IdP instance.
        :param pulumi.Input[builtins.str] trust_revocation: Trust revocation for the Okta IdP instance.
        :param pulumi.Input[builtins.int] trust_revocation_cache_lifetime: Trust revocation cache lifetime for the Okta IdP instance.
        :param pulumi.Input[builtins.str] type: Identity Provider Types: https://developer.okta.com/docs/reference/api/idps/#identity-provider-type
        :param pulumi.Input[builtins.str] username_template: Okta EL Expression to generate or transform a unique username for the IdP user. Default: `idpuser.email`
        """
        if account_link_action is not None:
    ...
    def trust_audience(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def trust_audience(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "trust_audience", value)

    @property
    @pulumi.getter(name="trustIssuer")
    def trust_issuer(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @trust_issuer.setter
    def trust_issuer(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "trust_issuer", value)

    @property
    @pulumi.getter(name="trustKid")
    def trust_kid(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @trust_kid.setter
    def trust_kid(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "trust_kid", value)

    @property
    @pulumi.getter(name="trustRevocation")
    def trust_revocation(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def trust_revocation(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "trust_revocation", value)

    @property
    @pulumi.getter(name="trustRevocationCacheLifetime")
    def trust_revocation_cache_lifetime(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def trust_revocation_cache_lifetime(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Social(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            trust_revocation_cache_lifetime: Optional[pulumi.Input[builtins.int]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            username_template: Optional[pulumi.Input[builtins.str]] = None) -> 'Social':
        """
    ...
    @property
    @pulumi.getter(name="appleKid")
    def apple_kid(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Key ID that you obtained from Apple when you created the private key for the client
        """
        return pulumi.get(self, "apple_kid")
    ...
    @property
    @pulumi.getter(name="applePrivateKey")
    def apple_private_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Key ID that you obtained from Apple when you created the private key for the client. PrivateKey is required when resource is first created. For all consecutive updates, it can be empty/omitted and keeps the existing value if it is empty/omitted. PrivateKey isn't returned when importing this resource.
        """
        return pulumi.get(self, "apple_private_key")
    ...
    @property
    @pulumi.getter(name="appleTeamId")
    def apple_team_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Team ID associated with your Apple developer account
        """
        return pulumi.get(self, "apple_team_id")
    ...
    @property
    @pulumi.getter(name="trustAudience")
    def trust_audience(self) -> pulumi.Output[builtins.str]:
        """
        Trust audience for the Okta IdP instance.
        """
        return pulumi.get(self, "trust_audience")
    ...
    @property
    @pulumi.getter(name="trustIssuer")
    def trust_issuer(self) -> pulumi.Output[builtins.str]:
        """
        Trust issuer for the Okta IdP instance.
        """
        return pulumi.get(self, "trust_issuer")
    ...
    @property
    @pulumi.getter(name="trustKid")
    def trust_kid(self) -> pulumi.Output[builtins.str]:
        """
        Trust kid for the Okta IdP instance.
        """
        return pulumi.get(self, "trust_kid")
    ...
    @property
    @pulumi.getter(name="trustRevocation")
    def trust_revocation(self) -> pulumi.Output[builtins.str]:
        """
        Trust revocation for the Okta IdP instance.
        """
        return pulumi.get(self, "trust_revocation")
    ...
    @property
    @pulumi.getter(name="trustRevocationCacheLifetime")
    def trust_revocation_cache_lifetime(self) -> pulumi.Output[builtins.int]:
        """
        Trust revocation cache lifetime for the Okta IdP instance.
        """
        return pulumi.get(self, "trust_revocation_cache_lifetime")
