...
class GetSamlResult:
    ...
    def subject_formats(self) -> Sequence[builtins.str]:
        """
...
def get_saml(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: Id of idp.
    :param builtins.str name: Name of the idp.
    """
    __args__ = dict()
    __args__['id'] = id
    __args__['name'] = name
...
def get_saml_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
