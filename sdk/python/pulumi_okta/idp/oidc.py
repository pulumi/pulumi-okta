...
class OidcArgs:
    def __init__(__self__, *,
                 authorization_binding: pulumi.Input[builtins.str],
                 ...
                 jwks_binding: pulumi.Input[builtins.str],
                 jwks_url: pulumi.Input[builtins.str],
                 scopes: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 token_binding: pulumi.Input[builtins.str],
                 token_url: pulumi.Input[builtins.str],
                 account_link_action: Optional[pulumi.Input[builtins.str]] = None,
                 account_link_group_includes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 deprovisioned_action: Optional[pulumi.Input[builtins.str]] = None,
                 groups_action: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 pkce_required: Optional[pulumi.Input[builtins.bool]] = None,
                 profile_master: Optional[pulumi.Input[builtins.bool]] = None,
                 protocol_type: Optional[pulumi.Input[builtins.str]] = None,
                 provisioning_action: Optional[pulumi.Input[builtins.str]] = None,
                 request_signature_algorithm: Optional[pulumi.Input[builtins.str]] = None,
                 request_signature_scope: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 subject_match_attribute: Optional[pulumi.Input[builtins.str]] = None,
                 subject_match_type: Optional[pulumi.Input[builtins.str]] = None,
                 suspended_action: Optional[pulumi.Input[builtins.str]] = None,
                 user_info_binding: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] authorization_binding: The method of making an authorization request. It can be set to `HTTP-POST` or `HTTP-REDIRECT`.
        :param pulumi.Input[builtins.str] authorization_url: IdP Authorization Server (AS) endpoint to request consent from the user and obtain an authorization code grant.
        :param pulumi.Input[builtins.str] client_id: Unique identifier issued by AS for the Okta IdP instance.
        :param pulumi.Input[builtins.str] client_secret: Client secret issued by AS for the Okta IdP instance.
        :param pulumi.Input[builtins.str] issuer_url: URI that identifies the issuer.
        :param pulumi.Input[builtins.str] jwks_binding: The method of making a request for the OIDC JWKS. It can be set to `HTTP-POST` or `HTTP-REDIRECT`
        :param pulumi.Input[builtins.str] jwks_url: Endpoint where the keys signer publishes its keys in a JWK Set.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] scopes: The scopes of the IdP.
        :param pulumi.Input[builtins.str] token_binding: The method of making a token request. It can be set to `HTTP-POST` or `HTTP-REDIRECT`.
        :param pulumi.Input[builtins.str] token_url: IdP Authorization Server (AS) endpoint to exchange the authorization code grant for an access token.
        :param pulumi.Input[builtins.str] account_link_action: Specifies the account linking action for an IdP user. Default: `AUTO`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] account_link_group_includes: Group memberships to determine link candidates.
        :param pulumi.Input[builtins.str] deprovisioned_action: Action for a previously deprovisioned IdP user during authentication. Can be `NONE` or `REACTIVATE`. Default: `NONE`
        :param pulumi.Input[builtins.str] groups_action: Provisioning action for IdP user's group memberships. It can be `NONE`, `SYNC`, `APPEND`, or `ASSIGN`. Default: `NONE`
        ...
        :param pulumi.Input[builtins.str] issuer_mode: Indicates whether Okta uses the original Okta org domain URL, a custom domain URL, or dynamic. It can be `ORG_URL`, `CUSTOM_URL`, or `DYNAMIC`. Default: `ORG_URL`
        ...
        :param pulumi.Input[builtins.bool] pkce_required: Require Proof Key for Code Exchange (PKCE) for additional verification key rotation mode. See: https://developer.okta.com/docs/reference/api/idps/#oauth-2-0-and-openid-connect-client-object
        :param pulumi.Input[builtins.bool] profile_master: Determines if the IdP should act as a source of truth for user profile attributes.
        :param pulumi.Input[builtins.str] protocol_type: The type of protocol to use. It can be `OIDC` or `OAUTH2`. Default: `OIDC`
        :param pulumi.Input[builtins.str] provisioning_action: Provisioning action for an IdP user during authentication. Default: `AUTO`
        :param pulumi.Input[builtins.str] request_signature_algorithm: The HMAC Signature Algorithm used when signing an authorization request. Defaults to `HS256`. It can be `HS256`, `HS384`, `HS512`, `SHA-256`. `RS256`, `RS384`, or `RS512`. NOTE: `SHA-256` an undocumented legacy value and not continue to be valid. See API docs https://developer.okta.com/docs/reference/api/idps/#oidc-request-signature-algorithm-object
        :param pulumi.Input[builtins.str] request_signature_scope: Specifies whether to digitally sign an AuthnRequest messages to the IdP. Defaults to `REQUEST`. It can be `REQUEST` or `NONE`.
        :param pulumi.Input[builtins.str] status: Default to `ACTIVE`
        :param pulumi.Input[builtins.str] subject_match_attribute: Okta user profile attribute for matching transformed IdP username. Only for matchType `CUSTOM_ATTRIBUTE`.
        :param pulumi.Input[builtins.str] subject_match_type: Determines the Okta user profile attribute match conditions for account linking and authentication of the transformed IdP username. By default, it is set to `USERNAME`. It can be set to `USERNAME`, `EMAIL`, `USERNAME_OR_EMAIL` or `CUSTOM_ATTRIBUTE`.
        :param pulumi.Input[builtins.str] suspended_action: Action for a previously suspended IdP user during authentication. Can be `NONE` or `REACTIVATE`. Default: `NONE`
        :param pulumi.Input[builtins.str] user_info_url: Protected resource endpoint that returns claims about the authenticated user.
        :param pulumi.Input[builtins.str] username_template: Okta EL Expression to generate or transform a unique username for the IdP user. Default: `idpuser.email`
        """
    ...
    def authorization_binding(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def authorization_binding(self, value: pulumi.Input[builtins.str]):
    ...
    def jwks_binding(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @jwks_binding.setter
    def jwks_binding(self, value: pulumi.Input[builtins.str]):
    ...
    def token_binding(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def token_binding(self, value: pulumi.Input[builtins.str]):
    ...
    def account_link_action(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def account_link_action(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "account_link_action", value)

    @property
    @pulumi.getter(name="accountLinkGroupIncludes")
    def account_link_group_includes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def account_link_group_includes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "account_link_group_includes", value)

    @property
    @pulumi.getter(name="deprovisionedAction")
    def deprovisioned_action(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def deprovisioned_action(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "deprovisioned_action", value)

    @property
    @pulumi.getter(name="groupsAction")
    def groups_action(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def groups_action(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "groups_action", value)

    @property
    @pulumi.getter(name="groupsAssignments")
    def groups_assignments(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def groups_assignments(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def groups_filters(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def pkce_required(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def pkce_required(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "pkce_required", value)

    @property
    @pulumi.getter(name="profileMaster")
    def profile_master(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def profile_master(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def request_signature_algorithm(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def request_signature_algorithm(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "request_signature_algorithm", value)

    @property
    @pulumi.getter(name="requestSignatureScope")
    def request_signature_scope(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def request_signature_scope(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def subject_match_attribute(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def subject_match_attribute(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "subject_match_attribute", value)

    @property
    @pulumi.getter(name="subjectMatchType")
    def subject_match_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def subject_match_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "subject_match_type", value)

    @property
    @pulumi.getter(name="suspendedAction")
    def suspended_action(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def suspended_action(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "suspended_action", value)

    @property
    @pulumi.getter(name="userInfoBinding")
    def user_info_binding(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "user_info_binding")

    @user_info_binding.setter
    def user_info_binding(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _OidcState:
    def __init__(__self__, *,
                 account_link_action: Optional[pulumi.Input[builtins.str]] = None,
                 account_link_group_includes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 authorization_binding: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 jwks_binding: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 subject_match_type: Optional[pulumi.Input[builtins.str]] = None,
                 suspended_action: Optional[pulumi.Input[builtins.str]] = None,
                 token_binding: Optional[pulumi.Input[builtins.str]] = None,
                 token_url: Optional[pulumi.Input[builtins.str]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None,
                 user_info_binding: Optional[pulumi.Input[builtins.str]] = None,
                 user_info_url: Optional[pulumi.Input[builtins.str]] = None,
                 user_type_id: Optional[pulumi.Input[builtins.str]] = None,
                 username_template: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] token_binding: The method of making a token request. It can be set to `HTTP-POST` or `HTTP-REDIRECT`.
        :param pulumi.Input[builtins.str] token_url: IdP Authorization Server (AS) endpoint to exchange the authorization code grant for an access token.
        :param pulumi.Input[builtins.str] type: Type of OIDC IdP.
        :param pulumi.Input[builtins.str] user_info_url: Protected resource endpoint that returns claims about the authenticated user.
        :param pulumi.Input[builtins.str] user_type_id: User type ID. Can be used as `target_id` in the `profile.Mapping` resource.
        :param pulumi.Input[builtins.str] username_template: Okta EL Expression to generate or transform a unique username for the IdP user. Default: `idpuser.email`
        """
        if account_link_action is not None:
            pulumi.set(__self__, "account_link_action", account_link_action)
    ...
    @property
    @pulumi.getter(name="authorizationBinding")
    def authorization_binding(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The method of making an authorization request. It can be set to `HTTP-POST` or `HTTP-REDIRECT`.
        """
        return pulumi.get(self, "authorization_binding")
    ...
    @authorization_binding.setter
    def authorization_binding(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "authorization_binding", value)
    ...
    @property
    @pulumi.getter(name="jwksBinding")
    def jwks_binding(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The method of making a request for the OIDC JWKS. It can be set to `HTTP-POST` or `HTTP-REDIRECT`
        """
        return pulumi.get(self, "jwks_binding")
    ...
    @jwks_binding.setter
    def jwks_binding(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "jwks_binding", value)
    ...
    @property
    @pulumi.getter(name="tokenBinding")
    def token_binding(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The method of making a token request. It can be set to `HTTP-POST` or `HTTP-REDIRECT`.
        """
        return pulumi.get(self, "token_binding")
    ...
    @token_binding.setter
    def token_binding(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "token_binding", value)
    ...
    def user_type_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @user_type_id.setter
    def user_type_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Oidc(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            user_info_url: Optional[pulumi.Input[builtins.str]] = None,
            user_type_id: Optional[pulumi.Input[builtins.str]] = None,
            username_template: Optional[pulumi.Input[builtins.str]] = None) -> 'Oidc':
        """
    ...
    @property
    @pulumi.getter(name="accountLinkAction")
    def account_link_action(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the account linking action for an IdP user. Default: `AUTO`
        """
        return pulumi.get(self, "account_link_action")
    ...
    @property
    @pulumi.getter(name="accountLinkGroupIncludes")
    def account_link_group_includes(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Group memberships to determine link candidates.
        """
        return pulumi.get(self, "account_link_group_includes")
    ...
    @property
    @pulumi.getter(name="authorizationBinding")
    def authorization_binding(self) -> pulumi.Output[builtins.str]:
        """
        The method of making an authorization request. It can be set to `HTTP-POST` or `HTTP-REDIRECT`.
        """
        return pulumi.get(self, "authorization_binding")
    ...
    @property
    @pulumi.getter(name="deprovisionedAction")
    def deprovisioned_action(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Action for a previously deprovisioned IdP user during authentication. Can be `NONE` or `REACTIVATE`. Default: `NONE`
        """
        return pulumi.get(self, "deprovisioned_action")
    ...
    @property
    @pulumi.getter(name="groupsAction")
    def groups_action(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Provisioning action for IdP user's group memberships. It can be `NONE`, `SYNC`, `APPEND`, or `ASSIGN`. Default: `NONE`
        """
        return pulumi.get(self, "groups_action")
    ...
    @property
    @pulumi.getter(name="groupsAssignments")
    def groups_assignments(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of Okta Group IDs to add an IdP user as a member with the `ASSIGN` `groups_action`.
        """
        return pulumi.get(self, "groups_assignments")
    ...
    @property
    @pulumi.getter(name="groupsFilters")
    def groups_filters(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Whitelist of Okta Group identifiers that are allowed for the `APPEND` or `SYNC` `groups_action`.
        """
        return pulumi.get(self, "groups_filters")
    ...
    @property
    @pulumi.getter(name="issuerMode")
    def issuer_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Indicates whether Okta uses the original Okta org domain URL, a custom domain URL, or dynamic. It can be `ORG_URL`, `CUSTOM_URL`, or `DYNAMIC`. Default: `ORG_URL`
        """
        return pulumi.get(self, "issuer_mode")
    ...
    @property
    @pulumi.getter(name="jwksBinding")
    def jwks_binding(self) -> pulumi.Output[builtins.str]:
        """
        The method of making a request for the OIDC JWKS. It can be set to `HTTP-POST` or `HTTP-REDIRECT`
        """
        return pulumi.get(self, "jwks_binding")
    ...
    @property
    @pulumi.getter(name="pkceRequired")
    def pkce_required(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Require Proof Key for Code Exchange (PKCE) for additional verification key rotation mode. See: https://developer.okta.com/docs/reference/api/idps/#oauth-2-0-and-openid-connect-client-object
        """
        return pulumi.get(self, "pkce_required")
    ...
    @property
    @pulumi.getter(name="profileMaster")
    def profile_master(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Determines if the IdP should act as a source of truth for user profile attributes.
        """
        return pulumi.get(self, "profile_master")
    ...
    @property
    @pulumi.getter(name="requestSignatureAlgorithm")
    def request_signature_algorithm(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The HMAC Signature Algorithm used when signing an authorization request. Defaults to `HS256`. It can be `HS256`, `HS384`, `HS512`, `SHA-256`. `RS256`, `RS384`, or `RS512`. NOTE: `SHA-256` an undocumented legacy value and not continue to be valid. See API docs https://developer.okta.com/docs/reference/api/idps/#oidc-request-signature-algorithm-object
        """
        return pulumi.get(self, "request_signature_algorithm")
    ...
    @property
    @pulumi.getter(name="requestSignatureScope")
    def request_signature_scope(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies whether to digitally sign an AuthnRequest messages to the IdP. Defaults to `REQUEST`. It can be `REQUEST` or `NONE`.
        """
        return pulumi.get(self, "request_signature_scope")
    ...
    @property
    @pulumi.getter(name="subjectMatchAttribute")
    def subject_match_attribute(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Okta user profile attribute for matching transformed IdP username. Only for matchType `CUSTOM_ATTRIBUTE`.
        """
        return pulumi.get(self, "subject_match_attribute")
    ...
    @property
    @pulumi.getter(name="subjectMatchType")
    def subject_match_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Determines the Okta user profile attribute match conditions for account linking and authentication of the transformed IdP username. By default, it is set to `USERNAME`. It can be set to `USERNAME`, `EMAIL`, `USERNAME_OR_EMAIL` or `CUSTOM_ATTRIBUTE`.
        """
        return pulumi.get(self, "subject_match_type")
    ...
    @property
    @pulumi.getter(name="suspendedAction")
    def suspended_action(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Action for a previously suspended IdP user during authentication. Can be `NONE` or `REACTIVATE`. Default: `NONE`
        """
        return pulumi.get(self, "suspended_action")
    ...
    @property
    @pulumi.getter(name="tokenBinding")
    def token_binding(self) -> pulumi.Output[builtins.str]:
        """
        The method of making a token request. It can be set to `HTTP-POST` or `HTTP-REDIRECT`.
        """
        return pulumi.get(self, "token_binding")
    ...
    @property
    @pulumi.getter(name="userInfoBinding")
    def user_info_binding(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "user_info_binding")
    ...
    @property
    @pulumi.getter(name="userTypeId")
    def user_type_id(self) -> pulumi.Output[builtins.str]:
        """
        User type ID. Can be used as `target_id` in the `profile.Mapping` resource.
        """
        return pulumi.get(self, "user_type_id")
