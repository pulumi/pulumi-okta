...
class SamlKeyArgs:
    def __init__(__self__, *,
                 x5cs: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        The set of arguments for constructing a SamlKey resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] x5cs: base64-encoded X.509 certificate chain with DER encoding
        """
        pulumi.set(__self__, "x5cs", x5cs)

    @property
    @pulumi.getter
    def x5cs(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    @x5cs.setter
    def x5cs(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class _SamlKeyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] created: Date created.
        :param pulumi.Input[builtins.str] expires_at: Date the cert expires.
        :param pulumi.Input[builtins.str] kid: Key ID.
        :param pulumi.Input[builtins.str] kty: Identifies the cryptographic algorithm family used with the key.
        :param pulumi.Input[builtins.str] use: Intended use of the public key.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] x5cs: base64-encoded X.509 certificate chain with DER encoding
        :param pulumi.Input[builtins.str] x5t_s256: base64url-encoded SHA-256 thumbprint of the DER encoding of an X.509 certificate.
        """
...
class SamlKey(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            use: Optional[pulumi.Input[builtins.str]] = None,
            x5cs: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            x5t_s256: Optional[pulumi.Input[builtins.str]] = None) -> 'SamlKey':
        """
    ...
    @property
    @pulumi.getter
    def kty(self) -> pulumi.Output[builtins.str]:
        """
        Identifies the cryptographic algorithm family used with the key.
        """
        return pulumi.get(self, "kty")
    ...
    @property
    @pulumi.getter
    def x5cs(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        base64-encoded X.509 certificate chain with DER encoding
        """
        return pulumi.get(self, "x5cs")
    ...
    @property
    @pulumi.getter(name="x5tS256")
    def x5t_s256(self) -> pulumi.Output[builtins.str]:
        """
        base64url-encoded SHA-256 thumbprint of the DER encoding of an X.509 certificate.
        """
        return pulumi.get(self, "x5t_s256")
