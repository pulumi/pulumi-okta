...
class GetMetadataSamlResult:
    ...
    def assertions_signed(self) -> builtins.bool:
        """
    ...
    def authn_request_signed(self) -> builtins.bool:
        """
...
def get_metadata_saml(idp_id: Optional[builtins.str] = None,
    ...
    :param builtins.str idp_id: The id of the IdP to retrieve metadata for.
    """
    __args__ = dict()
...
def get_metadata_saml_output(idp_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
