...
class PolicyMfaDefaultArgs:
    def __init__(__self__, *,
        ...
        """
        PolicyMfaDefaultArgs._configure(
...
class _PolicyMfaDefaultState:
    def __init__(__self__, *,
        ...
        """
        _PolicyMfaDefaultState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
...
class PolicyMfaDefault(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a PolicyMfaDefault resource with the given unique name, props, and options.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            PolicyMfaDefaultArgs._configure(_setter, **kwargs)
