...
class OrgSupportArgs:
    def __init__(__self__, *,
                 extend_by: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a OrgSupport resource.
        :param pulumi.Input[builtins.int] extend_by: Number of days the support should be extended by
        """
    ...
    def extend_by(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @extend_by.setter
    def extend_by(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _OrgSupportState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] expiration: Expiration of Okta Support
        :param pulumi.Input[builtins.int] extend_by: Number of days the support should be extended by
        :param pulumi.Input[builtins.str] status: Status of Okta Support
        """
...
class OrgSupport(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            expiration: Optional[pulumi.Input[builtins.str]] = None,
            extend_by: Optional[pulumi.Input[builtins.int]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'OrgSupport':
        """
    ...
    @property
    @pulumi.getter(name="extendBy")
    def extend_by(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Number of days the support should be extended by
        """
        return pulumi.get(self, "extend_by")
