...
class PolicyProfileEnrollmentAppsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] policy_id: ID of the enrollment policy.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] apps: List of app IDs to be added to this policy
        """
...
class _PolicyProfileEnrollmentAppsState:
    def __init__(__self__, *,
                 apps: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 default_policy_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] apps: List of app IDs to be added to this policy
        :param pulumi.Input[builtins.str] default_policy_id: ID of the Default Enrollment Policy. This policy is used as a policy to re-assign apps to when they are unassigned from this one
        :param pulumi.Input[builtins.str] policy_id: ID of the enrollment policy.
        """
        if apps is not None:
            pulumi.set(__self__, "apps", apps)
    ...
    def default_policy_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_policy_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("okta:index/policyProfileEnrollmentApps:PolicyProfileEnrollmentApps")
class PolicyProfileEnrollmentApps(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            apps: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            default_policy_id: Optional[pulumi.Input[builtins.str]] = None,
            policy_id: Optional[pulumi.Input[builtins.str]] = None) -> 'PolicyProfileEnrollmentApps':
        """
    ...
    @property
    @pulumi.getter
    def apps(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of app IDs to be added to this policy
        """
        return pulumi.get(self, "apps")
    ...
    @property
    @pulumi.getter(name="defaultPolicyId")
    def default_policy_id(self) -> pulumi.Output[builtins.str]:
        """
        ID of the Default Enrollment Policy. This policy is used as a policy to re-assign apps to when they are unassigned from this one
        """
        return pulumi.get(self, "default_policy_id")
