...
class PolicyRuleProfileEnrollmentArgs:
    def __init__(__self__, *,
                 ...
                 unknown_user_action: pulumi.Input[builtins.str],
                 access: Optional[pulumi.Input[builtins.str]] = None,
                 email_verification: Optional[pulumi.Input[builtins.bool]] = None,
                 enroll_authenticator_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 progressive_profiling_action: Optional[pulumi.Input[builtins.str]] = None,
                 target_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 ui_schema_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] unknown_user_action: Which action should be taken if this User is new. Valid values are: `DENY`, `REGISTER`
        :param pulumi.Input[builtins.str] access: Allow or deny access based on the rule conditions. Valid values are: `ALLOW`, `DENY`. Default: `ALLOW`.
        :param pulumi.Input[builtins.bool] email_verification: Indicates whether email verification should occur before access is granted. Default: `true`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] enroll_authenticator_types: Enrolls authenticator types
        :param pulumi.Input[builtins.str] inline_hook_id: ID of a Registration Inline Hook
        ...
        :param pulumi.Input[builtins.str] progressive_profiling_action: Enabled or disabled progressive profiling action rule conditions: `ENABLED` or `DISABLED`. Default: `DISABLED`
        :param pulumi.Input[builtins.str] target_group_id: The ID of a Group that this User should be added to
        :param pulumi.Input[builtins.str] ui_schema_id: Value created by the backend. If present all policy updates must include this attribute/value.
        """
    ...
    def unknown_user_action(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def unknown_user_action(self, value: pulumi.Input[builtins.str]):
    ...
    def email_verification(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def email_verification(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "email_verification", value)

    @property
    @pulumi.getter(name="enrollAuthenticatorTypes")
    def enroll_authenticator_types(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def enroll_authenticator_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def progressive_profiling_action(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def progressive_profiling_action(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def ui_schema_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @ui_schema_id.setter
    def ui_schema_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _PolicyRuleProfileEnrollmentState:
    def __init__(__self__, *,
                 ...
                 target_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 ui_schema_id: Optional[pulumi.Input[builtins.str]] = None,
                 unknown_user_action: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="unknownUserAction")
    def unknown_user_action(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Which action should be taken if this User is new. Valid values are: `DENY`, `REGISTER`
        """
        return pulumi.get(self, "unknown_user_action")
    ...
    @unknown_user_action.setter
    def unknown_user_action(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "unknown_user_action", value)
...
class PolicyRuleProfileEnrollment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            target_group_id: Optional[pulumi.Input[builtins.str]] = None,
            ui_schema_id: Optional[pulumi.Input[builtins.str]] = None,
            unknown_user_action: Optional[pulumi.Input[builtins.str]] = None) -> 'PolicyRuleProfileEnrollment':
        """
    ...
    @property
    @pulumi.getter(name="emailVerification")
    def email_verification(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether email verification should occur before access is granted. Default: `true`.
        """
        return pulumi.get(self, "email_verification")
    ...
    @property
    @pulumi.getter(name="enrollAuthenticatorTypes")
    def enroll_authenticator_types(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Enrolls authenticator types
        """
        return pulumi.get(self, "enroll_authenticator_types")
    ...
    @property
    @pulumi.getter(name="progressiveProfilingAction")
    def progressive_profiling_action(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Enabled or disabled progressive profiling action rule conditions: `ENABLED` or `DISABLED`. Default: `DISABLED`
        """
        return pulumi.get(self, "progressive_profiling_action")
    ...
    @property
    @pulumi.getter(name="uiSchemaId")
    def ui_schema_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Value created by the backend. If present all policy updates must include this attribute/value.
        """
        return pulumi.get(self, "ui_schema_id")
    ...
    @property
    @pulumi.getter(name="unknownUserAction")
    def unknown_user_action(self) -> pulumi.Output[builtins.str]:
        """
        Which action should be taken if this User is new. Valid values are: `DENY`, `REGISTER`
        """
        return pulumi.get(self, "unknown_user_action")
