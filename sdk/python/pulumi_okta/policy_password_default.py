...
class PolicyPasswordDefaultArgs:
    def __init__(__self__, *,
                 call_recovery: Optional[pulumi.Input[builtins.str]] = None,
                 email_recovery: Optional[pulumi.Input[builtins.str]] = None,
                 password_auto_unlock_minutes: Optional[pulumi.Input[builtins.int]] = None,
                 password_dictionary_lookup: Optional[pulumi.Input[builtins.bool]] = None,
                 password_exclude_first_name: Optional[pulumi.Input[builtins.bool]] = None,
                 password_exclude_last_name: Optional[pulumi.Input[builtins.bool]] = None,
                 password_exclude_username: Optional[pulumi.Input[builtins.bool]] = None,
                 password_expire_warn_days: Optional[pulumi.Input[builtins.int]] = None,
                 password_history_count: Optional[pulumi.Input[builtins.int]] = None,
                 password_lockout_notification_channels: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 password_max_age_days: Optional[pulumi.Input[builtins.int]] = None,
                 password_max_lockout_attempts: Optional[pulumi.Input[builtins.int]] = None,
                 password_min_age_minutes: Optional[pulumi.Input[builtins.int]] = None,
                 password_min_length: Optional[pulumi.Input[builtins.int]] = None,
                 password_min_lowercase: Optional[pulumi.Input[builtins.int]] = None,
                 password_min_number: Optional[pulumi.Input[builtins.int]] = None,
                 password_min_symbol: Optional[pulumi.Input[builtins.int]] = None,
                 password_min_uppercase: Optional[pulumi.Input[builtins.int]] = None,
                 password_show_lockout_failures: Optional[pulumi.Input[builtins.bool]] = None,
                 question_min_length: Optional[pulumi.Input[builtins.int]] = None,
                 question_recovery: Optional[pulumi.Input[builtins.str]] = None,
                 recovery_email_token: Optional[pulumi.Input[builtins.int]] = None,
                 skip_unlock: Optional[pulumi.Input[builtins.bool]] = None,
                 sms_recovery: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a PolicyPasswordDefault resource.
        :param pulumi.Input[builtins.str] call_recovery: Enable or disable voice call recovery: ACTIVE or INACTIVE. Default: `INACTIVE`
        :param pulumi.Input[builtins.str] email_recovery: Enable or disable email password recovery: ACTIVE or INACTIVE. Default: `ACTIVE`
        :param pulumi.Input[builtins.int] password_auto_unlock_minutes: Number of minutes before a locked account is unlocked: 0 = no limit. Default: `0`
        :param pulumi.Input[builtins.bool] password_dictionary_lookup: Check Passwords Against Common Password Dictionary. Default: `false`
        :param pulumi.Input[builtins.bool] password_exclude_first_name: User firstName attribute must be excluded from the password
        :param pulumi.Input[builtins.bool] password_exclude_last_name: User lastName attribute must be excluded from the password
        :param pulumi.Input[builtins.bool] password_exclude_username: If the user name must be excluded from the password. Default: `true`
        :param pulumi.Input[builtins.int] password_expire_warn_days: Length in days a user will be warned before password expiry: 0 = no warning. Default: `0`
        :param pulumi.Input[builtins.int] password_history_count: Number of distinct passwords that must be created before they can be reused: 0 = none. Default: `4`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] password_lockout_notification_channels: Notification channels to use to notify a user when their account has been locked.
        :param pulumi.Input[builtins.int] password_max_age_days: Length in days a password is valid before expiry: 0 = no limit. Default: `0`
        :param pulumi.Input[builtins.int] password_max_lockout_attempts: Number of unsuccessful login attempts allowed before lockout: 0 = no limit. Default: `10`
        :param pulumi.Input[builtins.int] password_min_age_minutes: Minimum time interval in minutes between password changes: 0 = no limit. Default: `0`
        :param pulumi.Input[builtins.int] password_min_length: Minimum password length. Default is `8`.
        :param pulumi.Input[builtins.int] password_min_lowercase: If a password must contain at least one lower case letter: 0 = no, 1 = yes. Default = 1
        :param pulumi.Input[builtins.int] password_min_number: If a password must contain at least one number: 0 = no, 1 = yes. Default = `1`
        :param pulumi.Input[builtins.int] password_min_symbol: If a password must contain at least one symbol (!@#$%^&*): 0 = no, 1 = yes. Default = `0`
        :param pulumi.Input[builtins.int] password_min_uppercase: If a password must contain at least one upper case letter: 0 = no, 1 = yes. Default = 1
        :param pulumi.Input[builtins.bool] password_show_lockout_failures: If a user should be informed when their account is locked. Default: `false`
        :param pulumi.Input[builtins.int] question_min_length: Min length of the password recovery question answer. Default: `4`
        :param pulumi.Input[builtins.str] question_recovery: Enable or disable security question password recovery: ACTIVE or INACTIVE. Default: `ACTIVE`
        :param pulumi.Input[builtins.int] recovery_email_token: Lifetime in minutes of the recovery email token. Default: `60`
        :param pulumi.Input[builtins.bool] skip_unlock: When an Active Directory user is locked out of Okta, the Okta unlock operation should also attempt to unlock the user's Windows account. Default: `false`
        :param pulumi.Input[builtins.str] sms_recovery: Enable or disable SMS password recovery: ACTIVE or INACTIVE. Default: `INACTIVE`
        """
    ...
    def call_recovery(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def call_recovery(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "call_recovery", value)

    @property
    @pulumi.getter(name="emailRecovery")
    def email_recovery(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def email_recovery(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "email_recovery", value)

    @property
    @pulumi.getter(name="passwordAutoUnlockMinutes")
    def password_auto_unlock_minutes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def password_auto_unlock_minutes(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "password_auto_unlock_minutes", value)

    @property
    @pulumi.getter(name="passwordDictionaryLookup")
    def password_dictionary_lookup(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def password_dictionary_lookup(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "password_dictionary_lookup", value)

    @property
    @pulumi.getter(name="passwordExcludeFirstName")
    def password_exclude_first_name(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def password_exclude_first_name(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "password_exclude_first_name", value)

    @property
    @pulumi.getter(name="passwordExcludeLastName")
    def password_exclude_last_name(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def password_exclude_last_name(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "password_exclude_last_name", value)

    @property
    @pulumi.getter(name="passwordExcludeUsername")
    def password_exclude_username(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def password_exclude_username(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "password_exclude_username", value)

    @property
    @pulumi.getter(name="passwordExpireWarnDays")
    def password_expire_warn_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def password_expire_warn_days(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "password_expire_warn_days", value)

    @property
    @pulumi.getter(name="passwordHistoryCount")
    def password_history_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def password_history_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "password_history_count", value)

    @property
    @pulumi.getter(name="passwordLockoutNotificationChannels")
    def password_lockout_notification_channels(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def password_lockout_notification_channels(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "password_lockout_notification_channels", value)

    @property
    @pulumi.getter(name="passwordMaxAgeDays")
    def password_max_age_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def password_max_age_days(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "password_max_age_days", value)

    @property
    @pulumi.getter(name="passwordMaxLockoutAttempts")
    def password_max_lockout_attempts(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def password_max_lockout_attempts(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "password_max_lockout_attempts", value)

    @property
    @pulumi.getter(name="passwordMinAgeMinutes")
    def password_min_age_minutes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def password_min_age_minutes(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "password_min_age_minutes", value)

    @property
    @pulumi.getter(name="passwordMinLength")
    def password_min_length(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def password_min_length(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "password_min_length", value)

    @property
    @pulumi.getter(name="passwordMinLowercase")
    def password_min_lowercase(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def password_min_lowercase(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "password_min_lowercase", value)

    @property
    @pulumi.getter(name="passwordMinNumber")
    def password_min_number(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def password_min_number(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "password_min_number", value)

    @property
    @pulumi.getter(name="passwordMinSymbol")
    def password_min_symbol(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def password_min_symbol(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "password_min_symbol", value)

    @property
    @pulumi.getter(name="passwordMinUppercase")
    def password_min_uppercase(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def password_min_uppercase(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "password_min_uppercase", value)

    @property
    @pulumi.getter(name="passwordShowLockoutFailures")
    def password_show_lockout_failures(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def password_show_lockout_failures(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "password_show_lockout_failures", value)

    @property
    @pulumi.getter(name="questionMinLength")
    def question_min_length(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def question_min_length(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "question_min_length", value)

    @property
    @pulumi.getter(name="questionRecovery")
    def question_recovery(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def question_recovery(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "question_recovery", value)

    @property
    @pulumi.getter(name="recoveryEmailToken")
    def recovery_email_token(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def recovery_email_token(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "recovery_email_token", value)

    @property
    @pulumi.getter(name="skipUnlock")
    def skip_unlock(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @skip_unlock.setter
    def skip_unlock(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "skip_unlock", value)

    @property
    @pulumi.getter(name="smsRecovery")
    def sms_recovery(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @sms_recovery.setter
    def sms_recovery(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _PolicyPasswordDefaultState:
    def __init__(__self__, *,
                 call_recovery: Optional[pulumi.Input[builtins.str]] = None,
                 default_auth_provider: Optional[pulumi.Input[builtins.str]] = None,
                 default_included_group_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] call_recovery: Enable or disable voice call recovery: ACTIVE or INACTIVE. Default: `INACTIVE`
        :param pulumi.Input[builtins.str] default_auth_provider: Default Authentication Provider
        :param pulumi.Input[builtins.str] default_included_group_id: Default group ID (always included)
        :param pulumi.Input[builtins.str] description: Default policy description
        :param pulumi.Input[builtins.str] email_recovery: Enable or disable email password recovery: ACTIVE or INACTIVE. Default: `ACTIVE`
        :param pulumi.Input[builtins.str] name: Default policy name
        :param pulumi.Input[builtins.int] password_auto_unlock_minutes: Number of minutes before a locked account is unlocked: 0 = no limit. Default: `0`
        :param pulumi.Input[builtins.bool] password_dictionary_lookup: Check Passwords Against Common Password Dictionary. Default: `false`
        :param pulumi.Input[builtins.bool] password_exclude_first_name: User firstName attribute must be excluded from the password
        :param pulumi.Input[builtins.bool] password_exclude_last_name: User lastName attribute must be excluded from the password
        ...
        :param pulumi.Input[builtins.int] password_min_uppercase: If a password must contain at least one upper case letter: 0 = no, 1 = yes. Default = 1
        :param pulumi.Input[builtins.bool] password_show_lockout_failures: If a user should be informed when their account is locked. Default: `false`
        :param pulumi.Input[builtins.int] priority: Default policy priority
        :param pulumi.Input[builtins.int] question_min_length: Min length of the password recovery question answer. Default: `4`
        :param pulumi.Input[builtins.str] question_recovery: Enable or disable security question password recovery: ACTIVE or INACTIVE. Default: `ACTIVE`
        :param pulumi.Input[builtins.int] recovery_email_token: Lifetime in minutes of the recovery email token. Default: `60`
        :param pulumi.Input[builtins.bool] skip_unlock: When an Active Directory user is locked out of Okta, the Okta unlock operation should also attempt to unlock the user's Windows account. Default: `false`
        :param pulumi.Input[builtins.str] sms_recovery: Enable or disable SMS password recovery: ACTIVE or INACTIVE. Default: `INACTIVE`
        :param pulumi.Input[builtins.str] status: Default policy status
        """
        if call_recovery is not None:
            pulumi.set(__self__, "call_recovery", call_recovery)
    ...
    def default_auth_provider(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_auth_provider(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "default_auth_provider", value)

    @property
    @pulumi.getter(name="defaultIncludedGroupId")
    def default_included_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_included_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class PolicyPasswordDefault(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            skip_unlock: Optional[pulumi.Input[builtins.bool]] = None,
            sms_recovery: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'PolicyPasswordDefault':
        """
    ...
    @property
    @pulumi.getter(name="callRecovery")
    def call_recovery(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Enable or disable voice call recovery: ACTIVE or INACTIVE. Default: `INACTIVE`
        """
        return pulumi.get(self, "call_recovery")
    ...
    @property
    @pulumi.getter(name="defaultAuthProvider")
    def default_auth_provider(self) -> pulumi.Output[builtins.str]:
        """
        Default Authentication Provider
        """
        return pulumi.get(self, "default_auth_provider")
    ...
    @property
    @pulumi.getter(name="defaultIncludedGroupId")
    def default_included_group_id(self) -> pulumi.Output[builtins.str]:
        """
        Default group ID (always included)
        """
        return pulumi.get(self, "default_included_group_id")
    ...
    @property
    @pulumi.getter(name="emailRecovery")
    def email_recovery(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Enable or disable email password recovery: ACTIVE or INACTIVE. Default: `ACTIVE`
        """
        return pulumi.get(self, "email_recovery")
    ...
    @property
    @pulumi.getter(name="passwordAutoUnlockMinutes")
    def password_auto_unlock_minutes(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Number of minutes before a locked account is unlocked: 0 = no limit. Default: `0`
        """
        return pulumi.get(self, "password_auto_unlock_minutes")
    ...
    @property
    @pulumi.getter(name="passwordDictionaryLookup")
    def password_dictionary_lookup(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Check Passwords Against Common Password Dictionary. Default: `false`
        """
        return pulumi.get(self, "password_dictionary_lookup")
    ...
    @property
    @pulumi.getter(name="passwordExcludeFirstName")
    def password_exclude_first_name(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        User firstName attribute must be excluded from the password
        """
        return pulumi.get(self, "password_exclude_first_name")
    ...
    @property
    @pulumi.getter(name="passwordExcludeLastName")
    def password_exclude_last_name(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        User lastName attribute must be excluded from the password
        """
        return pulumi.get(self, "password_exclude_last_name")
    ...
    @property
    @pulumi.getter(name="passwordExcludeUsername")
    def password_exclude_username(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If the user name must be excluded from the password. Default: `true`
        """
        return pulumi.get(self, "password_exclude_username")
    ...
    @property
    @pulumi.getter(name="passwordExpireWarnDays")
    def password_expire_warn_days(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Length in days a user will be warned before password expiry: 0 = no warning. Default: `0`
        """
        return pulumi.get(self, "password_expire_warn_days")
    ...
    @property
    @pulumi.getter(name="passwordHistoryCount")
    def password_history_count(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Number of distinct passwords that must be created before they can be reused: 0 = none. Default: `4`
        """
        return pulumi.get(self, "password_history_count")
    ...
    @property
    @pulumi.getter(name="passwordLockoutNotificationChannels")
    def password_lockout_notification_channels(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Notification channels to use to notify a user when their account has been locked.
        """
        return pulumi.get(self, "password_lockout_notification_channels")
    ...
    @property
    @pulumi.getter(name="passwordMaxAgeDays")
    def password_max_age_days(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Length in days a password is valid before expiry: 0 = no limit. Default: `0`
        """
        return pulumi.get(self, "password_max_age_days")
    ...
    @property
    @pulumi.getter(name="passwordMaxLockoutAttempts")
    def password_max_lockout_attempts(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Number of unsuccessful login attempts allowed before lockout: 0 = no limit. Default: `10`
        """
        return pulumi.get(self, "password_max_lockout_attempts")
    ...
    @property
    @pulumi.getter(name="passwordMinAgeMinutes")
    def password_min_age_minutes(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Minimum time interval in minutes between password changes: 0 = no limit. Default: `0`
        """
        return pulumi.get(self, "password_min_age_minutes")
    ...
    @property
    @pulumi.getter(name="passwordMinLength")
    def password_min_length(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Minimum password length. Default is `8`.
        """
        return pulumi.get(self, "password_min_length")
    ...
    @property
    @pulumi.getter(name="passwordMinLowercase")
    def password_min_lowercase(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        If a password must contain at least one lower case letter: 0 = no, 1 = yes. Default = 1
        """
        return pulumi.get(self, "password_min_lowercase")
    ...
    @property
    @pulumi.getter(name="passwordMinNumber")
    def password_min_number(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        If a password must contain at least one number: 0 = no, 1 = yes. Default = `1`
        """
        return pulumi.get(self, "password_min_number")
    ...
    @property
    @pulumi.getter(name="passwordMinSymbol")
    def password_min_symbol(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        If a password must contain at least one symbol (!@#$%^&*): 0 = no, 1 = yes. Default = `0`
        """
        return pulumi.get(self, "password_min_symbol")
    ...
    @property
    @pulumi.getter(name="passwordMinUppercase")
    def password_min_uppercase(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        If a password must contain at least one upper case letter: 0 = no, 1 = yes. Default = 1
        """
        return pulumi.get(self, "password_min_uppercase")
    ...
    @property
    @pulumi.getter(name="passwordShowLockoutFailures")
    def password_show_lockout_failures(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If a user should be informed when their account is locked. Default: `false`
        """
        return pulumi.get(self, "password_show_lockout_failures")
    ...
    @property
    @pulumi.getter(name="questionMinLength")
    def question_min_length(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Min length of the password recovery question answer. Default: `4`
        """
        return pulumi.get(self, "question_min_length")
    ...
    @property
    @pulumi.getter(name="questionRecovery")
    def question_recovery(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Enable or disable security question password recovery: ACTIVE or INACTIVE. Default: `ACTIVE`
        """
        return pulumi.get(self, "question_recovery")
    ...
    @property
    @pulumi.getter(name="recoveryEmailToken")
    def recovery_email_token(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Lifetime in minutes of the recovery email token. Default: `60`
        """
        return pulumi.get(self, "recovery_email_token")
    ...
    @property
    @pulumi.getter(name="skipUnlock")
    def skip_unlock(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When an Active Directory user is locked out of Okta, the Okta unlock operation should also attempt to unlock the user's Windows account. Default: `false`
        """
        return pulumi.get(self, "skip_unlock")
    ...
    @property
    @pulumi.getter(name="smsRecovery")
    def sms_recovery(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Enable or disable SMS password recovery: ACTIVE or INACTIVE. Default: `INACTIVE`
        """
        return pulumi.get(self, "sms_recovery")
