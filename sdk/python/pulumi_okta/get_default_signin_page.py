...
def get_default_signin_page(brand_id: Optional[builtins.str] = None,
    ...
    :param builtins.str brand_id: brand id of the preview signin page
    """
    __args__ = dict()
...
def get_default_signin_page_output(brand_id: Optional[pulumi.Input[builtins.str]] = None,
