...
class _AppSignonPolicyState:
    def __init__(__self__, *,
                 catch_all: Optional[pulumi.Input[builtins.bool]] = None,
                 default_rule_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] catch_all: If false, the default rule of the policy is set access to `DENY`. Otherwise default behavior of the default rule is to leave access at `ALLOW`.  **WARNING** setting this attribute to false changes policy rule's default behavior. Use at your own risk. This is only applied during creation and does not affect import or update.
        :param pulumi.Input[builtins.str] default_rule_id: Default rule (system=true) id of the policy
        :param pulumi.Input[builtins.str] description: Description of the policy.
        :param pulumi.Input[builtins.str] name: Name of the policy.
        :param pulumi.Input[builtins.int] priority: Specifies the order in which this policy is evaluated in relation to the other policies.
        """
    ...
    def default_rule_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_rule_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AppSignonPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            description: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            priority: Optional[pulumi.Input[builtins.int]] = None) -> 'AppSignonPolicy':
        """
    ...
    @property
    @pulumi.getter(name="defaultRuleId")
    def default_rule_id(self) -> pulumi.Output[builtins.str]:
        """
        Default rule (system=true) id of the policy
        """
        return pulumi.get(self, "default_rule_id")
