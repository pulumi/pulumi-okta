...
class UserAdminRolesArgs:
    def __init__(__self__, *,
                 admin_roles: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] admin_roles: The list of Okta user admin roles, e.g. `['APP_ADMIN', 'USER_ADMIN']` See [API Docs](https://developer.okta.com/docs/api/openapi/okta-management/guides/roles/#standard-roles).
        :param pulumi.Input[builtins.str] user_id: ID of a Okta User
        :param pulumi.Input[builtins.bool] disable_notifications: When this setting is enabled, the admins won't receive any of the default Okta administrator emails. These admins also won't have access to contact Okta Support and open support cases on behalf of your org.
        """
    ...
    def admin_roles(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    @admin_roles.setter
    def admin_roles(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class _UserAdminRolesState:
    def __init__(__self__, *,
                 admin_roles: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 disable_notifications: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    @property
    @pulumi.getter(name="adminRoles")
    def admin_roles(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The list of Okta user admin roles, e.g. `['APP_ADMIN', 'USER_ADMIN']` See [API Docs](https://developer.okta.com/docs/api/openapi/okta-management/guides/roles/#standard-roles).
        """
        return pulumi.get(self, "admin_roles")
    ...
    @admin_roles.setter
    def admin_roles(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "admin_roles", value)
...
class UserAdminRoles(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            admin_roles: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            disable_notifications: Optional[pulumi.Input[builtins.bool]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None) -> 'UserAdminRoles':
        """
    ...
    @property
    @pulumi.getter(name="adminRoles")
    def admin_roles(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The list of Okta user admin roles, e.g. `['APP_ADMIN', 'USER_ADMIN']` See [API Docs](https://developer.okta.com/docs/api/openapi/okta-management/guides/roles/#standard-roles).
        """
        return pulumi.get(self, "admin_roles")
