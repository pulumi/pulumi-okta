...
def get_everyone_group(include_users: Optional[builtins.bool] = None,
...
def get_everyone_group_output(include_users: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
