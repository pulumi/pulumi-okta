...
class RoleArgs:
    def __init__(__self__, *,
                 ...
                 resource_set_id: Optional[pulumi.Input[builtins.str]] = None,
                 role_id: Optional[pulumi.Input[builtins.str]] = None,
                 target_app_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 target_group_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a Role resource.
        :param pulumi.Input[builtins.str] group_id: ID of group to attach admin roles to
        :param pulumi.Input[builtins.str] role_type: Admin role assigned to the group. It can be any one of the following values: "API_ADMIN", "APP_ADMIN", "CUSTOM",
               ...
               Group Administrator.
        :param pulumi.Input[builtins.bool] disable_notifications: When this setting is enabled, the admins won't receive any of the default Okta administrator emails. These admins also
               won't have access to contact Okta Support and open support cases on behalf of your org.
        :param pulumi.Input[builtins.str] resource_set_id: Resource Set ID. Required for role_type = `CUSTOM`
        :param pulumi.Input[builtins.str] role_id: Role ID. Required for role_type = `CUSTOM`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] target_app_lists: A list of app names (name represents set of app instances, like 'salesforce' or 'facebook'), or a combination of app
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] target_group_lists: A list of group IDs you would like as the targets of the admin role. - Only supported when used with the role types:
    ...
    def resource_set_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def resource_set_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def target_app_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def target_app_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "target_app_lists", value)

    @property
    @pulumi.getter(name="targetGroupLists")
    def target_group_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def target_group_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class Role(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            role_type: Optional[pulumi.Input[builtins.str]] = None,
            target_app_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            target_group_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'Role':
        """
    ...
    @property
    @pulumi.getter(name="disableNotifications")
    def disable_notifications(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When this setting is enabled, the admins won't receive any of the default Okta administrator emails. These admins also
        won't have access to contact Okta Support and open support cases on behalf of your org.
        """
    ...
    @property
    @pulumi.getter(name="resourceSetId")
    def resource_set_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Resource Set ID. Required for role_type = `CUSTOM`
        """
        return pulumi.get(self, "resource_set_id")
    ...
    @property
    @pulumi.getter(name="targetAppLists")
    def target_app_lists(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of app names (name represents set of app instances, like 'salesforce' or 'facebook'), or a combination of app
        name and app instance ID (like 'facebook.0oapsqQ6dv19pqyEo0g3') you would like as the targets of the admin role. - Only
        supported when used with the role type `APP_ADMIN`.
    ...
    @property
    @pulumi.getter(name="targetGroupLists")
    def target_group_lists(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of group IDs you would like as the targets of the admin role. - Only supported when used with the role types:
        `GROUP_MEMBERSHIP_ADMIN`, `HELP_DESK_ADMIN`, or `USER_ADMIN`.
        """
