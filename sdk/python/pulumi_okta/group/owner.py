...
class OwnerArgs:
    def __init__(__self__, *,
                 ...
                 id_of_group_owner: pulumi.Input[builtins.str],
                 type: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a Owner resource.
        :param pulumi.Input[builtins.str] group_id: The id of the group
        :param pulumi.Input[builtins.str] id_of_group_owner: The user id of the group owner
        :param pulumi.Input[builtins.str] type: The entity type of the owner. Enum: "GROUP" "USER"
        """
    ...
    def id_of_group_owner(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def id_of_group_owner(self, value: pulumi.Input[builtins.str]):
...
class _OwnerState:
    def __init__(__self__, *,
                 ...
                 id_of_group_owner: Optional[pulumi.Input[builtins.str]] = None,
                 origin_id: Optional[pulumi.Input[builtins.str]] = None,
                 origin_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] display_name: The display name of the group owner
        :param pulumi.Input[builtins.str] group_id: The id of the group
        :param pulumi.Input[builtins.str] id_of_group_owner: The user id of the group owner
        :param pulumi.Input[builtins.str] origin_id: The ID of the app instance if the originType is APPLICATION. This value is NULL if originType is OKTA_DIRECTORY.
        :param pulumi.Input[builtins.str] origin_type: The source where group ownership is managed. Enum: "APPLICATION" "OKTA_DIRECTORY"
        :param pulumi.Input[builtins.bool] resolved: If originType is APPLICATION, this parameter is set to FALSE until the owner's originId is reconciled with an associated Okta ID.
        :param pulumi.Input[builtins.str] type: The entity type of the owner. Enum: "GROUP" "USER"
        """
    ...
    @property
    @pulumi.getter(name="idOfGroupOwner")
    def id_of_group_owner(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The user id of the group owner
        """
        return pulumi.get(self, "id_of_group_owner")
    ...
    @id_of_group_owner.setter
    def id_of_group_owner(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "id_of_group_owner", value)
    ...
    def origin_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @origin_type.setter
    def origin_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Owner(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            origin_type: Optional[pulumi.Input[builtins.str]] = None,
            resolved: Optional[pulumi.Input[builtins.bool]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'Owner':
        """
    ...
    @property
    @pulumi.getter(name="idOfGroupOwner")
    def id_of_group_owner(self) -> pulumi.Output[builtins.str]:
        """
        The user id of the group owner
        """
        return pulumi.get(self, "id_of_group_owner")
    ...
    @property
    @pulumi.getter(name="originType")
    def origin_type(self) -> pulumi.Output[builtins.str]:
        """
        The source where group ownership is managed. Enum: "APPLICATION" "OKTA_DIRECTORY"
        """
        return pulumi.get(self, "origin_type")
    ...
    @property
    @pulumi.getter
    def resolved(self) -> pulumi.Output[builtins.bool]:
        """
        If originType is APPLICATION, this parameter is set to FALSE until the owner's originId is reconciled with an associated Okta ID.
        """
        return pulumi.get(self, "resolved")
