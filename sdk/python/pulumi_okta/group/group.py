...
class GroupArgs:
    def __init__(__self__, *,
                 ...
                 skip_users: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a Group resource.
        :param pulumi.Input[builtins.str] custom_profile_attributes: JSON formatted custom attributes for a group. It must be JSON due to various types Okta allows.
        :param pulumi.Input[builtins.str] description: The description of the Okta Group.
        :param pulumi.Input[builtins.str] name: The name of the Okta Group.
        :param pulumi.Input[builtins.bool] skip_users: Ignore users sync. This is a temporary solution until 'users' field is supported in all the app-like resources
        """
    ...
    def skip_users(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @skip_users.setter
    def skip_users(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Group(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            description: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            skip_users: Optional[pulumi.Input[builtins.bool]] = None) -> 'Group':
        """
    ...
    @property
    @pulumi.getter(name="customProfileAttributes")
    def custom_profile_attributes(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        JSON formatted custom attributes for a group. It must be JSON due to various types Okta allows.
        """
        return pulumi.get(self, "custom_profile_attributes")
    ...
    @pulumi.getter(name="skipUsers")
    @_utilities.deprecated("""Because users has been removed, this attribute is a no op and will be removed""")
    def skip_users(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Ignore users sync. This is a temporary solution until 'users' field is supported in all the app-like resources
        """
        return pulumi.get(self, "skip_users")
