...
class GetRuleResult:
    ...
    def group_assignments(self) -> Sequence[builtins.str]:
        """
    ...
    def users_excludeds(self) -> Sequence[builtins.str]:
        """
...
def get_rule(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The ID of the Group Rule.
    :param builtins.str name: The name of the Group Rule.
    :param builtins.str status: Default to `ACTIVE`
    """
    __args__ = dict()
    __args__['id'] = id
    __args__['name'] = name
...
def get_rule_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
