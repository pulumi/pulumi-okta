...
def get_group(delay_read_seconds: Optional[builtins.str] = None,
    ...
    :param builtins.str delay_read_seconds: Force delay of the group read by N seconds. Useful when eventual consistency of group information needs to be allowed for; for instance, when group rules are known to have been applied.
    :param builtins.str id: ID of group.
    :param builtins.bool include_users: Fetch group users, having default off cuts down on API calls.
    :param builtins.str name: Name of group.
    """
    __args__ = dict()
...
def get_group_output(delay_read_seconds: Optional[pulumi.Input[Optional[builtins.str]]] = None,
