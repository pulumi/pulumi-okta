...
class GetDeviceAssurancePolicyResult:
    ...
    @property
    @pulumi.getter
    def jailbreak(self) -> builtins.bool:
        """
    ...
    def secure_hardware_present(self) -> Optional[builtins.bool]:
        """
...
def get_device_assurance_policy(id: Optional[builtins.str] = None,
                                name: Optional[builtins.str] = None,
                                secure_hardware_present: Optional[builtins.bool] = None,
    ...
    :param builtins.str id: ID of the user type to retrieve, conflicts with `name`.
    :param builtins.str name: Name of user type to retrieve, conflicts with `id`.
    :param builtins.bool secure_hardware_present: Indicates if the device contains a secure hardware functionality
...
def get_device_assurance_policy_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                       name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                       secure_hardware_present: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
