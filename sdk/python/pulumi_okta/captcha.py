...
class CaptchaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] secret_key: Secret key issued from the CAPTCHA vendor to perform server-side validation for a CAPTCHA token
        :param pulumi.Input[builtins.str] site_key: Site key issued from the CAPTCHA vendor to render a CAPTCHA on a page
        :param pulumi.Input[builtins.str] type: Type of the captcha. Valid values: `HCAPTCHA`, `RECAPTCHA_V2`
        :param pulumi.Input[builtins.str] name: Name of the CAPTCHA
        """
...
class Captcha(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            secret_key: Optional[pulumi.Input[builtins.str]] = None,
            site_key: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'Captcha':
        """
