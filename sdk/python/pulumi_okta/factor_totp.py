...
class FactorTotpArgs:
    def __init__(__self__, *,
                 clock_drift_interval: Optional[pulumi.Input[builtins.int]] = None,
                 hmac_algorithm: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 otp_length: Optional[pulumi.Input[builtins.int]] = None,
                 shared_secret_encoding: Optional[pulumi.Input[builtins.str]] = None,
                 time_step: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a FactorTotp resource.
        :param pulumi.Input[builtins.int] clock_drift_interval: Clock drift interval. This setting allows you to build in tolerance for any drift between the token's current time and the server's current time. Valid values: `3`, `5`, `10`. Default is `3`.
        :param pulumi.Input[builtins.str] hmac_algorithm: HMAC Algorithm. Valid values: `HMacSHA1`, `HMacSHA256`, `HMacSHA512`. Default is `HMacSHA512`.
        :param pulumi.Input[builtins.str] name: The TOTP name.
        :param pulumi.Input[builtins.int] otp_length: Length of the password. Default is `6`.
        :param pulumi.Input[builtins.str] shared_secret_encoding: Shared secret encoding. Valid values: `base32`, `base64`, `hexadecimal`. Default is `base32`.
        :param pulumi.Input[builtins.int] time_step: Time step in seconds. Valid values: `15`, `30`, `60`. Default is `15`.
        """
    ...
    def clock_drift_interval(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def clock_drift_interval(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "clock_drift_interval", value)

    @property
    @pulumi.getter(name="hmacAlgorithm")
    def hmac_algorithm(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def hmac_algorithm(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def otp_length(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @otp_length.setter
    def otp_length(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "otp_length", value)

    @property
    @pulumi.getter(name="sharedSecretEncoding")
    def shared_secret_encoding(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def shared_secret_encoding(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "shared_secret_encoding", value)

    @property
    @pulumi.getter(name="timeStep")
    def time_step(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @time_step.setter
    def time_step(self, value: Optional[pulumi.Input[builtins.int]]):
...
class FactorTotp(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            otp_length: Optional[pulumi.Input[builtins.int]] = None,
            shared_secret_encoding: Optional[pulumi.Input[builtins.str]] = None,
            time_step: Optional[pulumi.Input[builtins.int]] = None) -> 'FactorTotp':
        """
    ...
    @property
    @pulumi.getter(name="clockDriftInterval")
    def clock_drift_interval(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Clock drift interval. This setting allows you to build in tolerance for any drift between the token's current time and the server's current time. Valid values: `3`, `5`, `10`. Default is `3`.
        """
        return pulumi.get(self, "clock_drift_interval")
    ...
    @property
    @pulumi.getter(name="hmacAlgorithm")
    def hmac_algorithm(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        HMAC Algorithm. Valid values: `HMacSHA1`, `HMacSHA256`, `HMacSHA512`. Default is `HMacSHA512`.
        """
        return pulumi.get(self, "hmac_algorithm")
    ...
    @property
    @pulumi.getter(name="otpLength")
    def otp_length(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Length of the password. Default is `6`.
        """
        return pulumi.get(self, "otp_length")
    ...
    @property
    @pulumi.getter(name="sharedSecretEncoding")
    def shared_secret_encoding(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Shared secret encoding. Valid values: `base32`, `base64`, `hexadecimal`. Default is `base32`.
        """
        return pulumi.get(self, "shared_secret_encoding")
    ...
    @property
    @pulumi.getter(name="timeStep")
    def time_step(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Time step in seconds. Valid values: `15`, `30`, `60`. Default is `15`.
        """
        return pulumi.get(self, "time_step")
