...
class FactorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] provider_id: The MFA provider name. Allowed values are `duo`, `fido_u2f`, `fido_webauthn`, `google_otp`, `okta_call`, `okta_otp`, `okta_password`, `okta_push`, `okta_question`, `okta_sms`, `okta_email`, `rsa_token`, `symantec_vip`, `yubikey_token`, or `hotp`.
        :param pulumi.Input[builtins.bool] active: Whether to activate the provider, by default, it is set to `true`.
        """
...
class Factor(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            active: Optional[pulumi.Input[builtins.bool]] = None,
            provider_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Factor':
        """
