...
class AuthServerDefaultArgs:
    def __init__(__self__, *,
                 ...
                 credentials_rotation_mode: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] audiences: The recipients that the tokens are intended for. This becomes the `aud` claim in an access token. Currently Okta only supports a single value here.
        :param pulumi.Input[builtins.str] credentials_rotation_mode: The key rotation mode for the authorization server. Can be `AUTO` or `MANUAL`. Default: `MANUAL`.Credential rotation mode, in many cases you cannot set this to MANUAL, the API will ignore the value and you will get a perpetual diff. This should rarely be used.
        :param pulumi.Input[builtins.str] description: The description of the authorization server.
        :param pulumi.Input[builtins.str] issuer_mode: *Early Access Property*. Allows you to use a custom issuer URL. It can be set to `CUSTOM_URL`, `ORG_URL`, or `DYNAMIC`. Default: `ORG_URL`
        :param pulumi.Input[builtins.str] name: The name of the authorization server. Not necessary but left for backwards capacity with legacy implementation.
    ...
    def credentials_rotation_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def credentials_rotation_mode(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _AuthServerDefaultState:
    def __init__(__self__, *,
                 audiences: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 credentials_last_rotated: Optional[pulumi.Input[builtins.str]] = None,
                 credentials_next_rotation: Optional[pulumi.Input[builtins.str]] = None,
                 credentials_rotation_mode: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] audiences: The recipients that the tokens are intended for. This becomes the `aud` claim in an access token. Currently Okta only supports a single value here.
        :param pulumi.Input[builtins.str] credentials_last_rotated: The timestamp when the authorization server started to use the `kid` for signing tokens.
        :param pulumi.Input[builtins.str] credentials_next_rotation: The timestamp when the authorization server changes the key for signing tokens. Only returned when `credentials_rotation_mode` is `AUTO`.
        :param pulumi.Input[builtins.str] credentials_rotation_mode: The key rotation mode for the authorization server. Can be `AUTO` or `MANUAL`. Default: `MANUAL`.Credential rotation mode, in many cases you cannot set this to MANUAL, the API will ignore the value and you will get a perpetual diff. This should rarely be used.
        :param pulumi.Input[builtins.str] description: The description of the authorization server.
        :param pulumi.Input[builtins.str] issuer: The complete URL for a Custom Authorization Server. This becomes the `iss` claim in an access token.
        :param pulumi.Input[builtins.str] issuer_mode: *Early Access Property*. Allows you to use a custom issuer URL. It can be set to `CUSTOM_URL`, `ORG_URL`, or `DYNAMIC`. Default: `ORG_URL`
        :param pulumi.Input[builtins.str] kid: The ID of the JSON Web Key used for signing tokens issued by the authorization server.
        :param pulumi.Input[builtins.str] name: The name of the authorization server. Not necessary but left for backwards capacity with legacy implementation.
        :param pulumi.Input[builtins.str] status: Default to `ACTIVE`
        """
        if audiences is not None:
    ...
    def credentials_last_rotated(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def credentials_last_rotated(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "credentials_last_rotated", value)

    @property
    @pulumi.getter(name="credentialsNextRotation")
    def credentials_next_rotation(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def credentials_next_rotation(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AuthServerDefault(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            kid: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'AuthServerDefault':
        """
    ...
    @property
    @pulumi.getter(name="credentialsLastRotated")
    def credentials_last_rotated(self) -> pulumi.Output[builtins.str]:
        """
        The timestamp when the authorization server started to use the `kid` for signing tokens.
        """
        return pulumi.get(self, "credentials_last_rotated")
    ...
    @property
    @pulumi.getter(name="credentialsNextRotation")
    def credentials_next_rotation(self) -> pulumi.Output[builtins.str]:
        """
        The timestamp when the authorization server changes the key for signing tokens. Only returned when `credentials_rotation_mode` is `AUTO`.
        """
        return pulumi.get(self, "credentials_next_rotation")
    ...
    @property
    @pulumi.getter(name="credentialsRotationMode")
    def credentials_rotation_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The key rotation mode for the authorization server. Can be `AUTO` or `MANUAL`. Default: `MANUAL`.Credential rotation mode, in many cases you cannot set this to MANUAL, the API will ignore the value and you will get a perpetual diff. This should rarely be used.
        """
        return pulumi.get(self, "credentials_rotation_mode")
