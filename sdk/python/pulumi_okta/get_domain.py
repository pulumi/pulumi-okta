...
class GetDomainResult:
    ...
    def public_certificate(self) -> Mapping[str, builtins.str]:
        """
...
def get_domain(domain_id_or_name: Optional[builtins.str] = None,
    ...
    :param builtins.str domain_id_or_name: Brand ID
    """
    __args__ = dict()
...
def get_domain_output(domain_id_or_name: Optional[pulumi.Input[builtins.str]] = None,
