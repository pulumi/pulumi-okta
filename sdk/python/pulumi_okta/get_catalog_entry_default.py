...
def get_catalog_entry_default(counts: Optional[Union['GetCatalogEntryDefaultCountsArgs', 'GetCatalogEntryDefaultCountsArgsDict', 'outputs.GetCatalogEntryDefaultCountsResult']] = None,
                              entry_id: Optional[_builtins.str] = None,
                              links: Optional[Union['GetCatalogEntryDefaultLinksArgs', 'GetCatalogEntryDefaultLinksArgsDict', 'outputs.GetCatalogEntryDefaultLinksResult']] = None,
...
def get_catalog_entry_default_output(counts: pulumi.Input[Optional[Optional[Union['GetCatalogEntryDefaultCountsArgs', 'GetCatalogEntryDefaultCountsArgsDict', 'outputs.GetCatalogEntryDefaultCountsResult']]]] = None,
                                     entry_id: pulumi.Input[Optional[_builtins.str]] = None,
                                     links: pulumi.Input[Optional[Optional[Union['GetCatalogEntryDefaultLinksArgs', 'GetCatalogEntryDefaultLinksArgsDict', 'outputs.GetCatalogEntryDefaultLinksResult']]]] = None,
