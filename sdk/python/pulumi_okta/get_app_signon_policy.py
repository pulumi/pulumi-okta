...
def get_app_signon_policy(app_id: Optional[builtins.str] = None,
    ...
    :param builtins.str app_id: App ID
    """
    __args__ = dict()
...
def get_app_signon_policy_output(app_id: Optional[pulumi.Input[builtins.str]] = None,
