...
class LinkValueArgs:
    def __init__(__self__, *,
                 ...
                 primary_user_id: pulumi.Input[builtins.str],
                 associated_user_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a LinkValue resource.
        :param pulumi.Input[builtins.str] primary_name: Name of the `primary` relationship being assigned.
        :param pulumi.Input[builtins.str] primary_user_id: User ID to be assigned to `primary` for the 'associated' user in the specified relationship.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] associated_user_ids: Set of User IDs or login values of the users to be assigned the `associated` relationship.
        """
    ...
    def primary_user_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def primary_user_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "primary_user_id", value)

    @property
    @pulumi.getter(name="associatedUserIds")
    def associated_user_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def associated_user_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _LinkValueState:
    def __init__(__self__, *,
                 ...
                 primary_user_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="primaryUserId")
    def primary_user_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        User ID to be assigned to `primary` for the 'associated' user in the specified relationship.
        """
        return pulumi.get(self, "primary_user_id")
    ...
    @primary_user_id.setter
    def primary_user_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "primary_user_id", value)
...
class LinkValue(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            associated_user_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            primary_name: Optional[pulumi.Input[builtins.str]] = None,
            primary_user_id: Optional[pulumi.Input[builtins.str]] = None) -> 'LinkValue':
        """
    ...
    @property
    @pulumi.getter(name="associatedUserIds")
    def associated_user_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Set of User IDs or login values of the users to be assigned the `associated` relationship.
        """
        return pulumi.get(self, "associated_user_ids")
    ...
    @property
    @pulumi.getter(name="primaryUserId")
    def primary_user_id(self) -> pulumi.Output[builtins.str]:
        """
        User ID to be assigned to `primary` for the 'associated' user in the specified relationship.
        """
        return pulumi.get(self, "primary_user_id")
