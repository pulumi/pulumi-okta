...
class PasswordArgs:
    def __init__(__self__, *,
                 ...
                 groups_includeds: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] auth_provider: Authentication Provider: `OKTA`, `ACTIVE_DIRECTORY` or `LDAP`. Default: `OKTA`
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] groups_includeds: List of Group IDs to Include
        ...
        :param pulumi.Input[builtins.int] password_history_count: Number of distinct passwords that must be created before they can be reused: 0 = none. Default: `0`
        ...
        :param pulumi.Input[builtins.int] password_min_length: Minimum password length. Default: `8`
        ...
        :param pulumi.Input[builtins.int] priority: Policy Priority, this attribute can be set to a valid priority. To avoid endless diff situation we error if an invalid priority is provided. API defaults it to the last (lowest) if not there.
        ...
        :param pulumi.Input[builtins.str] status: Policy Status: `ACTIVE` or `INACTIVE`. Default: `ACTIVE`
        """
    ...
    def groups_includeds(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def groups_includeds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class Password(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            skip_unlock: Optional[pulumi.Input[builtins.bool]] = None,
            sms_recovery: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'Password':
        """
    ...
    @property
    @pulumi.getter(name="authProvider")
    def auth_provider(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Authentication Provider: `OKTA`, `ACTIVE_DIRECTORY` or `LDAP`. Default: `OKTA`
        """
        return pulumi.get(self, "auth_provider")
    ...
    @property
    @pulumi.getter(name="groupsIncludeds")
    def groups_includeds(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of Group IDs to Include
        """
        return pulumi.get(self, "groups_includeds")
