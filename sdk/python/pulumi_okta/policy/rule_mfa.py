...
class RuleMfaArgs:
    def __init__(__self__, *,
                 ...
                 enroll: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['RuleMfaAppIncludeArgs']]] app_includes: Applications to include in discovery rule. **IMPORTANT**: this field is only available in Classic Organizations. - 'id'
               ...
               is 'APP_TYPE' to indicate the type of application(s) to include in instances where an entire group (i.e. 'yahoo_mail')
               of applications should be included. - 'type' - (Required) One of: 'APP', 'APP_TYPE'
        :param pulumi.Input[builtins.str] enroll: When a user should be prompted for MFA. It can be `CHALLENGE`, `LOGIN`, or `NEVER`.
    ...
    @property
    @pulumi.getter
    def enroll(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @enroll.setter
    def enroll(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RuleMfa(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            priority: Optional[pulumi.Input[builtins.int]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            users_excludeds: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'RuleMfa':
        """
    ...
    @property
    @pulumi.getter
    def enroll(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        When a user should be prompted for MFA. It can be `CHALLENGE`, `LOGIN`, or `NEVER`.
        """
        return pulumi.get(self, "enroll")
