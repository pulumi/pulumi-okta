...
class DeviceAssuranceWindowsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] tpsp_secure_boot_enabled: Third party signal provider secure boot enabled
        :param pulumi.Input[bool] tpsp_site_isolation_enabled: Third party signal provider site isolation enabled
        :param pulumi.Input[bool] tpsp_third_party_blocking_enabled: Third party signal provider third party blocking enabled
    ...
    def _configure(
             ...
             **kwargs):
        if 'diskEncryptionTypes' in kwargs:
            disk_encryption_types = kwargs['diskEncryptionTypes']
        if 'osVersion' in kwargs:
            os_version = kwargs['osVersion']
        if 'screenlockTypes' in kwargs:
            screenlock_types = kwargs['screenlockTypes']
        if 'secureHardwarePresent' in kwargs:
            secure_hardware_present = kwargs['secureHardwarePresent']
        if 'thirdPartySignalProviders' in kwargs:
            third_party_signal_providers = kwargs['thirdPartySignalProviders']
        if 'tpspBrowserVersion' in kwargs:
            tpsp_browser_version = kwargs['tpspBrowserVersion']
        if 'tpspBuiltinDnsClientEnabled' in kwargs:
            tpsp_builtin_dns_client_enabled = kwargs['tpspBuiltinDnsClientEnabled']
        if 'tpspChromeRemoteDesktopAppBlocked' in kwargs:
            tpsp_chrome_remote_desktop_app_blocked = kwargs['tpspChromeRemoteDesktopAppBlocked']
        if 'tpspCrowdStrikeAgentId' in kwargs:
            tpsp_crowd_strike_agent_id = kwargs['tpspCrowdStrikeAgentId']
        if 'tpspCrowdStrikeCustomerId' in kwargs:
            tpsp_crowd_strike_customer_id = kwargs['tpspCrowdStrikeCustomerId']
        if 'tpspDeviceEnrollmentDomain' in kwargs:
            tpsp_device_enrollment_domain = kwargs['tpspDeviceEnrollmentDomain']
        if 'tpspDiskEncrypted' in kwargs:
            tpsp_disk_encrypted = kwargs['tpspDiskEncrypted']
        if 'tpspKeyTrustLevel' in kwargs:
            tpsp_key_trust_level = kwargs['tpspKeyTrustLevel']
        if 'tpspOsFirewall' in kwargs:
            tpsp_os_firewall = kwargs['tpspOsFirewall']
        if 'tpspOsVersion' in kwargs:
            tpsp_os_version = kwargs['tpspOsVersion']
        if 'tpspPasswordProctectionWarningTrigger' in kwargs:
            tpsp_password_proctection_warning_trigger = kwargs['tpspPasswordProctectionWarningTrigger']
        if 'tpspRealtimeUrlCheckMode' in kwargs:
            tpsp_realtime_url_check_mode = kwargs['tpspRealtimeUrlCheckMode']
        if 'tpspSafeBrowsingProtectionLevel' in kwargs:
            tpsp_safe_browsing_protection_level = kwargs['tpspSafeBrowsingProtectionLevel']
        if 'tpspScreenLockSecured' in kwargs:
            tpsp_screen_lock_secured = kwargs['tpspScreenLockSecured']
        if 'tpspSecureBootEnabled' in kwargs:
            tpsp_secure_boot_enabled = kwargs['tpspSecureBootEnabled']
        if 'tpspSiteIsolationEnabled' in kwargs:
            tpsp_site_isolation_enabled = kwargs['tpspSiteIsolationEnabled']
        if 'tpspThirdPartyBlockingEnabled' in kwargs:
            tpsp_third_party_blocking_enabled = kwargs['tpspThirdPartyBlockingEnabled']
        if 'tpspWindowsMachineDomain' in kwargs:
            tpsp_windows_machine_domain = kwargs['tpspWindowsMachineDomain']
        if 'tpspWindowsUserDomain' in kwargs:
            tpsp_windows_user_domain = kwargs['tpspWindowsUserDomain']
    ...
    def tpsp_crowd_strike_agent_id(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def tpsp_crowd_strike_agent_id(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "tpsp_crowd_strike_agent_id", value)

    @property
    @pulumi.getter(name="tpspCrowdStrikeCustomerId")
    def tpsp_crowd_strike_customer_id(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def tpsp_crowd_strike_customer_id(self, value: Optional[pulumi.Input[str]]):
    ...
    def tpsp_secure_boot_enabled(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def tpsp_secure_boot_enabled(self, value: Optional[pulumi.Input[bool]]):
    ...
    def tpsp_third_party_blocking_enabled(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def tpsp_third_party_blocking_enabled(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "tpsp_third_party_blocking_enabled", value)

    @property
    @pulumi.getter(name="tpspWindowsMachineDomain")
    def tpsp_windows_machine_domain(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def tpsp_windows_machine_domain(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "tpsp_windows_machine_domain", value)

    @property
    @pulumi.getter(name="tpspWindowsUserDomain")
    def tpsp_windows_user_domain(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def tpsp_windows_user_domain(self, value: Optional[pulumi.Input[str]]):
...
class DeviceAssuranceWindows(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tpsp_third_party_blocking_enabled: Optional[pulumi.Input[bool]] = None,
            tpsp_windows_machine_domain: Optional[pulumi.Input[str]] = None,
            tpsp_windows_user_domain: Optional[pulumi.Input[str]] = None) -> 'DeviceAssuranceWindows':
        """
    ...
    @property
    @pulumi.getter(name="tpspCrowdStrikeAgentId")
    def tpsp_crowd_strike_agent_id(self) -> pulumi.Output[Optional[str]]:
        """
        Third party signal provider crowdstrike agent id
        """
        return pulumi.get(self, "tpsp_crowd_strike_agent_id")
    ...
    @property
    @pulumi.getter(name="tpspCrowdStrikeCustomerId")
    def tpsp_crowd_strike_customer_id(self) -> pulumi.Output[Optional[str]]:
        """
        Third party signal provider crowdstrike user id
        """
        return pulumi.get(self, "tpsp_crowd_strike_customer_id")
    ...
    @property
    @pulumi.getter(name="tpspSecureBootEnabled")
    def tpsp_secure_boot_enabled(self) -> pulumi.Output[Optional[bool]]:
        """
        Third party signal provider secure boot enabled
        """
        return pulumi.get(self, "tpsp_secure_boot_enabled")
    ...
    @property
    @pulumi.getter(name="tpspThirdPartyBlockingEnabled")
    def tpsp_third_party_blocking_enabled(self) -> pulumi.Output[Optional[bool]]:
        """
        Third party signal provider third party blocking enabled
        """
        return pulumi.get(self, "tpsp_third_party_blocking_enabled")
    ...
    @property
    @pulumi.getter(name="tpspWindowsMachineDomain")
    def tpsp_windows_machine_domain(self) -> pulumi.Output[Optional[str]]:
        """
        Third party signal provider windows machine domain
        """
        return pulumi.get(self, "tpsp_windows_machine_domain")
    ...
    @property
    @pulumi.getter(name="tpspWindowsUserDomain")
    def tpsp_windows_user_domain(self) -> pulumi.Output[Optional[str]]:
        """
        Third party signal provider windows user domain
        """
        return pulumi.get(self, "tpsp_windows_user_domain")
