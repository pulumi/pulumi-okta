...
class DeviceAssuranceAndroidArgs:
    def __init__(__self__, *,
                 ...
                 jailbreak: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] disk_encryption_types: List of disk encryption type, can be `FULL`, `USER`
        :param pulumi.Input[builtins.bool] jailbreak: Is the device jailbroken in the device assurance policy.
        :param pulumi.Input[builtins.str] name: Policy device assurance name
        ...
        :param pulumi.Input[builtins.bool] secure_hardware_present: Indicates if the device contains a secure hardware functionality
        """
    ...
    @property
    @pulumi.getter
    def jailbreak(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @jailbreak.setter
    def jailbreak(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class DeviceAssuranceAndroid(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            platform: Optional[pulumi.Input[builtins.str]] = None,
            screenlock_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            secure_hardware_present: Optional[pulumi.Input[builtins.bool]] = None) -> 'DeviceAssuranceAndroid':
        """
    ...
    @property
    @pulumi.getter
    def jailbreak(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Is the device jailbroken in the device assurance policy.
        """
        return pulumi.get(self, "jailbreak")
