...
class _DeviceAssuranceIosState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] jailbreak: Is the device jailbroken in the device assurance policy.
        :param pulumi.Input[_builtins.str] last_update: Last update of the device assurance polic
        :param pulumi.Input[_builtins.str] last_updated_by: Last updated by of the device assurance polic
        :param pulumi.Input[_builtins.str] name: Name of the device assurance policy.
        :param pulumi.Input[_builtins.str] os_version: Minimum os version of the device in the device assurance policy.
...
class DeviceAssuranceIos(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            os_version: Optional[pulumi.Input[_builtins.str]] = None,
            platform: Optional[pulumi.Input[_builtins.str]] = None,
            screenlock_types: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None) -> 'DeviceAssuranceIos':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def jailbreak(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Is the device jailbroken in the device assurance policy.
        """
        return pulumi.get(self, "jailbreak")
