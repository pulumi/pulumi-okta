...
def get_default_policy(type: Optional[builtins.str] = None,
    ...
    :param builtins.str type: Policy type: OKTA*SIGN*ON, PASSWORD, MFA*ENROLL, or IDP*DISCOVERY
    """
    __args__ = dict()
    __args__['type'] = type
...
def get_default_policy_output(type: Optional[pulumi.Input[builtins.str]] = None,
