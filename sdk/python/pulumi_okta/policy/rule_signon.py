...
class RuleSignonArgs:
    def __init__(__self__, *,
                 ...
                 authtype: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 identity_provider_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 mfa_lifetime: Optional[pulumi.Input[builtins.int]] = None,
                 mfa_prompt: Optional[pulumi.Input[builtins.str]] = None,
                 mfa_remember_device: Optional[pulumi.Input[builtins.bool]] = None,
                 mfa_required: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 primary_factor: Optional[pulumi.Input[builtins.str]] = None,
                 priority: Optional[pulumi.Input[builtins.int]] = None,
                 risc_level: Optional[pulumi.Input[builtins.str]] = None,
                 risk_level: Optional[pulumi.Input[builtins.str]] = None,
                 session_idle: Optional[pulumi.Input[builtins.int]] = None,
                 session_lifetime: Optional[pulumi.Input[builtins.int]] = None,
                 session_persistent: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] access: Allow or deny access based on the rule conditions: `ALLOW`, `DENY` or `CHALLENGE`. Default: `ALLOW`
        :param pulumi.Input[builtins.str] authtype: Authentication entrypoint: `ANY`, `RADIUS` or `LDAP_INTERFACE`. Default: `ANY`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] behaviors: List of behavior IDs
        ...
        :param pulumi.Input[builtins.str] identity_provider: Apply rule based on the IdP used: `ANY`, `OKTA` or `SPECIFIC_IDP`. Default: `ANY`. > **WARNING**: Use of
               `identity_provider` requires a feature flag to be enabled.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_provider_ids: When identity_provider is `SPECIFIC_IDP` then this is the list of IdP IDs to apply the rule on
        :param pulumi.Input[builtins.int] mfa_lifetime: Elapsed time before the next MFA challenge
        :param pulumi.Input[builtins.str] mfa_prompt: Prompt for MFA based on the device used, a factor session lifetime, or every sign-on attempt: `DEVICE`, `SESSION`
               or`ALWAYS`.
        :param pulumi.Input[builtins.bool] mfa_remember_device: Remember MFA device. Default: `false`
        :param pulumi.Input[builtins.bool] mfa_required: Require MFA. Default: `false`
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] network_includes: Required if `network_connection` = `ZONE`. Indicates the network zones to include.
        :param pulumi.Input[builtins.str] policy_id: Policy ID of the Rule
        :param pulumi.Input[builtins.str] primary_factor: Rule's primary factor. **WARNING** Ony works as a part of the Identity Engine. Valid values: `PASSWORD_IDP_ANY_FACTOR`,
               `PASSWORD_IDP`.
        :param pulumi.Input[builtins.int] priority: Rule priority. This attribute can be set to a valid priority. To avoid an endless diff situation an error is thrown if
               an invalid property is provided. The Okta API defaults to the last (lowest) if not provided.
        :param pulumi.Input[builtins.str] risc_level: Risc level: ANY, LOW, MEDIUM or HIGH. Default: `ANY`
        :param pulumi.Input[builtins.str] risk_level: Risk level: ANY, LOW, MEDIUM or HIGH. Default: `ANY`
        :param pulumi.Input[builtins.int] session_idle: Max minutes a session can be idle. Default: `120`
        :param pulumi.Input[builtins.int] session_lifetime: Max minutes a session is active: Disable = 0. Default: `120`
        :param pulumi.Input[builtins.bool] session_persistent: Whether session cookies will last across browser sessions. Okta Administrators can never have persistent session
               cookies. Default: `false`
        :param pulumi.Input[builtins.str] status: Policy Rule Status: `ACTIVE` or `INACTIVE`. Default: `ACTIVE`
    ...
    @property
    @pulumi.getter
    def authtype(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @authtype.setter
    def authtype(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def identity_provider_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def identity_provider_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "identity_provider_ids", value)

    @property
    @pulumi.getter(name="mfaLifetime")
    def mfa_lifetime(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @mfa_lifetime.setter
    def mfa_lifetime(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "mfa_lifetime", value)

    @property
    @pulumi.getter(name="mfaPrompt")
    def mfa_prompt(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @mfa_prompt.setter
    def mfa_prompt(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "mfa_prompt", value)

    @property
    @pulumi.getter(name="mfaRememberDevice")
    def mfa_remember_device(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def mfa_remember_device(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "mfa_remember_device", value)

    @property
    @pulumi.getter(name="mfaRequired")
    def mfa_required(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @mfa_required.setter
    def mfa_required(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def primary_factor(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def primary_factor(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def risc_level(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @risc_level.setter
    def risc_level(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def session_idle(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @session_idle.setter
    def session_idle(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "session_idle", value)

    @property
    @pulumi.getter(name="sessionLifetime")
    def session_lifetime(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def session_lifetime(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "session_lifetime", value)

    @property
    @pulumi.getter(name="sessionPersistent")
    def session_persistent(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def session_persistent(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class RuleSignon(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            session_persistent: Optional[pulumi.Input[builtins.bool]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            users_excludeds: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'RuleSignon':
        """
    ...
    @property
    @pulumi.getter
    def authtype(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Authentication entrypoint: `ANY`, `RADIUS` or `LDAP_INTERFACE`. Default: `ANY`
        """
        return pulumi.get(self, "authtype")
    ...
    @property
    @pulumi.getter(name="identityProviderIds")
    def identity_provider_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        When identity_provider is `SPECIFIC_IDP` then this is the list of IdP IDs to apply the rule on
        """
        return pulumi.get(self, "identity_provider_ids")
    ...
    @property
    @pulumi.getter(name="mfaLifetime")
    def mfa_lifetime(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Elapsed time before the next MFA challenge
        """
        return pulumi.get(self, "mfa_lifetime")
    ...
    @property
    @pulumi.getter(name="mfaPrompt")
    def mfa_prompt(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Prompt for MFA based on the device used, a factor session lifetime, or every sign-on attempt: `DEVICE`, `SESSION`
        or`ALWAYS`.
        """
    ...
    @property
    @pulumi.getter(name="mfaRememberDevice")
    def mfa_remember_device(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Remember MFA device. Default: `false`
        """
        return pulumi.get(self, "mfa_remember_device")
    ...
    @property
    @pulumi.getter(name="mfaRequired")
    def mfa_required(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Require MFA. Default: `false`
        """
        return pulumi.get(self, "mfa_required")
    ...
    @property
    @pulumi.getter(name="primaryFactor")
    def primary_factor(self) -> pulumi.Output[builtins.str]:
        """
        Rule's primary factor. **WARNING** Ony works as a part of the Identity Engine. Valid values: `PASSWORD_IDP_ANY_FACTOR`,
        `PASSWORD_IDP`.
        """
    ...
    @pulumi.getter(name="riscLevel")
    @_utilities.deprecated("""Attribute typo, switch to risk_level instead. Default: `ANY`""")
    def risc_level(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Risc level: ANY, LOW, MEDIUM or HIGH. Default: `ANY`
        """
        return pulumi.get(self, "risc_level")
    ...
    @property
    @pulumi.getter(name="riskLevel")
    def risk_level(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Risk level: ANY, LOW, MEDIUM or HIGH. Default: `ANY`
        """
        return pulumi.get(self, "risk_level")
    ...
    @property
    @pulumi.getter(name="sessionIdle")
    def session_idle(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Max minutes a session can be idle. Default: `120`
        """
        return pulumi.get(self, "session_idle")
    ...
    @property
    @pulumi.getter(name="sessionLifetime")
    def session_lifetime(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Max minutes a session is active: Disable = 0. Default: `120`
        """
        return pulumi.get(self, "session_lifetime")
    ...
    @property
    @pulumi.getter(name="sessionPersistent")
    def session_persistent(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether session cookies will last across browser sessions. Okta Administrators can never have persistent session
        cookies. Default: `false`
        """
