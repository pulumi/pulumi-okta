...
def get_email_customization(brand_id: Optional[builtins.str] = None,
                            customization_id: Optional[builtins.str] = None,
    ...
    :param builtins.str brand_id: Brand ID
    :param builtins.str customization_id: The ID of the customization
...
def get_email_customization_output(brand_id: Optional[pulumi.Input[builtins.str]] = None,
                                   customization_id: Optional[pulumi.Input[builtins.str]] = None,
