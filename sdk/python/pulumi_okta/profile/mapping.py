...
class MappingArgs:
    def __init__(__self__, *,
                 ...
                 delete_when_absent: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] source_id: The source id of the mapping to manage.
        :param pulumi.Input[builtins.str] target_id: The target id of the mapping to manage.
        :param pulumi.Input[builtins.bool] always_apply: Whether apply the changes to all users with this profile after updating or creating the these mappings.
        ...
        :param pulumi.Input[builtins.bool] delete_when_absent: When turned on this flag will trigger the provider to delete mapping properties that are not defined in config. By default, we do not delete missing properties.
        """
    ...
    def delete_when_absent(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def delete_when_absent(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _MappingState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] delete_when_absent: When turned on this flag will trigger the provider to delete mapping properties that are not defined in config. By default, we do not delete missing properties.
        :param pulumi.Input[builtins.str] source_id: The source id of the mapping to manage.
        :param pulumi.Input[builtins.str] source_name: Name of the mapping source.
        :param pulumi.Input[builtins.str] source_type: ID of the mapping source.
        :param pulumi.Input[builtins.str] target_id: The target id of the mapping to manage.
        :param pulumi.Input[builtins.str] target_name: Name of the mapping target.
        :param pulumi.Input[builtins.str] target_type: ID of the mapping target.
        """
        if always_apply is not None:
            pulumi.set(__self__, "always_apply", always_apply)
        if delete_when_absent is not None:
...
class Mapping(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            target_id: Optional[pulumi.Input[builtins.str]] = None,
            target_name: Optional[pulumi.Input[builtins.str]] = None,
            target_type: Optional[pulumi.Input[builtins.str]] = None) -> 'Mapping':
        """
    ...
    @property
    @pulumi.getter(name="deleteWhenAbsent")
    def delete_when_absent(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When turned on this flag will trigger the provider to delete mapping properties that are not defined in config. By default, we do not delete missing properties.
        """
        return pulumi.get(self, "delete_when_absent")
