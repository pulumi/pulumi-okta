...
class _MappingState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] source_type: ID of the mapping source.
        :param pulumi.Input[_builtins.str] target_id: The target id of the mapping to manage.
        :param pulumi.Input[_builtins.str] target_name: Name of the mapping target.
        :param pulumi.Input[_builtins.str] target_type: ID of the mapping target.
        """
        if always_apply is not None:
            pulumi.set(__self__, "always_apply", always_apply)
        if delete_when_absent is not None:
...
class Mapping(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="deleteWhenAbsent")
    def delete_when_absent(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        When turned on this flag will trigger the provider to delete mapping properties that are not defined in config. By default, we do not delete missing properties.
        """
        return pulumi.get(self, "delete_when_absent")
