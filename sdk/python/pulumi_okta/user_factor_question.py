...
class UserFactorQuestionArgs:
    def __init__(__self__, *,
                 answer: pulumi.Input[_builtins.str],
    ...
    @_builtins.property
    @pulumi.getter
    def answer(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @answer.setter
    def answer(self, value: pulumi.Input[_builtins.str]):
...
class _UserFactorQuestionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] text: Display text for security question.
        :param pulumi.Input[_builtins.str] user_id: ID of the user. Resource will be recreated when `user_id` changes.
        """
...
class UserFactorQuestion(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[_builtins.str]] = None,
            text: Optional[pulumi.Input[_builtins.str]] = None,
            user_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'UserFactorQuestion':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def answer(self) -> pulumi.Output[_builtins.str]:
        """
        Security question answer. Note here that answer won't be set during the resource import.
        """
        return pulumi.get(self, "answer")
