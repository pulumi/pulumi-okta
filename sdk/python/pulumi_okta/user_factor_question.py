...
class UserFactorQuestionArgs:
    def __init__(__self__, *,
                 answer: pulumi.Input[builtins.str],
                 key: pulumi.Input[builtins.str],
                 user_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a UserFactorQuestion resource.
        :param pulumi.Input[builtins.str] answer: Security question answer. Note here that answer won't be set during the resource import.
        :param pulumi.Input[builtins.str] key: Security question unique key.
        :param pulumi.Input[builtins.str] user_id: ID of the user. Resource will be recreated when `user_id` changes.
        """
    ...
    @property
    @pulumi.getter
    def answer(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @answer.setter
    def answer(self, value: pulumi.Input[builtins.str]):
...
class _UserFactorQuestionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] answer: Security question answer. Note here that answer won't be set during the resource import.
        :param pulumi.Input[builtins.str] key: Security question unique key.
        :param pulumi.Input[builtins.str] status: The status of the security question factor.
        :param pulumi.Input[builtins.str] text: Display text for security question.
        :param pulumi.Input[builtins.str] user_id: ID of the user. Resource will be recreated when `user_id` changes.
        """
...
class UserFactorQuestion(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            text: Optional[pulumi.Input[builtins.str]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None) -> 'UserFactorQuestion':
        """
    ...
    @property
    @pulumi.getter
    def answer(self) -> pulumi.Output[builtins.str]:
        """
        Security question answer. Note here that answer won't be set during the resource import.
        """
        return pulumi.get(self, "answer")
