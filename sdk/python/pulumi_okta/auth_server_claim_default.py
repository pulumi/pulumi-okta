...
class AuthServerClaimDefaultArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] always_include_in_token: Specifies whether to include claims in token.
        :param pulumi.Input[builtins.str] name: The name of the claim. Can be set to `sub`, `address`, `birthdate`, `email`,`email_verified`, `family_name`, `gender`, `given_name`, `locale`, `middle_name`, `name`, `nickname`,`phone_number`, `picture`, `preferred_username`, `profile`, `updated_at`, `website`, `zoneinfo`
        :param pulumi.Input[builtins.str] value: The value of the claim. Only required for `sub` claim.
        """
...
class _AuthServerClaimDefaultState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of the claim. Can be set to `sub`, `address`, `birthdate`, `email`,`email_verified`, `family_name`, `gender`, `given_name`, `locale`, `middle_name`, `name`, `nickname`,`phone_number`, `picture`, `preferred_username`, `profile`, `updated_at`, `website`, `zoneinfo`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] scopes: Auth server claim list of scopes
        :param pulumi.Input[builtins.str] status: The status of the application.
        :param pulumi.Input[builtins.str] value: The value of the claim. Only required for `sub` claim.
        :param pulumi.Input[builtins.str] value_type: The type of value of the claim.
        """
        if always_include_in_token is not None:
            pulumi.set(__self__, "always_include_in_token", always_include_in_token)
...
@pulumi.type_token("okta:index/authServerClaimDefault:AuthServerClaimDefault")
class AuthServerClaimDefault(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            value: Optional[pulumi.Input[builtins.str]] = None,
            value_type: Optional[pulumi.Input[builtins.str]] = None) -> 'AuthServerClaimDefault':
        """
    ...
    @property
    @pulumi.getter(name="alwaysIncludeInToken")
    def always_include_in_token(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies whether to include claims in token.
        """
        return pulumi.get(self, "always_include_in_token")
