...
class EmailSenderArgs:
    def __init__(__self__, *,
                 ...
                 from_name: pulumi.Input[builtins.str],
                 subdomain: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a EmailSender resource.
        :param pulumi.Input[builtins.str] from_address: Email address to send from
        :param pulumi.Input[builtins.str] from_name: Name of sender
        :param pulumi.Input[builtins.str] subdomain: Mail domain to send from
        """
    ...
    def from_name(self) -> pulumi.Input[builtins.str]:
        """
        Name of sender
        """
    ...
    @from_name.setter
    def from_name(self, value: pulumi.Input[builtins.str]):
...
class _EmailSenderState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] from_address: Email address to send from
        :param pulumi.Input[builtins.str] from_name: Name of sender
        :param pulumi.Input[builtins.str] status: Verification status
        :param pulumi.Input[builtins.str] subdomain: Mail domain to send from
        """
...
class EmailSender(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            from_name: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            subdomain: Optional[pulumi.Input[builtins.str]] = None) -> 'EmailSender':
        """
    ...
    @property
    @pulumi.getter(name="fromName")
    def from_name(self) -> pulumi.Output[builtins.str]:
        """
        Name of sender
        """
        return pulumi.get(self, "from_name")
