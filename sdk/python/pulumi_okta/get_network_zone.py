...
class GetNetworkZoneResult:
    ...
    @_builtins.property
    @pulumi.getter
    def asns(self) -> Sequence[_builtins.str]:
        """
    ...
    def dynamic_locations(self) -> Sequence[_builtins.str]:
        """
    ...
    def dynamic_locations_excludes(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def dynamic_proxy_type(self) -> _builtins.str:
        """
    ...
    def ip_service_categories_excludes(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def ip_service_categories_includes(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def proxies(self) -> Sequence[_builtins.str]:
        """
...
def get_network_zone(dynamic_locations_excludes: Optional[Sequence[_builtins.str]] = None,
                     id: Optional[_builtins.str] = None,
                     ip_service_categories_excludes: Optional[Sequence[_builtins.str]] = None,
                     ip_service_categories_includes: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] dynamic_locations_excludes: Array of locations ISO-3166-1(2) excluded. Format code: countryCode OR countryCode-regionCode. Use with type `DYNAMIC_V2`
    :param _builtins.str id: ID of the network zone to retrieve, conflicts with `name`.
    :param Sequence[_builtins.str] ip_service_categories_excludes: List of ip service excluded. Use with type `DYNAMIC_V2`
    :param Sequence[_builtins.str] ip_service_categories_includes: List of ip service included. Use with type `DYNAMIC_V2`
    :param _builtins.str name: Name of the network zone to retrieve, conflicts with `id`.
    """
    __args__ = dict()
