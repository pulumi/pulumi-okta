...
class GetNetworkZoneResult:
    ...
    @property
    @pulumi.getter
    def asns(self) -> Sequence[builtins.str]:
        """
    ...
    def dynamic_locations(self) -> Sequence[builtins.str]:
        """
    ...
    def dynamic_locations_excludes(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    @property
    @pulumi.getter
    def gateways(self) -> Sequence[builtins.str]:
        """
    ...
    def ip_service_categories_excludes(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def ip_service_categories_includes(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    @property
    @pulumi.getter
    def proxies(self) -> Sequence[builtins.str]:
        """
...
def get_network_zone(dynamic_locations_excludes: Optional[Sequence[builtins.str]] = None,
                     id: Optional[builtins.str] = None,
                     ip_service_categories_excludes: Optional[Sequence[builtins.str]] = None,
                     ip_service_categories_includes: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] dynamic_locations_excludes: Array of locations ISO-3166-1(2) excluded. Format code: countryCode OR countryCode-regionCode. Use with type `DYNAMIC_V2`
    :param builtins.str id: ID of the network zone to retrieve, conflicts with `name`.
    :param Sequence[builtins.str] ip_service_categories_excludes: List of ip service excluded. Use with type `DYNAMIC_V2`
    :param Sequence[builtins.str] ip_service_categories_includes: List of ip service included. Use with type `DYNAMIC_V2`
    :param builtins.str name: Name of the network zone to retrieve, conflicts with `id`.
    """
    __args__ = dict()
...
def get_network_zone_output(dynamic_locations_excludes: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                            id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            ip_service_categories_excludes: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                            ip_service_categories_includes: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
