...
class GetOauthResult:
    ...
    def login_scopes(self) -> Sequence[builtins.str]:
        """
    ...
    def response_types(self) -> Sequence[builtins.str]:
        """
...
def get_oauth(active_only: Optional[builtins.bool] = None,
    ...
    :param builtins.str label: The label of the app to retrieve, conflicts with
           			label_prefix and id. Label uses the ?q=\\n\\n query parameter exposed by
           			Okta's List Apps API. The API will search both name and label using that
           			query. Therefore similarily named and labeled apps may be returned in the query
           			and have the unitended result of associating the wrong app with this data
...
def get_oauth_output(active_only: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
