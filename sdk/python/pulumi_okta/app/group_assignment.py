...
class GroupAssignmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] app_id: App to associate group with
        :param pulumi.Input[builtins.str] group_id: Group associated with the application
        ...
        :param pulumi.Input[builtins.bool] retain_assignment: Retain the group assignment on destroy. If set to true, the resource will be removed from state but not from the Okta app.
        """
...
class GroupAssignment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            priority: Optional[pulumi.Input[builtins.int]] = None,
            profile: Optional[pulumi.Input[builtins.str]] = None,
            retain_assignment: Optional[pulumi.Input[builtins.bool]] = None) -> 'GroupAssignment':
        """
