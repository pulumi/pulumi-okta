...
class GroupAssignmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] retain_assignment: Retain the group assignment on destroy. If set to true, the resource will be removed from state but not from the Okta app.
        """
