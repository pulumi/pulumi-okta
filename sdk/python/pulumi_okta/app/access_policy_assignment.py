...
class AccessPolicyAssignmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] app_id: The application ID; this value is immutable and can not be updated.
        :param pulumi.Input[builtins.str] policy_id: The access policy ID.
        """
...
@pulumi.type_token("okta:app/accessPolicyAssignment:AccessPolicyAssignment")
class AccessPolicyAssignment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            app_id: Optional[pulumi.Input[builtins.str]] = None,
            policy_id: Optional[pulumi.Input[builtins.str]] = None) -> 'AccessPolicyAssignment':
        """
