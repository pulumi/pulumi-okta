...
class GetMetadataSamlResult:
    ...
    def want_authn_requests_signed(self) -> builtins.bool:
        """
...
def get_metadata_saml(app_id: Optional[builtins.str] = None,
    ...
    :param builtins.str app_id: The application ID.
    :param builtins.str key_id: Certificate Key ID.
    """
    __args__ = dict()
...
def get_metadata_saml_output(app_id: Optional[pulumi.Input[builtins.str]] = None,
