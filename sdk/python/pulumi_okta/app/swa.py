...
class SwaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] preconfigured_app: Preconfigured app name
        :param pulumi.Input[builtins.str] redirect_url: If going to the login page URL redirects to another page, then enter that URL here
...
class Swa(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            user_name_template_suffix: Optional[pulumi.Input[builtins.str]] = None,
            user_name_template_type: Optional[pulumi.Input[builtins.str]] = None,
            username_field: Optional[pulumi.Input[builtins.str]] = None) -> 'Swa':
        """
