...
class SwaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] preconfigured_app: Preconfigured app name
        :param pulumi.Input[_builtins.str] redirect_url: If going to the login page URL redirects to another page, then enter that URL here
