...
class OauthRoleAssignmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] client_id: Client ID for the role to be assigned to
        :param pulumi.Input[builtins.str] type: Role type to assign. This can be one of the standard Okta roles, such as `HELP_DESK_ADMIN`, or `CUSTOM`. Using custom requires the `resource_set` and `role` attributes to be set.
        :param pulumi.Input[builtins.str] resource_set: Resource set for the custom role to assign, must be the ID of the created resource set.
        :param pulumi.Input[builtins.str] role: Custom Role ID
        """
...
class _OauthRoleAssignmentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] client_id: Client ID for the role to be assigned to
        :param pulumi.Input[builtins.str] label: Label of the role assignment
        :param pulumi.Input[builtins.str] resource_set: Resource set for the custom role to assign, must be the ID of the created resource set.
        :param pulumi.Input[builtins.str] role: Custom Role ID
        :param pulumi.Input[builtins.str] status: Status of the role assignment
        :param pulumi.Input[builtins.str] type: Role type to assign. This can be one of the standard Okta roles, such as `HELP_DESK_ADMIN`, or `CUSTOM`. Using custom requires the `resource_set` and `role` attributes to be set.
        """
...
class OauthRoleAssignment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            role: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'OauthRoleAssignment':
        """
