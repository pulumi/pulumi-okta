...
class AutoLoginArgs:
    def __init__(__self__, *,
                 ...
                 sign_on_redirect_url: Optional[pulumi.Input[builtins.str]] = None,
                 sign_on_url: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] preconfigured_app: Tells Okta to use an existing application in their application catalog, as opposed to a custom application.
        :param pulumi.Input[builtins.bool] reveal_password: Allow user to reveal password. Default is false. It can not be set to true if credentials*scheme is "ADMIN*SETS*CREDENTIALS", "SHARED*USERNAME*AND*PASSWORD" or "EXTERNAL*PASSWORD*SYNC".
        ...
        :param pulumi.Input[builtins.str] sign_on_redirect_url: Post login redirect URL
        :param pulumi.Input[builtins.str] sign_on_url: Login URL
    ...
    def sign_on_redirect_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def sign_on_redirect_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sign_on_redirect_url", value)

    @property
    @pulumi.getter(name="signOnUrl")
    def sign_on_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Login URL
        """
    ...
    @sign_on_url.setter
    def sign_on_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AutoLogin(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            user_name_template_push_status: Optional[pulumi.Input[builtins.str]] = None,
            user_name_template_suffix: Optional[pulumi.Input[builtins.str]] = None,
            user_name_template_type: Optional[pulumi.Input[builtins.str]] = None) -> 'AutoLogin':
        """
    ...
    @property
    @pulumi.getter(name="signOnRedirectUrl")
    def sign_on_redirect_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Post login redirect URL
        """
        return pulumi.get(self, "sign_on_redirect_url")
    ...
    @property
    @pulumi.getter(name="signOnUrl")
    def sign_on_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Login URL
        """
        return pulumi.get(self, "sign_on_url")
