...
class AutoLoginArgs:
    def __init__(__self__, *,
                 ...
                 sign_on_redirect_url: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] preconfigured_app: Tells Okta to use an existing application in their application catalog, as opposed to a custom application.
        :param pulumi.Input[_builtins.bool] reveal_password: Allow user to reveal password. Default is false. It can not be set to true if credentials*scheme is "ADMIN*SETS*CREDENTIALS", "SHARED*USERNAME*AND*PASSWORD" or "EXTERNAL*PASSWORD*SYNC".
        ...
        :param pulumi.Input[_builtins.str] sign_on_redirect_url: Post login redirect URL
        :param pulumi.Input[_builtins.str] sign_on_url: Login URL
    ...
    def sign_on_redirect_url(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def sign_on_redirect_url(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class AutoLogin(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            user_name_template_push_status: pulumi.Input[Optional[_builtins.str]] = None,
            user_name_template_suffix: pulumi.Input[Optional[_builtins.str]] = None,
            user_name_template_type: pulumi.Input[Optional[_builtins.str]] = None) -> 'AutoLogin':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="signOnRedirectUrl")
    def sign_on_redirect_url(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Post login redirect URL
        """
        return pulumi.get(self, "sign_on_redirect_url")
    ...
    @_builtins.property
    @pulumi.getter(name="signOnUrl")
    def sign_on_url(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Login URL
        """
        return pulumi.get(self, "sign_on_url")
