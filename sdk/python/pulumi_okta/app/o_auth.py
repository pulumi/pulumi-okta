...
class OAuthArgs:
    def __init__(__self__, *,
                 ...
                 auto_key_rotation: Optional[pulumi.Input[builtins.bool]] = None,
                 auto_submit_toolbar: Optional[pulumi.Input[builtins.bool]] = None,
                 client_basic_secret: Optional[pulumi.Input[builtins.str]] = None,
                 client_id: Optional[pulumi.Input[builtins.str]] = None,
                 client_uri: Optional[pulumi.Input[builtins.str]] = None,
                 consent_method: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 login_mode: Optional[pulumi.Input[builtins.str]] = None,
                 login_scopes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 login_uri: Optional[pulumi.Input[builtins.str]] = None,
                 logo: Optional[pulumi.Input[builtins.str]] = None,
                 logo_uri: Optional[pulumi.Input[builtins.str]] = None,
                 omit_secret: Optional[pulumi.Input[builtins.bool]] = None,
                 pkce_required: Optional[pulumi.Input[builtins.bool]] = None,
                 policy_uri: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 refresh_token_leeway: Optional[pulumi.Input[builtins.int]] = None,
                 refresh_token_rotation: Optional[pulumi.Input[builtins.str]] = None,
                 response_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 token_endpoint_auth_method: Optional[pulumi.Input[builtins.str]] = None,
                 tos_uri: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 wildcard_redirect: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] type: The type of client application.
        ...
        :param pulumi.Input[builtins.str] authentication_policy: The ID of the associated app*signon*policy. If this property is removed from the application the default sign-on-policy will be associated with this application.
        :param pulumi.Input[builtins.bool] auto_key_rotation: Requested key rotation mode. If
        ...
        :param pulumi.Input[builtins.str] client_basic_secret: The user provided OAuth client secret key value, this can be set when token*endpoint*auth*method is client*secret*basic. This does nothing when `omit*secret is set to true.
        :param pulumi.Input[builtins.str] client_id: OAuth client ID. If set during creation, app is created with this id.
        :param pulumi.Input[builtins.str] client_uri: URI to a web page providing information about the client.
        :param pulumi.Input[builtins.str] consent_method: *Early Access Property*. Indicates whether user consent is required or implicit. Valid values: REQUIRED, TRUSTED. Default value is TRUSTED
        :param pulumi.Input[builtins.str] enduser_note: Application notes for end users.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] grant_types: List of OAuth 2.0 grant types. Conditional validation params found here https://developer.okta.com/docs/api/resources/apps#credentials-settings-details. Defaults to minimum requirements per app type.
        ...
        :param pulumi.Input[builtins.str] issuer_mode: *Early Access Property*. Indicates whether the Okta Authorization Server uses the original Okta org domain URL or a custom domain URL as the issuer of ID token for this client.
        :param pulumi.Input[builtins.str] jwks_uri: URL reference to JWKS
        :param pulumi.Input[builtins.str] login_mode: The type of Idp-Initiated login that the client supports, if any
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] login_scopes: List of scopes to use for the request
        :param pulumi.Input[builtins.str] login_uri: URI that initiates login.
        ...
        :param pulumi.Input[builtins.str] logo_uri: URI that references a logo for the client.
        :param pulumi.Input[builtins.bool] omit_secret: This tells the provider not manage the client*secret value in state. When this is false (the default), it will cause the auto-generated client*secret to be persisted in the client_secret attribute in state. This also means that every time an update to this app is run, this value is also set on the API. If this changes from false => true, the `client_secret` is dropped from state and the secret at the time of the apply is what remains. If this is ever changes from true => false your app will be recreated, due to the need to regenerate a secret we can store in state.
        :param pulumi.Input[builtins.bool] pkce_required: Require Proof Key for Code Exchange (PKCE) for additional verification key rotation mode. See: https://developer.okta.com/docs/reference/api/apps/#oauth-credential-object
        :param pulumi.Input[builtins.str] policy_uri: URI to web page providing client policy document.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] post_logout_redirect_uris: List of URIs for redirection after logout. Note: see okta*app*oauth*post*logout*redirect*uri for appending to this list in a decentralized way.
        :param pulumi.Input[builtins.str] profile: Custom JSON that represents an OAuth application's profile
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] redirect_uris: List of URIs for use in the redirect-based flow. This is required for all application types except service. Note: see okta*app*oauth*redirect*uri for appending to this list in a decentralized way.
        :param pulumi.Input[builtins.int] refresh_token_leeway: *Early Access Property* Grace period for token rotation, required with grant types refresh_token
        :param pulumi.Input[builtins.str] refresh_token_rotation: *Early Access Property* Refresh token rotation behavior, required with grant types refresh_token
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] response_types: List of OAuth 2.0 response type strings. Valid values are any combination of: `code`, `token`, and `id_token`.
        :param pulumi.Input[builtins.str] status: Status of application. By default, it is `ACTIVE`
        :param pulumi.Input[builtins.str] token_endpoint_auth_method: Requested authentication method for the token endpoint, valid values include:  'client*secret*basic', 'client*secret*post', 'client*secret*jwt', 'private*key*jwt', 'none', etc.
        :param pulumi.Input[builtins.str] tos_uri: URI to web page providing client tos (terms of service).
        ...
        :param pulumi.Input[builtins.str] wildcard_redirect: *Early Access Property*. Indicates if the client is allowed to use wildcard matching of redirect_uris
        """
    ...
    def auto_key_rotation(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def auto_key_rotation(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def client_basic_secret(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def client_basic_secret(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def client_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @client_uri.setter
    def client_uri(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "client_uri", value)

    @property
    @pulumi.getter(name="consentMethod")
    def consent_method(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def consent_method(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def login_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @login_mode.setter
    def login_mode(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "login_mode", value)

    @property
    @pulumi.getter(name="loginScopes")
    def login_scopes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @login_scopes.setter
    def login_scopes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "login_scopes", value)

    @property
    @pulumi.getter(name="loginUri")
    def login_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @login_uri.setter
    def login_uri(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def omit_secret(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        This tells the provider not manage the client*secret value in state. When this is false (the default), it will cause the auto-generated client*secret to be persisted in the client_secret attribute in state. This also means that every time an update to this app is run, this value is also set on the API. If this changes from false => true, the `client_secret` is dropped from state and the secret at the time of the apply is what remains. If this is ever changes from true => false your app will be recreated, due to the need to regenerate a secret we can store in state.
        """
    ...
    @omit_secret.setter
    def omit_secret(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def policy_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @policy_uri.setter
    def policy_uri(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def refresh_token_leeway(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def refresh_token_leeway(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "refresh_token_leeway", value)

    @property
    @pulumi.getter(name="refreshTokenRotation")
    def refresh_token_rotation(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def refresh_token_rotation(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "refresh_token_rotation", value)

    @property
    @pulumi.getter(name="responseTypes")
    def response_types(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def response_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def tos_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @tos_uri.setter
    def tos_uri(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def wildcard_redirect(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def wildcard_redirect(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _OAuthState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] client_basic_secret: The user provided OAuth client secret key value, this can be set when token*endpoint*auth*method is client*secret*basic. This does nothing when `omit*secret is set to true.
        :param pulumi.Input[builtins.str] client_id: OAuth client ID. If set during creation, app is created with this id.
        :param pulumi.Input[builtins.str] client_secret: OAuth client secret value, this is output only. This will be in plain text in your statefile unless you set omit_secret above.
        :param pulumi.Input[builtins.str] client_uri: URI to a web page providing information about the client.
        :param pulumi.Input[builtins.str] consent_method: *Early Access Property*. Indicates whether user consent is required or implicit. Valid values: REQUIRED, TRUSTED. Default value is TRUSTED
        :param pulumi.Input[builtins.str] enduser_note: Application notes for end users.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] grant_types: List of OAuth 2.0 grant types. Conditional validation params found here https://developer.okta.com/docs/api/resources/apps#credentials-settings-details. Defaults to minimum requirements per app type.
...
class OAuth(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            user_name_template_suffix: Optional[pulumi.Input[builtins.str]] = None,
            user_name_template_type: Optional[pulumi.Input[builtins.str]] = None,
            wildcard_redirect: Optional[pulumi.Input[builtins.str]] = None) -> 'OAuth':
        """
    ...
    @property
    @pulumi.getter(name="autoKeyRotation")
    def auto_key_rotation(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Requested key rotation mode. If
        			auto*key*rotation isn't specified, the client automatically opts in for Okta's
        			key rotation. You can update this property via the API or via the administrator
    ...
    @property
    @pulumi.getter(name="clientBasicSecret")
    def client_basic_secret(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The user provided OAuth client secret key value, this can be set when token*endpoint*auth*method is client*secret*basic. This does nothing when `omit*secret is set to true.
        """
        return pulumi.get(self, "client_basic_secret")
    ...
    @property
    @pulumi.getter(name="clientUri")
    def client_uri(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        URI to a web page providing information about the client.
        """
        return pulumi.get(self, "client_uri")
    ...
    @property
    @pulumi.getter(name="consentMethod")
    def consent_method(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        *Early Access Property*. Indicates whether user consent is required or implicit. Valid values: REQUIRED, TRUSTED. Default value is TRUSTED
        """
        return pulumi.get(self, "consent_method")
    ...
    @property
    @pulumi.getter(name="jwksUri")
    def jwks_uri(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        URL reference to JWKS
        """
        return pulumi.get(self, "jwks_uri")
    ...
    @property
    @pulumi.getter(name="loginMode")
    def login_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The type of Idp-Initiated login that the client supports, if any
        """
        return pulumi.get(self, "login_mode")
    ...
    @property
    @pulumi.getter(name="loginScopes")
    def login_scopes(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of scopes to use for the request
        """
        return pulumi.get(self, "login_scopes")
    ...
    @property
    @pulumi.getter(name="loginUri")
    def login_uri(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        URI that initiates login.
        """
        return pulumi.get(self, "login_uri")
    ...
    @property
    @pulumi.getter(name="logoUri")
    def logo_uri(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        URI that references a logo for the client.
        """
        return pulumi.get(self, "logo_uri")
    ...
    @property
    @pulumi.getter(name="omitSecret")
    def omit_secret(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        This tells the provider not manage the client*secret value in state. When this is false (the default), it will cause the auto-generated client*secret to be persisted in the client_secret attribute in state. This also means that every time an update to this app is run, this value is also set on the API. If this changes from false => true, the `client_secret` is dropped from state and the secret at the time of the apply is what remains. If this is ever changes from true => false your app will be recreated, due to the need to regenerate a secret we can store in state.
        """
        return pulumi.get(self, "omit_secret")
    ...
    @property
    @pulumi.getter(name="pkceRequired")
    def pkce_required(self) -> pulumi.Output[builtins.bool]:
        """
        Require Proof Key for Code Exchange (PKCE) for additional verification key rotation mode. See: https://developer.okta.com/docs/reference/api/apps/#oauth-credential-object
        """
        return pulumi.get(self, "pkce_required")
    ...
    @property
    @pulumi.getter(name="policyUri")
    def policy_uri(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        URI to web page providing client policy document.
        """
        return pulumi.get(self, "policy_uri")
    ...
    @property
    @pulumi.getter(name="postLogoutRedirectUris")
    def post_logout_redirect_uris(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of URIs for redirection after logout. Note: see okta*app*oauth*post*logout*redirect*uri for appending to this list in a decentralized way.
        """
        return pulumi.get(self, "post_logout_redirect_uris")
    ...
    @property
    @pulumi.getter(name="refreshTokenLeeway")
    def refresh_token_leeway(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        *Early Access Property* Grace period for token rotation, required with grant types refresh_token
        """
        return pulumi.get(self, "refresh_token_leeway")
    ...
    @property
    @pulumi.getter(name="refreshTokenRotation")
    def refresh_token_rotation(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        *Early Access Property* Refresh token rotation behavior, required with grant types refresh_token
        """
        return pulumi.get(self, "refresh_token_rotation")
    ...
    @property
    @pulumi.getter(name="responseTypes")
    def response_types(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        List of OAuth 2.0 response type strings. Valid values are any combination of: `code`, `token`, and `id_token`.
        """
        return pulumi.get(self, "response_types")
    ...
    @property
    @pulumi.getter(name="tokenEndpointAuthMethod")
    def token_endpoint_auth_method(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Requested authentication method for the token endpoint, valid values include:  'client*secret*basic', 'client*secret*post', 'client*secret*jwt', 'private*key*jwt', 'none', etc.
        """
        return pulumi.get(self, "token_endpoint_auth_method")
    ...
    @property
    @pulumi.getter(name="tosUri")
    def tos_uri(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        URI to web page providing client tos (terms of service).
        """
        return pulumi.get(self, "tos_uri")
    ...
    @property
    @pulumi.getter(name="wildcardRedirect")
    def wildcard_redirect(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        *Early Access Property*. Indicates if the client is allowed to use wildcard matching of redirect_uris
        """
        return pulumi.get(self, "wildcard_redirect")
