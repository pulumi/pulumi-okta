...
class OAuthArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['OAuthJwkArgs']]] jwks: JSON Web Key Set (JWKS) for application. Note: Inline JWKS may have compatibility issues with v6 SDK. Consider using jwks_uri instead.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] login_scopes: List of scopes to use for the request
        ...
        if frontchannel_logout_session_required is not None:
            pulumi.set(__self__, "frontchannel_logout_session_required", frontchannel_logout_session_required)
        if frontchannel_logout_uri is not None:
            pulumi.set(__self__, "frontchannel_logout_uri", frontchannel_logout_uri)
...
class OAuth(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["frontchannel_logout_session_required"] = frontchannel_logout_session_required
            __props__.__dict__["frontchannel_logout_uri"] = frontchannel_logout_uri
    ...
    @_builtins.property
    @pulumi.getter(name="autoKeyRotation")
    def auto_key_rotation(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Requested key rotation mode. If
        			auto*key*rotation isn't specified, the client automatically opts in for Okta's
        			key rotation. You can update this property via the API or via the administrator
    ...
    @_builtins.property
    @pulumi.getter(name="frontchannelLogoutSessionRequired")
    def frontchannel_logout_session_required(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        *Early Access Property*. Determines whether Okta sends sid and iss in the logout request.
        """
        return pulumi.get(self, "frontchannel_logout_session_required")
    ...
    @_builtins.property
    @pulumi.getter(name="frontchannelLogoutUri")
    def frontchannel_logout_uri(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        *Early Access Property*. URL where Okta sends the logout request. Required when participate_slo is true.
        """
        return pulumi.get(self, "frontchannel_logout_uri")
    ...
    @_builtins.property
    @pulumi.getter(name="loginMode")
    def login_mode(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The type of Idp-Initiated login that the client supports, if any
        """
        return pulumi.get(self, "login_mode")
    ...
    @_builtins.property
    @pulumi.getter(name="loginScopes")
    def login_scopes(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        List of scopes to use for the request
        """
        return pulumi.get(self, "login_scopes")
    ...
    @_builtins.property
    @pulumi.getter(name="loginUri")
    def login_uri(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        URI that initiates login.
        """
        return pulumi.get(self, "login_uri")
    ...
    @_builtins.property
    @pulumi.getter(name="pkceRequired")
    def pkce_required(self) -> pulumi.Output[_builtins.bool]:
        """
        Require Proof Key for Code Exchange (PKCE) for additional verification key rotation mode. See: https://developer.okta.com/docs/reference/api/apps/#oauth-credential-object
        """
        return pulumi.get(self, "pkce_required")
    ...
    @_builtins.property
    @pulumi.getter(name="refreshTokenLeeway")
    def refresh_token_leeway(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        *Early Access Property* Grace period for token rotation, required with grant types refresh_token
        """
        return pulumi.get(self, "refresh_token_leeway")
    ...
    @_builtins.property
    @pulumi.getter(name="refreshTokenRotation")
    def refresh_token_rotation(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        *Early Access Property* Refresh token rotation behavior, required with grant types refresh_token
        """
        return pulumi.get(self, "refresh_token_rotation")
    ...
    @_builtins.property
    @pulumi.getter(name="tokenEndpointAuthMethod")
    def token_endpoint_auth_method(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Requested authentication method for the token endpoint, valid values include:  'client*secret*basic', 'client*secret*post', 'client*secret*jwt', 'private*key*jwt', 'none', etc.
        """
        return pulumi.get(self, "token_endpoint_auth_method")
