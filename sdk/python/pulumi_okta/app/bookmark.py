...
class BookmarkArgs:
    ...
    def _configure(
        ...
        if request_integration is not None:
            _setter("request_integration", request_integration)
...
class Bookmark(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a Bookmark resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            sign_on_mode: Optional[pulumi.Input[str]] = None,
            status: Optional[pulumi.Input[str]] = None,
            url: Optional[pulumi.Input[str]] = None) -> 'Bookmark':
        """
