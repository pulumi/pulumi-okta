...
class OAuthGroupsClaimArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: Name of the claim that will be used in the token.
        :param pulumi.Input[builtins.str] type: Groups claim type.
        :param pulumi.Input[builtins.str] value: Value of the claim. Can be an Okta Expression Language statement that evaluates at the time the token is minted.
        :param pulumi.Input[builtins.str] filter_type: Groups claim filter. Can only be set if type is FILTER.
        :param pulumi.Input[builtins.str] issuer_mode: Issuer mode inherited from OAuth App
        """
...
class OAuthJwkArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] kid: Key ID
        :param pulumi.Input[builtins.str] kty: Key type
        :param pulumi.Input[builtins.str] e: RSA Exponent
        :param pulumi.Input[builtins.str] n: RSA Modulus
        :param pulumi.Input[builtins.str] x: X coordinate of the elliptic curve point
        :param pulumi.Input[builtins.str] y: Y coordinate of the elliptic curve point
        """
...
class SamlAttributeStatementArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The reference name of the attribute statement
        :param pulumi.Input[builtins.str] filter_type: Type of group attribute filter. Valid values are: `STARTS_WITH`, `EQUALS`, `CONTAINS`, or `REGEX`
        :param pulumi.Input[builtins.str] filter_value: Filter value to use
        :param pulumi.Input[builtins.str] namespace: The attribute namespace. It can be set to `urn:oasis:names:tc:SAML:2.0:attrname-format:unspecified`, `urn:oasis:names:tc:SAML:2.0:attrname-format:uri`, or `urn:oasis:names:tc:SAML:2.0:attrname-format:basic`
        :param pulumi.Input[builtins.str] type: The type of attribute statements object
        """
        pulumi.set(__self__, "name", name)
        if filter_type is not None:
            pulumi.set(__self__, "filter_type", filter_type)
...
if not MYPY:
    class SamlKeyArgsDict(TypedDict):
        ...
        """
        x5cs: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        X.509 Certificate Chain
        """
        x5t_s256: NotRequired[pulumi.Input[builtins.str]]
        """
...
class SamlKeyArgs:
    def __init__(__self__, *,
                 ...
                 x5cs: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 x5t_s256: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] created: Created date
        :param pulumi.Input[builtins.str] e: RSA exponent
        :param pulumi.Input[builtins.str] expires_at: Expiration date
        :param pulumi.Input[builtins.str] kid: Key ID
        :param pulumi.Input[builtins.str] kty: Key type. Identifies the cryptographic algorithm family used with the key.
        :param pulumi.Input[builtins.str] last_updated: Last updated date
        :param pulumi.Input[builtins.str] n: RSA modulus
        :param pulumi.Input[builtins.str] use: Intended use of the public key.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] x5cs: X.509 Certificate Chain
        :param pulumi.Input[builtins.str] x5t_s256: X.509 certificate SHA-256 thumbprint
        """
    ...
    @property
    @pulumi.getter
    def x5cs(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        X.509 Certificate Chain
        """
    ...
    @x5cs.setter
    def x5cs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "x5cs", value)

    @property
    @pulumi.getter(name="x5tS256")
    def x5t_s256(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        X.509 certificate SHA-256 thumbprint
        """
    ...
    @x5t_s256.setter
    def x5t_s256(self, value: Optional[pulumi.Input[builtins.str]]):
