...
class UserArgs:
    def __init__(__self__, *,
                 ...
                 retain_assignment: Optional[pulumi.Input[builtins.bool]] = None,
                 username: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a User resource.
        :param pulumi.Input[builtins.str] app_id: App to associate user with
        :param pulumi.Input[builtins.str] user_id: User associated with the application
        :param pulumi.Input[builtins.str] password: The password to use.
        :param pulumi.Input[builtins.str] profile: The JSON profile of the App User.
        :param pulumi.Input[builtins.bool] retain_assignment: Retain the user assignment on destroy. If set to true, the resource will be removed from state but not from the Okta app.
        :param pulumi.Input[builtins.str] username: The username to use for the app user. In case the user is assigned to the app with `SHARED_USERNAME_AND_PASSWORD` credentials scheme, this field will be computed and should not be set.
        """
    ...
    def retain_assignment(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def retain_assignment(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _UserState:
    def __init__(__self__, *,
                 ...
                 has_shared_username: Optional[pulumi.Input[builtins.bool]] = None,
                 password: Optional[pulumi.Input[builtins.str]] = None,
                 profile: Optional[pulumi.Input[builtins.str]] = None,
                 retain_assignment: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    def has_shared_username(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "has_shared_username")

    @has_shared_username.setter
    def has_shared_username(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class User(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="hasSharedUsername")
    def has_shared_username(self) -> pulumi.Output[builtins.bool]:
        return pulumi.get(self, "has_shared_username")
    ...
    @property
    @pulumi.getter(name="retainAssignment")
    def retain_assignment(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Retain the user assignment on destroy. If set to true, the resource will be removed from state but not from the Okta app.
        """
        return pulumi.get(self, "retain_assignment")
