...
class GetSamlResult:
    ...
    def accessibility_self_service(self) -> builtins.bool:
        """
        Enable self service
        """
    ...
    def acs_endpoints(self) -> Sequence[builtins.str]:
        """
    ...
    def assertion_signed(self) -> builtins.bool:
        """
    ...
    def hide_ios(self) -> builtins.bool:
        """
    ...
    def hide_web(self) -> builtins.bool:
        """
    ...
    def honor_force_authn(self) -> builtins.bool:
        """
    ...
    def request_compressed(self) -> Optional[builtins.bool]:
        """
    ...
    def response_signed(self) -> builtins.bool:
        """
    ...
    def saml_signed_request_enabled(self) -> builtins.bool:
        """
    ...
    def skip_groups(self) -> Optional[builtins.bool]:
        """
    ...
    def skip_users(self) -> Optional[builtins.bool]:
        """
...
def get_saml(active_only: Optional[builtins.bool] = None,
             id: Optional[builtins.str] = None,
             label: Optional[builtins.str] = None,
             label_prefix: Optional[builtins.str] = None,
             request_compressed: Optional[builtins.bool] = None,
             skip_groups: Optional[builtins.bool] = None,
             skip_users: Optional[builtins.bool] = None,
    ...
    :param builtins.str id: Id of application to retrieve, conflicts with label and label_prefix.
    :param builtins.str label: The label of the app to retrieve, conflicts with label_prefix and id. Label
           			uses the ?q=\\n\\n query parameter exposed by Okta's API. It should be noted that at this time
           			this searches both name and label. This is used to avoid paginating through all applications.
    :param builtins.str label_prefix: Label prefix of the app to retrieve, conflicts with label and id. This will tell the
           			provider to do a starts with query as opposed to an equals query.
    :param builtins.bool request_compressed: Denotes whether the request is compressed or not.
    :param builtins.bool skip_groups: Ignore groups sync. This is a temporary solution until 'groups' field is supported in all the app-like resources
    :param builtins.bool skip_users: Ignore users sync. This is a temporary solution until 'users' field is supported in all the app-like resources
    """
    __args__ = dict()
...
def get_saml_output(active_only: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                    ...
                    request_compressed: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                    skip_groups: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                    skip_users: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
