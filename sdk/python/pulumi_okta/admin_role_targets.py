...
class AdminRoleTargetsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] role_type: Type of the role that is assigned to the user and supports optional targets. See [API Docs](https://developer.okta.com/docs/api/openapi/okta-management/guides/roles/#standard-roles)
        :param pulumi.Input[builtins.str] user_id: User associated with the role
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] apps: List of app names (name represents set of app instances) or a combination of app name and app instance ID (like 'salesforce' or 'facebook.0oapsqQ6dv19pqyEo0g3')
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] groups: List of group IDs. Conflicts with apps
        """
...
class _AdminRoleTargetsState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] apps: List of app names (name represents set of app instances) or a combination of app name and app instance ID (like 'salesforce' or 'facebook.0oapsqQ6dv19pqyEo0g3')
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] groups: List of group IDs. Conflicts with apps
        :param pulumi.Input[builtins.str] role_id: ID of a role
        :param pulumi.Input[builtins.str] role_type: Type of the role that is assigned to the user and supports optional targets. See [API Docs](https://developer.okta.com/docs/api/openapi/okta-management/guides/roles/#standard-roles)
        :param pulumi.Input[builtins.str] user_id: User associated with the role
        """
        if apps is not None:
...
class AdminRoleTargets(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            role_id: Optional[pulumi.Input[builtins.str]] = None,
            role_type: Optional[pulumi.Input[builtins.str]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None) -> 'AdminRoleTargets':
        """
