...
class PolicyProfileEnrollmentArgs:
    def __init__(__self__, *,
        ...
        """
        PolicyProfileEnrollmentArgs._configure(
...
class _PolicyProfileEnrollmentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] status: Status of the policy
        """
        _PolicyProfileEnrollmentState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            name=name,
            status=status,
        )
...
class PolicyProfileEnrollment(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a PolicyProfileEnrollment resource with the given unique name, props, and options.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            PolicyProfileEnrollmentArgs._configure(_setter, **kwargs)
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            name: Optional[pulumi.Input[str]] = None,
            status: Optional[pulumi.Input[str]] = None) -> 'PolicyProfileEnrollment':
        """
