...
class RoleSubscriptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] notification_type: Type of the notification. Valid values: - 'CONNECTOR_AGENT' - Disconnects and reconnects: On-prem provisioning, on-prem
        ...
        :param pulumi.Input[_builtins.str] role_type: Type of the role. Valid values: 'API_ADMIN', 'APP_ADMIN', 'CUSTOM', 'GROUP_MEMBERSHIP_ADMIN', 'HELP_DESK_ADMIN',
...
class RoleSubscription(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            notification_type: Optional[pulumi.Input[_builtins.str]] = None,
            role_type: Optional[pulumi.Input[_builtins.str]] = None,
            status: Optional[pulumi.Input[_builtins.str]] = None) -> 'RoleSubscription':
        """
