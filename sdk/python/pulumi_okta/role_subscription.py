...
class RoleSubscriptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] notification_type: Type of the notification. Valid values: - 'CONNECTOR_AGENT' - Disconnects and reconnects: On-prem provisioning, on-prem
        ...
        :param pulumi.Input[builtins.str] role_type: Type of the role. Valid values: 'API_ADMIN', 'APP_ADMIN', 'CUSTOM', 'GROUP_MEMBERSHIP_ADMIN', 'HELP_DESK_ADMIN',
        ...
        :param pulumi.Input[builtins.str] status: Subscription status. Valid values: `subscribed`, `unsubscribed`.
        """
...
class RoleSubscription(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            notification_type: Optional[pulumi.Input[builtins.str]] = None,
            role_type: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'RoleSubscription':
        """
