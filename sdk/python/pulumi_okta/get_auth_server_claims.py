...
def get_auth_server_claims(auth_server_id: Optional[builtins.str] = None,
...
def get_auth_server_claims_output(auth_server_id: Optional[pulumi.Input[builtins.str]] = None,
