...
def get_user_security_questions(user_id: Optional[builtins.str] = None,
    ...
    :param builtins.str user_id: ID of a Okta User
    """
    __args__ = dict()
...
def get_user_security_questions_output(user_id: Optional[pulumi.Input[builtins.str]] = None,
