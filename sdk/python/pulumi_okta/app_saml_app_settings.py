...
class AppSamlAppSettingsArgs:
    def __init__(__self__, *,
                 ...
                 settings: pulumi.Input[builtins.str]):
        """
        ...
        :param pulumi.Input[builtins.str] settings: Application settings in JSON format
        """
    ...
    @property
    @pulumi.getter
    def settings(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @settings.setter
    def settings(self, value: pulumi.Input[builtins.str]):
...
class AppSamlAppSettings(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            app_id: Optional[pulumi.Input[builtins.str]] = None,
            settings: Optional[pulumi.Input[builtins.str]] = None) -> 'AppSamlAppSettings':
        """
    ...
    @property
    @pulumi.getter
    def settings(self) -> pulumi.Output[builtins.str]:
        """
        Application settings in JSON format
        """
        return pulumi.get(self, "settings")
