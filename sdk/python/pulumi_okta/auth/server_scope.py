...
class ServerScopeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: Description of the Auth Server Scope.
        :param pulumi.Input[_builtins.str] display_name: Name of the end user displayed in a consent dialog box
        :param pulumi.Input[_builtins.str] metadata_publish: Whether to publish metadata or not. It can be set to `ALL_CLIENTS` or `NO_CLIENTS`. Default: `ALL_CLIENTS`
        :param pulumi.Input[_builtins.str] name: Auth server scope name
        :param pulumi.Input[_builtins.bool] optional: Whether the scope optional
        """
...
class _ServerScopeState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Auth server scope name
        :param pulumi.Input[_builtins.bool] optional: Whether the scope optional
        :param pulumi.Input[_builtins.bool] system: Whether Okta created the Scope
        """
...
class ServerScope(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def consent(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Indicates whether a consent dialog is needed for the scope. It can be set to `REQUIRED` or `IMPLICIT`. Default: `IMPLICIT`
        """
        return pulumi.get(self, "consent")
    ...
    @_builtins.property
    @pulumi.getter(name="metadataPublish")
    def metadata_publish(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Whether to publish metadata or not. It can be set to `ALL_CLIENTS` or `NO_CLIENTS`. Default: `ALL_CLIENTS`
        """
        return pulumi.get(self, "metadata_publish")
    ...
    @_builtins.property
    @pulumi.getter
    def optional(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Whether the scope optional
        """
        return pulumi.get(self, "optional")
