...
class ServerPolicyClaimArgs:
    def __init__(__self__, *,
                 auth_server_id: pulumi.Input[builtins.str],
                 grant_type_whitelists: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 policy_id: pulumi.Input[builtins.str],
                 priority: pulumi.Input[builtins.int],
                 access_token_lifetime_minutes: Optional[pulumi.Input[builtins.int]] = None,
                 group_blacklists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 group_whitelists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 inline_hook_id: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 refresh_token_lifetime_minutes: Optional[pulumi.Input[builtins.int]] = None,
                 refresh_token_window_minutes: Optional[pulumi.Input[builtins.int]] = None,
                 scope_whitelists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None,
                 user_blacklists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 user_whitelists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a ServerPolicyClaim resource.
        :param pulumi.Input[builtins.str] auth_server_id: Auth server ID
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] grant_type_whitelists: Accepted grant type values, `authorization_code`, `implicit`, `password`, `client_credentials`, `urn:ietf:params:oauth:grant-type:saml2-bearer` (*Early Access Property*), `urn:ietf:params:oauth:grant-type:token-exchange` (*Early Access Property*),`urn:ietf:params:oauth:grant-type:device_code` (*Early Access Property*), `interaction_code` (*OIE only*). For `implicit` value either `user_whitelist` or `group_whitelist` should be set.
        :param pulumi.Input[builtins.str] policy_id: Auth server policy ID
        :param pulumi.Input[builtins.int] priority: Priority of the auth server policy rule
        :param pulumi.Input[builtins.int] access_token_lifetime_minutes: Lifetime of access token. Can be set to a value between 5 and 1440 minutes. Default is `60`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] group_blacklists: Specifies a set of Groups whose Users are to be excluded.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] group_whitelists: Specifies a set of Groups whose Users are to be included. Can be set to Group ID or to the following: `EVERYONE`.
        :param pulumi.Input[builtins.str] inline_hook_id: The ID of the inline token to trigger.
        :param pulumi.Input[builtins.str] name: Auth server policy rule name
        :param pulumi.Input[builtins.int] refresh_token_lifetime_minutes: Lifetime of refresh token.
        :param pulumi.Input[builtins.int] refresh_token_window_minutes: Window in which a refresh token can be used. It can be a value between 5 and 2628000 (5 years) minutes. Default is `10080` (7 days).`refresh_token_window_minutes` must be between `access_token_lifetime_minutes` and `refresh_token_lifetime_minutes`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] scope_whitelists: Scopes allowed for this policy rule. They can be whitelisted by name or all can be whitelisted with `*`
        :param pulumi.Input[builtins.str] status: Default to `ACTIVE`
        :param pulumi.Input[builtins.str] type: Auth server policy rule type, unlikely this will be anything other then the default
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] user_blacklists: Specifies a set of Users to be excluded.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] user_whitelists: Specifies a set of Users to be included.
        """
    ...
    def auth_server_id(self) -> pulumi.Input[builtins.str]:
        """
        Auth server ID
        """
    ...
    def auth_server_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "auth_server_id", value)

    @property
    @pulumi.getter(name="grantTypeWhitelists")
    def grant_type_whitelists(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def grant_type_whitelists(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def access_token_lifetime_minutes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def access_token_lifetime_minutes(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "access_token_lifetime_minutes", value)

    @property
    @pulumi.getter(name="groupBlacklists")
    def group_blacklists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def group_blacklists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "group_blacklists", value)

    @property
    @pulumi.getter(name="groupWhitelists")
    def group_whitelists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def group_whitelists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def refresh_token_lifetime_minutes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def refresh_token_lifetime_minutes(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "refresh_token_lifetime_minutes", value)

    @property
    @pulumi.getter(name="refreshTokenWindowMinutes")
    def refresh_token_window_minutes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def refresh_token_window_minutes(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "refresh_token_window_minutes", value)

    @property
    @pulumi.getter(name="scopeWhitelists")
    def scope_whitelists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def scope_whitelists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def user_blacklists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def user_blacklists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "user_blacklists", value)

    @property
    @pulumi.getter(name="userWhitelists")
    def user_whitelists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def user_whitelists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _ServerPolicyClaimState:
    def __init__(__self__, *,
                 access_token_lifetime_minutes: Optional[pulumi.Input[builtins.int]] = None,
                 auth_server_id: Optional[pulumi.Input[builtins.str]] = None,
                 grant_type_whitelists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 group_blacklists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 group_whitelists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 inline_hook_id: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] scope_whitelists: Scopes allowed for this policy rule. They can be whitelisted by name or all can be whitelisted with `*`
        :param pulumi.Input[builtins.str] status: Default to `ACTIVE`
        :param pulumi.Input[builtins.bool] system: The rule is the system (default) rule for its associated policy
        :param pulumi.Input[builtins.str] type: Auth server policy rule type, unlikely this will be anything other then the default
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] user_blacklists: Specifies a set of Users to be excluded.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] user_whitelists: Specifies a set of Users to be included.
        """
    ...
    @property
    @pulumi.getter(name="authServerId")
    def auth_server_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Auth server ID
        """
        return pulumi.get(self, "auth_server_id")
    ...
    @auth_server_id.setter
    def auth_server_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "auth_server_id", value)

    @property
    @pulumi.getter(name="grantTypeWhitelists")
    def grant_type_whitelists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Accepted grant type values, `authorization_code`, `implicit`, `password`, `client_credentials`, `urn:ietf:params:oauth:grant-type:saml2-bearer` (*Early Access Property*), `urn:ietf:params:oauth:grant-type:token-exchange` (*Early Access Property*),`urn:ietf:params:oauth:grant-type:device_code` (*Early Access Property*), `interaction_code` (*OIE only*). For `implicit` value either `user_whitelist` or `group_whitelist` should be set.
        """
        return pulumi.get(self, "grant_type_whitelists")
    ...
    @grant_type_whitelists.setter
    def grant_type_whitelists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "grant_type_whitelists", value)
...
@pulumi.type_token("okta:auth/serverPolicyClaim:ServerPolicyClaim")
class ServerPolicyClaim(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[builtins.str]] = None,
            user_blacklists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            user_whitelists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'ServerPolicyClaim':
        """
    ...
    @property
    @pulumi.getter(name="accessTokenLifetimeMinutes")
    def access_token_lifetime_minutes(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Lifetime of access token. Can be set to a value between 5 and 1440 minutes. Default is `60`.
        """
        return pulumi.get(self, "access_token_lifetime_minutes")
    ...
    @property
    @pulumi.getter(name="authServerId")
    def auth_server_id(self) -> pulumi.Output[builtins.str]:
        """
        Auth server ID
        """
        return pulumi.get(self, "auth_server_id")
    ...
    @property
    @pulumi.getter(name="grantTypeWhitelists")
    def grant_type_whitelists(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Accepted grant type values, `authorization_code`, `implicit`, `password`, `client_credentials`, `urn:ietf:params:oauth:grant-type:saml2-bearer` (*Early Access Property*), `urn:ietf:params:oauth:grant-type:token-exchange` (*Early Access Property*),`urn:ietf:params:oauth:grant-type:device_code` (*Early Access Property*), `interaction_code` (*OIE only*). For `implicit` value either `user_whitelist` or `group_whitelist` should be set.
        """
        return pulumi.get(self, "grant_type_whitelists")
    ...
    @property
    @pulumi.getter(name="groupBlacklists")
    def group_blacklists(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Specifies a set of Groups whose Users are to be excluded.
        """
        return pulumi.get(self, "group_blacklists")
    ...
    @property
    @pulumi.getter(name="groupWhitelists")
    def group_whitelists(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Specifies a set of Groups whose Users are to be included. Can be set to Group ID or to the following: `EVERYONE`.
        """
        return pulumi.get(self, "group_whitelists")
    ...
    @property
    @pulumi.getter(name="refreshTokenLifetimeMinutes")
    def refresh_token_lifetime_minutes(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Lifetime of refresh token.
        """
        return pulumi.get(self, "refresh_token_lifetime_minutes")
    ...
    @property
    @pulumi.getter(name="refreshTokenWindowMinutes")
    def refresh_token_window_minutes(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Window in which a refresh token can be used. It can be a value between 5 and 2628000 (5 years) minutes. Default is `10080` (7 days).`refresh_token_window_minutes` must be between `access_token_lifetime_minutes` and `refresh_token_lifetime_minutes`.
        """
        return pulumi.get(self, "refresh_token_window_minutes")
    ...
    @property
    @pulumi.getter(name="scopeWhitelists")
    def scope_whitelists(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Scopes allowed for this policy rule. They can be whitelisted by name or all can be whitelisted with `*`
        """
        return pulumi.get(self, "scope_whitelists")
    ...
    @property
    @pulumi.getter(name="userBlacklists")
    def user_blacklists(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Specifies a set of Users to be excluded.
        """
        return pulumi.get(self, "user_blacklists")
    ...
    @property
    @pulumi.getter(name="userWhitelists")
    def user_whitelists(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Specifies a set of Users to be included.
        """
        return pulumi.get(self, "user_whitelists")
