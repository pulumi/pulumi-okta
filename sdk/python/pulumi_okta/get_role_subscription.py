...
def get_role_subscription(notification_type: Optional[builtins.str] = None,
    ...
    :param builtins.str notification_type: Type of the notification
    :param builtins.str role_type: Type of the role
    """
    __args__ = dict()
...
def get_role_subscription_output(notification_type: Optional[pulumi.Input[builtins.str]] = None,
