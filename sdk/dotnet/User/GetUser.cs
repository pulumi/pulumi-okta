...
namespace Pulumi.Okta.User
{
    public static partial class Invokes
    {
        ...
        public static Task<GetUserResult> GetUser(GetUserArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetUserResult>("okta:user/getUser:getUser", args ?? ResourceArgs.Empty, options.WithVersion());
    }

    public sealed class GetUserArgs : Pulumi.ResourceArgs
    {
        [Input("searches", required: true)]
        private InputList<Inputs.GetUserSearchesArgs>? _searches;

        /// <summary>
        /// Map of search criteria. It supports the following properties.
        /// </summary>
        public InputList<Inputs.GetUserSearchesArgs> Searches
        {
            get => _searches ?? (_searches = new InputList<Inputs.GetUserSearchesArgs>());
            set => _searches = value;
        }
    ...
    public sealed class GetUserSearchesArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Comparison to use.
        /// </summary>
