...
namespace Pulumi.Okta
{
    ...
    public partial class PolicyPasswordDefault : global::Pulumi.CustomResource
    {
        ...
        public PolicyPasswordDefault(string name, PolicyPasswordDefaultArgs? args = null, CustomResourceOptions? options = null)
            : base("okta:index/policyPasswordDefault:PolicyPasswordDefault", name, args ?? new PolicyPasswordDefaultArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyPasswordDefault(string name, Input<string> id, PolicyPasswordDefaultState? state = null, CustomResourceOptions? options = null)
            : base("okta:index/policyPasswordDefault:PolicyPasswordDefault", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static PolicyPasswordDefault Get(string name, Input<string> id, PolicyPasswordDefaultState? state = null, CustomResourceOptions? options = null)
        {
