...
export class DeviceAssuranceWindows extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DeviceAssuranceWindowsState, opts?: pulumi.CustomResourceOptions): DeviceAssuranceWindows {
        return new DeviceAssuranceWindows(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'okta:policy/deviceAssuranceWindows:DeviceAssuranceWindows';

    /**
     * Returns true if the given object is an instance of DeviceAssuranceWindows.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DeviceAssuranceWindows {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DeviceAssuranceWindows.__pulumiType;
    }
     ...
     */
    declare public readonly tpspCrowdStrikeAgentId: pulumi.Output<string | undefined>;
    /**
     * Third party signal provider crowdstrike user id
     */
    declare public readonly tpspCrowdStrikeCustomerId: pulumi.Output<string | undefined>;
    /**
     ...
     */
    declare public readonly tpspSecureBootEnabled: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    declare public readonly tpspThirdPartyBlockingEnabled: pulumi.Output<boolean | undefined>;
    /**
     * Third party signal provider windows machine domain
     */
    declare public readonly tpspWindowsMachineDomain: pulumi.Output<string | undefined>;
    /**
     * Third party signal provider windows user domain
     */
    declare public readonly tpspWindowsUserDomain: pulumi.Output<string | undefined>;
     ...
     */
    constructor(name: string, args?: DeviceAssuranceWindowsArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DeviceAssuranceWindowsArgs | DeviceAssuranceWindowsState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DeviceAssuranceWindowsState | undefined;
            ...
            resourceInputs["tpspCrowdStrikeAgentId"] = state?.tpspCrowdStrikeAgentId;
            resourceInputs["tpspCrowdStrikeCustomerId"] = state?.tpspCrowdStrikeCustomerId;
            ...
            resourceInputs["tpspSecureBootEnabled"] = state?.tpspSecureBootEnabled;
            resourceInputs["tpspSiteIsolationEnabled"] = state?.tpspSiteIsolationEnabled;
            resourceInputs["tpspThirdPartyBlockingEnabled"] = state?.tpspThirdPartyBlockingEnabled;
            resourceInputs["tpspWindowsMachineDomain"] = state?.tpspWindowsMachineDomain;
            resourceInputs["tpspWindowsUserDomain"] = state?.tpspWindowsUserDomain;
        } else {
            const args = argsOrState as DeviceAssuranceWindowsArgs | undefined;
            ...
            resourceInputs["tpspCrowdStrikeAgentId"] = args?.tpspCrowdStrikeAgentId;
            resourceInputs["tpspCrowdStrikeCustomerId"] = args?.tpspCrowdStrikeCustomerId;
            ...
            resourceInputs["tpspSecureBootEnabled"] = args?.tpspSecureBootEnabled;
            resourceInputs["tpspSiteIsolationEnabled"] = args?.tpspSiteIsolationEnabled;
            resourceInputs["tpspThirdPartyBlockingEnabled"] = args?.tpspThirdPartyBlockingEnabled;
            resourceInputs["tpspWindowsMachineDomain"] = args?.tpspWindowsMachineDomain;
            resourceInputs["tpspWindowsUserDomain"] = args?.tpspWindowsUserDomain;
        ...
        super(DeviceAssuranceWindows.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface DeviceAssuranceWindowsState {
    /**
     * Created by
     */
