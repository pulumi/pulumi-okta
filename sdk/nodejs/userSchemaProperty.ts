...
export class UserSchemaProperty extends pulumi.CustomResource {
     ...
     */
    declare public readonly arrayOneOfs: pulumi.Output<outputs.UserSchemaPropertyArrayOneOf[] | undefined>;
    /**
     ...
     */
    declare public readonly masterOverridePriorities: pulumi.Output<outputs.UserSchemaPropertyMasterOverridePriority[] | undefined>;
    /**
     ...
     * 	- 'title' - (Required) display name for the enum value.
     */
    declare public readonly oneOfs: pulumi.Output<outputs.UserSchemaPropertyOneOf[] | undefined>;
    /**
...
export interface UserSchemaPropertyState {
     ...
     * 	- 'title' - (Required) display name for the enum value.
     */
    arrayOneOfs?: pulumi.Input<pulumi.Input<inputs.UserSchemaPropertyArrayOneOf>[] | undefined>;
    /**
     * The type of the array elements if `type` is set to `array`
     */
     ...
     * 	- 'value' - (Required) - ID of profile source.
     */
    masterOverridePriorities?: pulumi.Input<pulumi.Input<inputs.UserSchemaPropertyMasterOverridePriority>[] | undefined>;
    /**
     * The maximum length of the user property value. Only applies to type `string`
     */
     ...
     * 	- 'title' - (Required) display name for the enum value.
     */
    oneOfs?: pulumi.Input<pulumi.Input<inputs.UserSchemaPropertyOneOf>[] | undefined>;
    /**
     * The validation pattern to use for the subschema. Must be in form of '.+', or '[<pattern>]+' if present.'
     */
