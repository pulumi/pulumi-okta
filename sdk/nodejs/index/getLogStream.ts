...
export interface GetLogStreamArgs {
     ...
     */
    settings?: inputs.Index.GetLogStreamSettings;
}
...
export interface GetLogStreamResult {
     ...
     * Provider specific configuration.
     */
    readonly settings?: outputs.Index.GetLogStreamSettings;
    /**
...
export interface GetLogStreamOutputArgs {
     ...
     * Provider specific configuration.
     */
    settings?: pulumi.Input<inputs.Index.GetLogStreamSettingsArgs>;
}
