...
public final class BookmarkAppArgs extends com.pulumi.resources.ResourceArgs {

    public static final BookmarkAppArgs Empty = new BookmarkAppArgs();
    ...
    private BookmarkAppArgs() {}

    private BookmarkAppArgs(BookmarkAppArgs $) {
    ...
    public static Builder builder(BookmarkAppArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(BookmarkAppArgs defaults) {
            $ = new BookmarkAppArgs(Objects.requireNonNull(defaults));
        }
