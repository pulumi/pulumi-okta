...
public class PolicyPasswordDefault extends com.pulumi.resources.CustomResource {
     ...
     */
    public PolicyPasswordDefault(java.lang.String name) {
     ...
     */
    public PolicyPasswordDefault(java.lang.String name, @Nullable PolicyPasswordDefaultArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public PolicyPasswordDefault(java.lang.String name, @Nullable PolicyPasswordDefaultArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("okta:index/policyPasswordDefault:PolicyPasswordDefault", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private PolicyPasswordDefault(java.lang.String name, Output<java.lang.String> id, @Nullable PolicyPasswordDefaultState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("okta:index/policyPasswordDefault:PolicyPasswordDefault", name, state, makeResourceOptions(options, id), false);
    }

    private static PolicyPasswordDefaultArgs makeArgs(@Nullable PolicyPasswordDefaultArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? PolicyPasswordDefaultArgs.Empty : args;
    }
     ...
     */
    public static PolicyPasswordDefault get(java.lang.String name, Output<java.lang.String> id, @Nullable PolicyPasswordDefaultState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
