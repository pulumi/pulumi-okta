...
public final class GetUsersUser {
    ...
    public static final class Builder {
        ...
        public Builder zipCode(String zipCode) {
            ...
            return new GetUsersUser(adminRoles, city, costCenter, countryCode, customProfileAttributes, department, displayName, division, email, employeeNumber, firstName, groupMemberships, honorificPrefix, honorificSuffix, id, lastName, locale, login, manager, managerId, middleName, mobilePhone, nickName, organization, postalAddress, preferredLanguage, primaryPhone, profileUrl, secondEmail, state, status, streetAddress, timezone, title, userType, zipCode);
        }
    }
}
