...
public final class SwaAppArgs extends com.pulumi.resources.ResourceArgs {

    public static final SwaAppArgs Empty = new SwaAppArgs();
    ...
    public static Builder builder(SwaAppArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SwaAppArgs defaults) {
            $ = new SwaAppArgs(Objects.requireNonNull(defaults));
        }
