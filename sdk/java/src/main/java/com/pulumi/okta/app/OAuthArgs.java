...
public final class OAuthArgs extends com.pulumi.resources.ResourceArgs {

    public static final OAuthArgs Empty = new OAuthArgs();
    ...
    public static Builder builder(OAuthArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(OAuthArgs defaults) {
            $ = new OAuthArgs(Objects.requireNonNull(defaults));
        }
