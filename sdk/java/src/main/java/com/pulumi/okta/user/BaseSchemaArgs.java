...
public final class BaseSchemaArgs extends com.pulumi.resources.ResourceArgs {

    public static final BaseSchemaArgs Empty = new BaseSchemaArgs();
    ...
    private BaseSchemaArgs() {}

    private BaseSchemaArgs(BaseSchemaArgs $) {
        this.index = $.index;
        this.master = $.master;
    ...
    public static Builder builder(BaseSchemaArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(BaseSchemaArgs defaults) {
            $ = new BaseSchemaArgs(Objects.requireNonNull(defaults));
        }
