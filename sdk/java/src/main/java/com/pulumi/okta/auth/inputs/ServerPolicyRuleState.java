...
public final class ServerPolicyRuleState extends com.pulumi.resources.ResourceArgs {
    ...
    private ServerPolicyRuleState() {}

    private ServerPolicyRuleState(ServerPolicyRuleState $) {
    ...
    public static Builder builder(ServerPolicyRuleState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServerPolicyRuleState();
        }

        public Builder(ServerPolicyRuleState defaults) {
            $ = new ServerPolicyRuleState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder grantTypeWhitelists(@Nullable Output<List<String>> grantTypeWhitelists) {
        ...
        public ServerPolicyRuleState build() {
            return $;
        }
    }
