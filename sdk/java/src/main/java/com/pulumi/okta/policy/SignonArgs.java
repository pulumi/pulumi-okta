...
public final class SignonArgs extends com.pulumi.resources.ResourceArgs {

    public static final SignonArgs Empty = new SignonArgs();
    ...
    public static Builder builder(SignonArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SignonArgs defaults) {
            $ = new SignonArgs(Objects.requireNonNull(defaults));
        }
