...
public final class SamlIdpState extends com.pulumi.resources.ResourceArgs {

    public static final SamlIdpState Empty = new SamlIdpState();
    ...
    private SamlIdpState() {}

    private SamlIdpState(SamlIdpState $) {
    ...
    public static Builder builder(SamlIdpState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SamlIdpState defaults) {
            $ = new SamlIdpState(Objects.requireNonNull(defaults));
        }
