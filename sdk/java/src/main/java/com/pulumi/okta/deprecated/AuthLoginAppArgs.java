...
public final class AuthLoginAppArgs extends com.pulumi.resources.ResourceArgs {

    public static final AuthLoginAppArgs Empty = new AuthLoginAppArgs();
    ...
    private AuthLoginAppArgs() {}

    private AuthLoginAppArgs(AuthLoginAppArgs $) {
    ...
    public static Builder builder(AuthLoginAppArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AuthLoginAppArgs();
        }

        public Builder(AuthLoginAppArgs defaults) {
            $ = new AuthLoginAppArgs(Objects.requireNonNull(defaults));
        }
