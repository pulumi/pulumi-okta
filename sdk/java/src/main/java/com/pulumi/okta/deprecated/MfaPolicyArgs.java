...
public final class MfaPolicyArgs extends com.pulumi.resources.ResourceArgs {

    public static final MfaPolicyArgs Empty = new MfaPolicyArgs();
    ...
    private MfaPolicyArgs() {}

    private MfaPolicyArgs(MfaPolicyArgs $) {
    ...
    public static Builder builder(MfaPolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(MfaPolicyArgs defaults) {
            $ = new MfaPolicyArgs(Objects.requireNonNull(defaults));
        }
