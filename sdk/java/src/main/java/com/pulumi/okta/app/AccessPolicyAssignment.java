...
public class AccessPolicyAssignment extends com.pulumi.resources.CustomResource {
    ...
    public AccessPolicyAssignment(java.lang.String name, AccessPolicyAssignmentArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("okta:app/accessPolicyAssignment:AccessPolicyAssignment", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private AccessPolicyAssignment(java.lang.String name, Output<java.lang.String> id, @Nullable AccessPolicyAssignmentState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("okta:app/accessPolicyAssignment:AccessPolicyAssignment", name, state, makeResourceOptions(options, id), false);
    }
