...
public final class PolicyPasswordDefaultArgs extends com.pulumi.resources.ResourceArgs {

    public static final PolicyPasswordDefaultArgs Empty = new PolicyPasswordDefaultArgs();
    ...
    private PolicyPasswordDefaultArgs() {}

    private PolicyPasswordDefaultArgs(PolicyPasswordDefaultArgs $) {
    ...
    public static Builder builder(PolicyPasswordDefaultArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PolicyPasswordDefaultArgs();
        }

        public Builder(PolicyPasswordDefaultArgs defaults) {
            $ = new PolicyPasswordDefaultArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PolicyPasswordDefaultArgs build() {
            return $;
        }
    }
