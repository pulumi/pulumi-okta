...
public final class PreviewSigninPageContentSecurityPolicySetting {
    ...
    public static Builder builder(PreviewSigninPageContentSecurityPolicySetting defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> srcLists;
        public Builder() {}
        public Builder(PreviewSigninPageContentSecurityPolicySetting defaults) {
        ...
        public PreviewSigninPageContentSecurityPolicySetting build() {
            final var _resultValue = new PreviewSigninPageContentSecurityPolicySetting();
