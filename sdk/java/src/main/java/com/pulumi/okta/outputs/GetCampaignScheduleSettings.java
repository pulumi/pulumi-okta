...
import com.pulumi.okta.outputs.GetCampaignScheduleSettingsRecurrence;
...
@CustomType
public final class GetCampaignScheduleSettings {
    ...
    public List<GetCampaignScheduleSettingsRecurrence> recurrences() {
    ...
    public static final class Builder {
        ...
        public GetCampaignScheduleSettings build() {
            final var _resultValue = new GetCampaignScheduleSettings();
