...
import com.pulumi.okta.app.inputs.BookmarkUserArgs;
...
public final class BookmarkState extends com.pulumi.resources.ResourceArgs {

    public static final BookmarkState Empty = new BookmarkState();
    ...
    @Import(name="users")
    private @Nullable Output<List<BookmarkUserArgs>> users;
     ...
     */
    @Deprecated /* The direct configuration of users in this app resource is deprecated, please ensure you use the resource `okta_app_user` for this functionality. */
    public Optional<Output<List<BookmarkUserArgs>>> users() {
    ...
    public static Builder builder(BookmarkState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(BookmarkState defaults) {
            $ = new BookmarkState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param requestIntegration Would you like Okta to add an integration for this app?
         * 
         * @return builder
         * 
         */
         ...
         */
        @Deprecated /* The direct configuration of users in this app resource is deprecated, please ensure you use the resource `okta_app_user` for this functionality. */
        public Builder users(@Nullable Output<List<BookmarkUserArgs>> users) {
            $.users = users;
            return this;
        }
         ...
         */
        @Deprecated /* The direct configuration of users in this app resource is deprecated, please ensure you use the resource `okta_app_user` for this functionality. */
        public Builder users(List<BookmarkUserArgs> users) {
         ...
         */
        @Deprecated /* The direct configuration of users in this app resource is deprecated, please ensure you use the resource `okta_app_user` for this functionality. */
        public Builder users(BookmarkUserArgs... users) {
