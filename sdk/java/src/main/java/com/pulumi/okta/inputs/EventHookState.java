...
public final class EventHookState extends com.pulumi.resources.ResourceArgs {

    public static final EventHookState Empty = new EventHookState();
    ...
    /**
     * @return Authentication required for event hook request.
     * 
     */
    ...
    private EventHookState() {}

    private EventHookState(EventHookState $) {
        this.auth = $.auth;
    ...
    public static Builder builder(EventHookState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(EventHookState defaults) {
            $ = new EventHookState(Objects.requireNonNull(defaults));
        }

        /**
         * @param auth Authentication required for event hook request.
         * 
         * @return builder
         * 
         */
