...
public final class MfaPolicyState extends com.pulumi.resources.ResourceArgs {

    public static final MfaPolicyState Empty = new MfaPolicyState();
    ...
    private MfaPolicyState() {}

    private MfaPolicyState(MfaPolicyState $) {
    ...
    public static Builder builder(MfaPolicyState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(MfaPolicyState defaults) {
            $ = new MfaPolicyState(Objects.requireNonNull(defaults));
        }
