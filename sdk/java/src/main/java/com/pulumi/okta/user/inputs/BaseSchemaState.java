...
public final class BaseSchemaState extends com.pulumi.resources.ResourceArgs {

    public static final BaseSchemaState Empty = new BaseSchemaState();
    ...
    private BaseSchemaState() {}

    private BaseSchemaState(BaseSchemaState $) {
        this.index = $.index;
        this.master = $.master;
    ...
    public static Builder builder(BaseSchemaState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(BaseSchemaState defaults) {
            $ = new BaseSchemaState(Objects.requireNonNull(defaults));
        }
