...
@CustomType
public final class SchemaArrayOneOf {
    /**
    ...
    public static Builder builder(SchemaArrayOneOf defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SchemaArrayOneOf defaults) {
        ...
        public Builder title(String title) {
            ...
            return this;
        }        public SchemaArrayOneOf build() {
            return new SchemaArrayOneOf(const_, title);
        }
    }
}
