...
import com.pulumi.okta.app.outputs.SecurePasswordStoreUser;
...
public class SecurePasswordStore extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="users", type=List.class, parameters={SecurePasswordStoreUser.class})
    private Output</* @Nullable */ List<SecurePasswordStoreUser>> users;
