...
public final class SecurityNotificationEmailsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private SecurityNotificationEmailsArgs(SecurityNotificationEmailsArgs $) {
    ...
    public static Builder builder(SecurityNotificationEmailsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SecurityNotificationEmailsArgs();
        }

        public Builder(SecurityNotificationEmailsArgs defaults) {
            $ = new SecurityNotificationEmailsArgs(Objects.requireNonNull(defaults));
        }
