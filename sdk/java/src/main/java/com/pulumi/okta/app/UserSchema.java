...
import com.pulumi.okta.app.inputs.UserSchemaState;
import com.pulumi.okta.app.outputs.UserSchemaArrayOneOf;
import com.pulumi.okta.app.outputs.UserSchemaOneOf;
 ...
 * 
 */
@ResourceType(type="okta:app/userSchema:UserSchema")
public class UserSchema extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="arrayOneOfs", type=List.class, parameters={UserSchemaArrayOneOf.class})
    private Output</* @Nullable */ List<UserSchemaArrayOneOf>> arrayOneOfs;

    /**
     * @return Display name and value an enum array can be set to.
     * 
     */
    public Output<Optional<List<UserSchemaArrayOneOf>>> arrayOneOfs() {
     ...
     * 
     */
    @Export(name="oneOfs", type=List.class, parameters={UserSchemaOneOf.class})
    private Output</* @Nullable */ List<UserSchemaOneOf>> oneOfs;

    /**
     * @return Array of maps containing a mapping for display name to enum value.
     * 
     */
    public Output<Optional<List<UserSchemaOneOf>>> oneOfs() {
    ...
    public UserSchema(String name) {
        this(name, UserSchemaArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public UserSchema(String name, UserSchemaArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("okta:app/userSchema:UserSchema", name, args == null ? UserSchemaArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private UserSchema(String name, Output<String> id, @Nullable UserSchemaState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("okta:app/userSchema:UserSchema", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static UserSchema get(String name, Output<String> id, @Nullable UserSchemaState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
