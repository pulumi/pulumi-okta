...
import com.pulumi.okta.app.inputs.UserSchemaArrayOneOfArgs;
import com.pulumi.okta.app.inputs.UserSchemaOneOfArgs;
...
public final class UserSchemaState extends com.pulumi.resources.ResourceArgs {

    public static final UserSchemaState Empty = new UserSchemaState();
    ...
    private @Nullable Output<List<UserSchemaArrayOneOfArgs>> arrayOneOfs;

    /**
     * @return Display name and value an enum array can be set to.
     * 
     */
    public Optional<Output<List<UserSchemaArrayOneOfArgs>>> arrayOneOfs() {
     ...
     */
    @Import(name="oneOfs")
    private @Nullable Output<List<UserSchemaOneOfArgs>> oneOfs;

    /**
     * @return Array of maps containing a mapping for display name to enum value.
     * 
     */
    public Optional<Output<List<UserSchemaOneOfArgs>>> oneOfs() {
    ...
    private UserSchemaState() {}

    private UserSchemaState(UserSchemaState $) {
        this.appId = $.appId;
    ...
    public static Builder builder(UserSchemaState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(UserSchemaState defaults) {
            $ = new UserSchemaState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder arrayOneOfs(@Nullable Output<List<UserSchemaArrayOneOfArgs>> arrayOneOfs) {
         ...
         * 
         */
        public Builder arrayOneOfs(List<UserSchemaArrayOneOfArgs> arrayOneOfs) {
         ...
         * 
         */
        public Builder arrayOneOfs(UserSchemaArrayOneOfArgs... arrayOneOfs) {
         ...
         * 
         */
        public Builder oneOfs(@Nullable Output<List<UserSchemaOneOfArgs>> oneOfs) {
            $.oneOfs = oneOfs;
            return this;
        }
         ...
         * 
         */
        public Builder oneOfs(List<UserSchemaOneOfArgs> oneOfs) {
         ...
         * 
         */
        public Builder oneOfs(UserSchemaOneOfArgs... oneOfs) {
