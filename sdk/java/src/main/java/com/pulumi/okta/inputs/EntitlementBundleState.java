...
public final class EntitlementBundleState extends com.pulumi.resources.ResourceArgs {

    public static final EntitlementBundleState Empty = new EntitlementBundleState();
    ...
    private EntitlementBundleState() {}

    private EntitlementBundleState(EntitlementBundleState $) {
    ...
    public static Builder builder(EntitlementBundleState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EntitlementBundleState();
        }

        public Builder(EntitlementBundleState defaults) {
            $ = new EntitlementBundleState(Objects.requireNonNull(defaults));
        }
        ...
        public EntitlementBundleState build() {
            return $;
        }
    }
