...
public final class ThreeFieldAppState extends com.pulumi.resources.ResourceArgs {

    public static final ThreeFieldAppState Empty = new ThreeFieldAppState();
    ...
    private ThreeFieldAppState() {}

    private ThreeFieldAppState(ThreeFieldAppState $) {
    ...
    public static Builder builder(ThreeFieldAppState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ThreeFieldAppState();
        }

        public Builder(ThreeFieldAppState defaults) {
            $ = new ThreeFieldAppState(Objects.requireNonNull(defaults));
        }
        ...
        public ThreeFieldAppState build() {
            return $;
        }
    }
