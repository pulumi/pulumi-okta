...
public final class SocialIdpArgs extends com.pulumi.resources.ResourceArgs {

    public static final SocialIdpArgs Empty = new SocialIdpArgs();
    ...
    private SocialIdpArgs() {}

    private SocialIdpArgs(SocialIdpArgs $) {
    ...
    public static Builder builder(SocialIdpArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SocialIdpArgs defaults) {
            $ = new SocialIdpArgs(Objects.requireNonNull(defaults));
        }
