...
public final class EntitlementArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public EntitlementArgs build() {
            if ($.dataType == null) {
                throw new MissingRequiredPropertyException("EntitlementArgs", "dataType");
            }
            if ($.externalValue == null) {
                throw new MissingRequiredPropertyException("EntitlementArgs", "externalValue");
            }
            if ($.multiValue == null) {
                throw new MissingRequiredPropertyException("EntitlementArgs", "multiValue");
            }
            return $;
        }
    }
