...
public final class RuleSignonArgs extends com.pulumi.resources.ResourceArgs {

    public static final RuleSignonArgs Empty = new RuleSignonArgs();
    ...
    private RuleSignonArgs(RuleSignonArgs $) {
        this.access = $.access;
    ...
    public static Builder builder(RuleSignonArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RuleSignonArgs defaults) {
            $ = new RuleSignonArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param identityProviderIds When identity*provider is SPECIFIC*IDP then this is the list of IdP IDs to apply the rule on
         * 
         * @return builder
         * 
         */
