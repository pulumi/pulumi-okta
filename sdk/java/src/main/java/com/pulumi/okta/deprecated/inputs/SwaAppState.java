...
import com.pulumi.okta.deprecated.inputs.SwaAppUserArgs;
...
public final class SwaAppState extends com.pulumi.resources.ResourceArgs {

    public static final SwaAppState Empty = new SwaAppState();
    ...
    @Import(name="users")
    private @Nullable Output<List<SwaAppUserArgs>> users;
     ...
     */
    @Deprecated /* The direct configuration of users in this app resource is deprecated, please ensure you use the resource `okta_app_user` for this functionality. */
    public Optional<Output<List<SwaAppUserArgs>>> users() {
        return Optional.ofNullable(this.users);
    }

    private SwaAppState() {}

    private SwaAppState(SwaAppState $) {
    ...
    public static Builder builder(SwaAppState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SwaAppState defaults) {
            $ = new SwaAppState(Objects.requireNonNull(defaults));
        }
         ...
         */
        @Deprecated /* The direct configuration of users in this app resource is deprecated, please ensure you use the resource `okta_app_user` for this functionality. */
        public Builder users(@Nullable Output<List<SwaAppUserArgs>> users) {
            $.users = users;
            return this;
        }
         ...
         */
        @Deprecated /* The direct configuration of users in this app resource is deprecated, please ensure you use the resource `okta_app_user` for this functionality. */
        public Builder users(List<SwaAppUserArgs> users) {
         ...
         */
        @Deprecated /* The direct configuration of users in this app resource is deprecated, please ensure you use the resource `okta_app_user` for this functionality. */
        public Builder users(SwaAppUserArgs... users) {
            return users(List.of(users));
        }

        public SwaAppState build() {
            return $;
        }
    }
