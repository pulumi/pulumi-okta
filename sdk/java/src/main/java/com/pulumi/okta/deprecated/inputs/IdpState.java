...
public final class IdpState extends com.pulumi.resources.ResourceArgs {

    public static final IdpState Empty = new IdpState();
    ...
    public static Builder builder(IdpState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(IdpState defaults) {
            $ = new IdpState(Objects.requireNonNull(defaults));
        }
