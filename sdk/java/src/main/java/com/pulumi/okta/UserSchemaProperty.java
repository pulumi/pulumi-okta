...
public class UserSchemaProperty extends com.pulumi.resources.CustomResource {
    ...
    private UserSchemaProperty(java.lang.String name, Output<java.lang.String> id, @Nullable UserSchemaPropertyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static UserSchemaProperty get(java.lang.String name, Output<java.lang.String> id, @Nullable UserSchemaPropertyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
