...
import com.pulumi.okta.deprecated.inputs.SamlAppKeyArgs;
...
public final class SamlAppState extends com.pulumi.resources.ResourceArgs {

    public static final SamlAppState Empty = new SamlAppState();
     ...
     */
    @Import(name="keys")
    private @Nullable Output<List<SamlAppKeyArgs>> keys;

    /**
     * @return Application keys
     * 
     */
    public Optional<Output<List<SamlAppKeyArgs>>> keys() {
    ...
    private SamlAppState() {}

    private SamlAppState(SamlAppState $) {
    ...
    public static Builder builder(SamlAppState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SamlAppState defaults) {
            $ = new SamlAppState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder keys(@Nullable Output<List<SamlAppKeyArgs>> keys) {
            $.keys = keys;
            return this;
        }
         ...
         * 
         */
        public Builder keys(List<SamlAppKeyArgs> keys) {
         ...
         * 
         */
        public Builder keys(SamlAppKeyArgs... keys) {
