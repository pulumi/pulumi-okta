...
@CustomType
public final class UserSchemaArrayOneOf {
    /**
    ...
    public static Builder builder(UserSchemaArrayOneOf defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(UserSchemaArrayOneOf defaults) {
        ...
        public Builder title(String title) {
            ...
            return this;
        }        public UserSchemaArrayOneOf build() {
            return new UserSchemaArrayOneOf(const_, title);
        }
    }
}
