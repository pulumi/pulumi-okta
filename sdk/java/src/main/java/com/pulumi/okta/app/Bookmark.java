...
public class Bookmark extends com.pulumi.resources.CustomResource {
     ...
     */
    public Bookmark(java.lang.String name, BookmarkArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public Bookmark(java.lang.String name, BookmarkArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("okta:app/bookmark:Bookmark", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private Bookmark(java.lang.String name, Output<java.lang.String> id, @Nullable BookmarkState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("okta:app/bookmark:Bookmark", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static Bookmark get(java.lang.String name, Output<java.lang.String> id, @Nullable BookmarkState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
