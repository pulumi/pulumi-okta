...
public final class UserBaseSchemaState extends com.pulumi.resources.ResourceArgs {

    public static final UserBaseSchemaState Empty = new UserBaseSchemaState();
    ...
    private UserBaseSchemaState() {}

    private UserBaseSchemaState(UserBaseSchemaState $) {
        this.appId = $.appId;
        this.index = $.index;
        this.master = $.master;
    ...
    public static Builder builder(UserBaseSchemaState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new UserBaseSchemaState();
        }

        public Builder(UserBaseSchemaState defaults) {
            $ = new UserBaseSchemaState(Objects.requireNonNull(defaults));
        }
        ...
        public UserBaseSchemaState build() {
            return $;
        }
    }
