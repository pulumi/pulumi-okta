...
public final class SignonPolicyState extends com.pulumi.resources.ResourceArgs {

    public static final SignonPolicyState Empty = new SignonPolicyState();
    ...
    private SignonPolicyState() {}

    private SignonPolicyState(SignonPolicyState $) {
    ...
    public static Builder builder(SignonPolicyState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SignonPolicyState();
        }

        public Builder(SignonPolicyState defaults) {
            $ = new SignonPolicyState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param priority Policy Priority, this attribute can be set to a valid priority. To avoid endless diff situation we error if an invalid
         * priority is provided. API defaults it to the last (lowest) if not there.
         * 
         * @return builder
         * 
        ...
        public SignonPolicyState build() {
            return $;
        }
    }
