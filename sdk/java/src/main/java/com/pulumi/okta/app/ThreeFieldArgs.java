...
public final class ThreeFieldArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ThreeFieldArgs(ThreeFieldArgs $) {
    ...
    public static Builder builder(ThreeFieldArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ThreeFieldArgs defaults) {
            $ = new ThreeFieldArgs(Objects.requireNonNull(defaults));
        }
