...
public final class GetUsersSearch extends com.pulumi.resources.InvokeArgs {
    ...
    private GetUsersSearch(GetUsersSearch $) {
    ...
    public static final class Builder {
        ...
        public Builder(GetUsersSearch defaults) {
            $ = new GetUsersSearch(Objects.requireNonNull(defaults));
        }
