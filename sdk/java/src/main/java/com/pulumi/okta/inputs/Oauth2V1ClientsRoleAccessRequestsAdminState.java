...
public final class Oauth2V1ClientsRoleAccessRequestsAdminState extends com.pulumi.resources.ResourceArgs {

    public static final Oauth2V1ClientsRoleAccessRequestsAdminState Empty = new Oauth2V1ClientsRoleAccessRequestsAdminState();
    ...
    private Oauth2V1ClientsRoleAccessRequestsAdminState() {}

    private Oauth2V1ClientsRoleAccessRequestsAdminState(Oauth2V1ClientsRoleAccessRequestsAdminState $) {
    ...
    public static Builder builder(Oauth2V1ClientsRoleAccessRequestsAdminState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new Oauth2V1ClientsRoleAccessRequestsAdminState();
        }

        public Builder(Oauth2V1ClientsRoleAccessRequestsAdminState defaults) {
            $ = new Oauth2V1ClientsRoleAccessRequestsAdminState(Objects.requireNonNull(defaults));
        }
        ...
        public Oauth2V1ClientsRoleAccessRequestsAdminState build() {
            return $;
        }
    }
