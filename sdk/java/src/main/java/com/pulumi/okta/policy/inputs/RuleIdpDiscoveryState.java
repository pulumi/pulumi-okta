...
public final class RuleIdpDiscoveryState extends com.pulumi.resources.ResourceArgs {
    ...
    private RuleIdpDiscoveryState() {}

    private RuleIdpDiscoveryState(RuleIdpDiscoveryState $) {
    ...
    public static Builder builder(RuleIdpDiscoveryState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RuleIdpDiscoveryState();
        }

        public Builder(RuleIdpDiscoveryState defaults) {
            $ = new RuleIdpDiscoveryState(Objects.requireNonNull(defaults));
        }
        ...
        public RuleIdpDiscoveryState build() {
            return $;
        }
    }
